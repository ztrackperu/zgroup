<div role="tabpanel" id="transporte" class="tab-pane">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2">
      <input type="text" id="c_fechora" name="c_fechora" value="" class="form-control datepicker-max-today input-sm" placeholder="Fecha EIR"/>
    </div>
    <div class="col-xs-1">
    ...
    <div class="col-xs-2">
      <input type="text" id="c_placa2" name="c_placa2" value="" class="form-control input-sm placa-format" placeholder="Placa Carreta" data-validacion-tipo="requerido"/>
    </div>
    <label class="control-label col-xs-1">Placa Tracto </label>
    <div class="col-xs-2">
      <input type="text" id="c_placa" name="c_placa" value="" class="form-control input-sm placa-format" placeholder="Placa Tracto" data-validacion-tipo="requerido"/>
