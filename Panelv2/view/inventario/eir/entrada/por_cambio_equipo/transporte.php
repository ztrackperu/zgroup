<div role="tabpanel" id="transporte" class="tab-pane">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-3">
      <input autocomplete="off" type="text" name="transportista" id="transportista" value="<?php echo $listaEirSalGuia->c_nomtra ?>"
    ...
    <div class="col-xs-2">
      ...
      <input type="text" name="c_chofer" id="c_chofer" value="<?php echo $listaEirSalGuia->c_chofer ?>" class="form-control input-sm"
        placeholder="Chofer" onFocus="abrirmodalTrans();" readonly />
    </div>
    <label class="control-label col-xs-1">Licencia</label>
    <div class="col-xs-2">
      <input type="text" id="c_licenci" name="c_licenci" value="<?php echo $listaEirSalGuia->c_licenci ?>" class="form-control input-sm"
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2">
      <input type="text" id="c_placa" name="c_placa" value="<?php echo $listaEirSalGuia->c_placa ?>" class="form-control input-sm"
        placeholder="Placa Tracto" data-validacion-tipo="requerido" />
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2">
      <select id="psalida" name="psalida" class="form-control input-sm select2">
    ...
    <label class="control-label col-xs-1">Punto</label>
    <div class="col-xs-2">
      <select id="pllegada" name="pllegada" class="form-control input-sm select2">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2">
      <select name="c_depsal" id="c_depsal" class="form-control input-sm select2">
          <option value="">[SALIDA]</option>
    ...
    <label class="control-label col-xs-1">Deposito</label>
    <div class="col-xs-2">
      <select name="c_deping" id="c_deping" class="form-control input-sm select2">
          <option value="">[LLEGADA]</option>
          <?php foreach($this->model->ListaDepositos() as $estaequi):	 ?>                                   
          <option value="<?php echo $estaequi->C_NUMITM; ?>"  > <?php echo utf8_encode($estaequi->C_DESITM); ?> </option>
          <?php  endforeach;	 ?>       
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2">
      <select name="ptosalida" id="ptosalida" class="form-control input-sm select2">
          <option value="">[SALIDA]</option>
    ...
    <label class="control-label col-xs-1">Puerto</label>
    <div class="col-xs-2">
      <select name="ptollegada" id="ptollegada" class="form-control input-sm select2">
          <option value="">[LLEGADA]</option>
          <?php foreach($this->maestro->ListaPuertos() as $estaequi):	 ?>                                   
          <option value="<?php echo $estaequi->C_NUMITM; ?>"  > <?php echo utf8_encode($estaequi->C_DESITM); ?> </option>
          <?php  endforeach;	 ?>       
