<div role="tabpanel" id="equipo" class="tab-pane">
  ...
  <div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-2">
        <input type="text" name="Dc_refnaci" id="Dc_refnaci" value="<?php echo $equi->c_refnaci; ?>" <?php echo $equi->c_nacional
        == 0 ? 'readonly' : ''; ?> class="form-control input-sm" placeholder="N° de dua" />
      </div>

      <label class="control-label col-xs-1">Fecha</label>
      <div class="col-xs-2">
        <input type="text" name="Dc_fecnac" id="Dc_fecnac" value="<?php echo $equi->c_fecnac; ?>" <?php echo $equi->c_nacional
