...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">REGISTRO EIR DE SALIDA DEL EQUIPO  <?php echo $serie; ?></div>
 <div>
...
<!--fin modal alertas info-->   
 ...
 <form class="form-horizontal" id="frm-EirEntrada" method="post" action="?c=inv05&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=GuardarRegEirSalida" >
     ...
     &nbsp;<a class="btn btn-danger" href="?c=inv05&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Cancelar</a>&nbsp;<a class="btn btn-warning" onClick="location.reload();" >Refrescar</a>&nbsp;
    </div>
...
<input type="hidden" name="item" id="item" value="<?php echo $_GET['item'] ?>" />
            ...
            <div class="col-xs-2">
            	<input type="text" name="c_numguia" id="c_numguia" value="<?php echo $listaEirSalGuia->c_numguia; ?>" class="form-control input-sm"  readonly="readonly" />
            </div>  
             <label class="control-label col-xs-1">Motivo </label>
            <div class="col-xs-2">
             <input type="text" name="c_motivo" id="c_motivo" value="" class="form-control input-sm" placeholder="Motivo" readonly="readonly" />  
        	</div>              
       ...
       <label class="control-label col-xs-1"></label>
         ...
         <div class="form-group"> 
           ...
           <label class="control-label col-xs-1">Placa Carreta </label>
            <div class="col-xs-2">
             <input type="text" id="c_placa2" name="c_placa2" value="<?php echo $listaEirSalGuia->c_placa2 ?>" class="form-control input-sm" placeholder="Placa Carreta" data-validacion-tipo="requerido" />  
        	</div>                       
	...
	<div role="tabpanel" id="detalle"  class="tab-pane"   >
       ...
       <div class="form-group"> 
           <label class="control-label col-xs-1">Descripcion </label>
            ...
            <div class="col-xs-2">
             <input type="text" id="c_idequipo" name="c_idequipo" class="form-control input-sm" value="<?php echo $equi->c_idequipo; ?>" readonly="readonly" />  
            
             </div>
         	<label class="control-label col-xs-1">Estado Equipo</label>
            <div class="col-xs-2">
            	<select name="xc_sitalm" id="xc_sitalm" class="form-control input-sm" disabled="disabled">
                   <option value="">SELECCIONE</option>
                   <?php foreach($this->maestro->Listaestadoequipo() as $est):	 ?>                                   
                   <option value="<?php echo $est->c_numitm; ?>" <?php echo $est->c_numitm == $listaEirSalGuia->c_estaequipo ? 'selected' : ''; ?>  > <?php echo $est->c_desitm; ?> </option>
                   <?php  endforeach;	 ?>       
               </select>
               <input name="c_sitalm" type="hidden" id="c_sitalm" value="<?php echo $listaEirSalGuia->c_estaequipo ?>" />
             </div>   
        </div>
        <!--fila 5-->    
       <div class="form-group"> 
           ...
           <div class="form-group">     
            ...
            <div class="col-xs-2">
               <select name="Dc_codsit" id="Dc_codsit" class="form-control input-sm">
                   <option value="SELECCIONE">SELECCIONE</option>
                   <?php foreach($this->maestro->Listaestadoequipo() as $est):	 ?>                                   
                   <option value="<?php echo $est->c_numitm; ?>" <?php echo $equi->c_codsitalm== $est->c_numitm ? 'selected' : ''; ?> > <?php echo $est->c_desitm; ?> </option>
                   <?php  endforeach;	 ?>       
               </select>
            </div>
