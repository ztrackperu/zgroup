...
<form class="form-horizontal" id="frm-updequipo" action="?c=<?php echo $c; ?>&a=GuardarUpdEquipo&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>" method="post" >
	...
	<div class="form-control-static" align="right">
     ...
     &nbsp;<a class="btn btn-danger" href="?c=<?php echo $c; ?>&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Salir</a>&nbsp;<a class="btn btn-warning" onClick="location.reload();">Refrescar</a>&nbsp;
    </div>
       ...
       <div class="form-group">
        ...
        <div class="form-group">     
          ...
          <div class="form-group"> 
            ...
            <label class="control-label col-xs-2">N° Dua</label>
            <div class="col-xs-3">
              <input type="text" name="Rc_refnaci" id="Rc_refnaci" value="<?php echo $equi->c_refnaci; ?>" class="form-control input-sm" placeholder="N° de dua" data-validacion-tipo="requerido" />
            </div>      
       ...
       <div class="form-group">
        ...
        <div class="form-group">     
          ...
          <div class="form-group"> 
            ...
            <label class="control-label col-xs-2">N° Dua</label>
            <div class="col-xs-2">
              <input type="text" name="Gc_refnaci" id="Gc_refnaci" value="<?php echo $equi->c_refnaci; ?>" class="form-control input-sm" placeholder="N° de dua" data-validacion-tipo="requerido" />
            </div>
       ...
       <div class="form-group">
        ...
        <div class="form-group">     
          ...
          <div class="form-group"> 
            ...
            <label class="control-label col-xs-2">N° Dua</label>
            <div class="col-xs-2">
              <input type="text" name="Cc_refnaci" id="Cc_refnaci" value="<?php echo $equi->c_refnaci; ?>" class="form-control input-sm" placeholder="N° de dua" data-validacion-tipo="requerido" />
            </div>
     ...
     <div  role="tabpanel"  <?php   if($tipo=='012'){ $valor='T'; ?> id="transformadores" class="active"  <?php }else{ ?> class="tab-pane" <?php } ?> > 
       ...
       <div class="form-group">
        ...
        <div class="form-group">     
          ...
          <div class="form-group"> 
            ...
            <label class="control-label col-xs-2">N° Dua</label>
            <div class="col-xs-2">
              <input type="text" name="Tc_refnaci" id="Tc_refnaci" value="<?php echo $equi->c_refnaci; ?>" class="form-control input-sm" placeholder="N° de dua" data-validacion-tipo="requerido" />
            </div>
       ...
       <div class="form-group">                  
          ...
          <div class="form-group"> 
            ...
            <label class="control-label col-xs-2">N° Dua</label>
            <div class="col-xs-2">
              <input type="text" name="Mc_refnaci" id="Mc_refnaci" value="<?php echo $equi->c_refnaci; ?>" class="form-control input-sm" placeholder="N° de dua" data-validacion-tipo="requerido" />
            </div>
