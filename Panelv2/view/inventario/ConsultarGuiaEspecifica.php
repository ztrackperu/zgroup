...
<!--NUEVA CONSULTAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA -->
<div class="container-fluid"> 
    <div class="panel panel-primary">
        <!-- Default panel contents -->
        <div class="panel-heading">CONSULTA DE GUIA NO LISTADA</div>
    </div>&nbsp;&nbsp;
    
    <form class="form-horizontal" id="frmbuscaguia" name="frmbuscaguia" method="post" action="?c=inv04&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=ConsultarGuiaEspecifica" >
        ...
        <!-- <a class="btn btn-warning" href="?c=inv04&mod=<?php //echo $_GET['mod']; ?>&udni=<?php// echo $udni; ?>&a=ConsultarGuiaEspecifica">CONSULTAR</a>-->
            <table id="CABEZA" class="table table-hover" style="font-size:12px;">
                <tr>
                    <td width="50%" align="center"> 
                        <input id="BuscarNew" name="BuscarNew" class="form-control input-sm" type="text" placeholder="Ingrese NUMERO de Guia y/o NOMBRE del cliente" />
                    </td>
        ...
        <?php if($this->model->ListarGuiaXCliente($ClienteG) != NULL) {?>
            <table id="tablas" class="table table-hover" style="font-size:12px;">
                ...
                <tbody>
                    <?php 
                        $i=0;
                        foreach($this->model->ListarGuiaXCliente($ClienteG) as $r):
				...
				$modificar='0';
                    ...
                    <tr>
                        ...
                        <td colspan="2"> 
                            ...
                            <?php /*?> <li><a href="view/inventario/guiaa4/test.php?c_numguia=<?php echo $r->c_numguia?>&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>" target="_blank">ImprimirA4</a></li> <?php */?>
