...
<div class="container-fluid">
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-heading">REGISTRO EIR DE SALIDA DEL EQUIPO..
      <?php echo $serie; ?>
    </div>
    <div>
	...
	border: 0px solid #A8A8A8;width:500px;" readonly />
      ...
      <form class="form-horizontal" id="frm-EirEntrada" method="post" action="?c=inv05&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=GuardarRegEirSalida">
        <div class="form-control-static" align="right">
          ...
          <a class="btn btn-danger" href="?c=inv05&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Cancelar</a>&nbsp;
        ...
        <div class="tab-content">
          <?php
          include_once('eir/salida/cabecera.php');
          include_once('eir/salida/transporte.php');
          include_once('eir/salida/detalle.php');
          include_once('eir/salida/equipo.php');
          include_once('eir/salida/permiso.php');
          ?>
        </div>
