    ...
    <div class="panel-heading">INVENTARIAR EQUIPOS</div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="tipo" name="tipo">
                <option value=""><B>SELECCIONAR</B></option>
                <option <?php if($_GET['tipo']=='TIPO A'){echo "selected";}?> value="TIPO A">TIPO A</option>
                <option <?php if($_GET['tipo']=='TIPO B'){echo "selected";}?> value="TIPO B">TIPO B</option>
                <option <?php if($_GET['tipo']=='TIPO C'){echo "selected";}?> value="TIPO C">TIPO C</option>
                <option <?php if($_GET['tipo']=='TIPO D'){echo "selected";}?> value="TIPO D">TIPO D</option>
            </select>
        </div>
        <div class="form-group">
