...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">ADMINISTRACION GUIA BUSCADA</div>
</div>
  <?PHP if($udni=='70498492'){?>
  &nbsp;&nbsp;
  <input id="BuscarNew" type="text" placeholder="Ingrese NUMERO de Guia y/o NOMBRE del cliente" />
  <a href="?c=inv04&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=ConsultarGuiaEspecifica2" class="btn btn-warning" target="_blank">Consultar Otra GUIA</a>
  <?PHP }?>
