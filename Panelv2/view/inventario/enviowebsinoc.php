...
function abrir() { 
	...
	window.open('http://zgroup.com.pe/public/formwebeirentradasinoc.php?val1='+c_numeir+'&val2='+nombreproducto+'&val3='+codigoequipo+'&val4='+condicionequipo+'&val5='+usuario+'&val6='+numasig+'&val7='+tipomov+'&val8='+guiaremision+'&val9='+tipo,'miwin','top=300,left=300,width=300,height=300') ; 
...
function vereir(){
	c_numeir=document.getElementById('c_numeir').value;
	location.href="?c=inv06&a=VerEirVistaPrevia&neir="+c_numeir+"&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>";		
}                

</script>
</head>

<body onload="JavaScript:abrir()">  <!--onload="abrir()"-->
...
<div class="container-fluid"> 
    ...
    <form id="formweb" name="formweb">
        ...
        <input type="hidden" name="nombreproducto" id="nombreproducto" value="<?php echo $c_numeirSalida ?>" />
        ...
        <input type="hidden" name="guiaremision" id="guiaremision" value="<?php echo $guiaremision ?>" />
        ...
        <!-- <a class="btn btn-info" onClick="abrir();" >abrir</a>-->
	</form>
</div>
</div>
</body>
