...
<div class="container-fluid">
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-heading">REGISTRO EIR DE ENTRADA POR CAMBIO DEL EQUIPO..
      <?php echo $serie; ?>
    </div>
    <div>
      ...
      <form class="form-horizontal" id="frm-EirEntrada" method="post" action="?c=dev01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=GuardarRegEirEntradaDev">
        <div class="form-control-static" align="right">
          ...
          <a class="btn btn-danger" href="?c=dev01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Cancelar</a>&nbsp;
          <a
        ...
        <div class="tab-content">
          <?php
          include_once('eir/entrada/por_cambio_equipo/cabecera.php');
          include_once('eir/entrada/por_cambio_equipo/transporte.php');
          include_once('eir/entrada/por_cambio_equipo/detalle.php');
          include_once('eir/entrada/por_cambio_equipo/equipo.php');
          include_once('eir/entrada/por_cambio_equipo/permiso.php');
          ?>
        </div>
