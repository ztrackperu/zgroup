            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Equipo</label><input type="hidden" name="login"
                            id="login" value="<?php echo $login ?>  " />
                    ...
                    <div class="form-group">
                        ...
                        <input name="fechainv" type="text" class="form-control default-datepicker input-sm" id="fechainv" value="<?= date(" d/m/Y"); ?>" readonly="readonly">
                    </div>
                </div>
