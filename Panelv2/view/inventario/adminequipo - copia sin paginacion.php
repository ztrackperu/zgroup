...
<div class="panel panel-primary">
  ...
  <table  class="table table-hover" id="testTable" style="font-size:12px">
    <thead>
   	    <tr>
   	        <th class="filterable-cell" width="10px">Nro</th>
            <th class="filterable-cell" >Id Equipo</th>        
            <th class="filterable-cell">Descripcion</th>
            <th class="filterable-cell">Nota Ingreso</th> 
            <th class="filterable-cell">Orden Compra</th>          
            <th class="filterable-cell">Fecha Ingreso</th>
            <th class="filterable-cell">N° Dua</th>
            <th class="filterable-cell">Fec. Inventario</th>
            <th class="filterable-cell">Obs Inventario</th> 
            <th class="filterable-cell" width="20px">Estado</th>
            <th class="filterable-cell" width="20px">Estado Alm</th>           
            <th class="filterable-cell"></th>
    ...
    <?php
	 ...
	 ?>
        <tr>
          <td class="filterable-cell"><?php echo $j; ?></td>
          <td class="filterable-cell"><?php echo $r->c_idequipo; ?></td>
          <td class="filterable-cell"><?php echo utf8_encode($r->IN_ARTI); ?></td>
          <td class="filterable-cell"><?php echo $r->c_nronis; ?></td>
          <td class="filterable-cell"><?php echo $docing; ?></td>
          <td class="filterable-cell"><?php echo $d_fecing; ?></td>
          <td class="filterable-cell"><?php echo $r->c_refnaci; ?></td>
          <td class="filterable-cell"><?php echo $r->c_fisico; ?></td>
          <td class="filterable-cell"><?php echo $r->c_fisico2; ?>&nbsp;</td>            
          <td class="filterable-cell"><?php echo $r->c_codsit; ?></td>
          <td class="filterable-cell"><?php echo $r->c_codsitalm; ?></td>           
