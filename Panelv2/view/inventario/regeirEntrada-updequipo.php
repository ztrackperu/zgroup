	...
	border: 0px solid #A8A8A8;width:500px;" readonly />
      ...
      <form class="form-horizontal" id="frm-EirEntrada" method="post" action="?c=inv03&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=GuardarRegEirEntrada">
        <div class="form-control-static" align="right">
          ...
          <a class="btn btn-danger" href="?c=inv03&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Cancelar</a>&nbsp;
          <a
        ...
        <div class="tab-content">
          <?php
          include_once('eir/entrada/cabecera.php');
          include_once('eir/entrada/transporte.php');
          include_once('eir/entrada/detalle.php');
          include_once('eir/entrada/equipo.php');
          include_once('eir/entrada/permiso.php');
          ?>
        </div>
