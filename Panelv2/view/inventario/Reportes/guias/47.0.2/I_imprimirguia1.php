...
<li><a href="#nogo" onclick="window.print();"><b>Imprimir</b></a></li>
    ...
    <form id="frmImpresion" name="formElem" method="post" >
        ...
        <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:14px;font-family:sans-serif;letter-spacing: 2px">
            <tr>
	          <td width="38208" colspan="8">
             
                <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:14px;font:sans-serif;letter-spacing: 2px">
                  <tr style="font:sans-serif;font-size:14px;"> <!-- letter-spacing: 2px -->
                    <td height="18">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td colspan="3">&nbsp;</td>
                    <td colspan="5">&nbsp;</td>
...
<!--        <tr>
            ...
            <tr height="30px">
              ...
              <td height="30px">&nbsp;</td>
              <td height="30px">&nbsp;</td>
              <td height="30px" font-size="30px"></td>
