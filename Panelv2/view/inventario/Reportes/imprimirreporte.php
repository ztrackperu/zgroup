...
<table width="570" class="table table-hover" id="tabla" style="font-size:12px">
    <thead>
		<tr>
          ...
          <td><a class="btn btn-info" href="indexa.php?c=07">Retornar</a></td>
        ...
        <tr>
            ...
            <th width="49" style="width:50px;">Trasportista</th>
            <th width="59" style="width:10px;">Estado</th>
            <th width="138" style="width:160px;">&nbsp;</th>
        </tr>
    </thead>
    <tbody>
    <?php foreach($this->model->ListaReporteGuiaGeneral($xsw,$zsw,$cli,$fi,$ff) as $r): $i=0; $i++; ?>
        <tr>
            <td><?php echo $i; ?></td>
            ...
            <td>
            <?php if($r->c_estado==1){ echo '<strong style="color:#0D1FC6">Generado</strong>'; 
			  }elseif($r->c_estado==2){ echo '<strong style="color:#060">Aprobado</strong>';
			  }  ?>
