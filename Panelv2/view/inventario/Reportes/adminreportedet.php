...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">FILTROS REPORTE DE GUIAS DETALLADO</div>
  
 <form class="form-horizontal" id="frmbuscacoti" name="frmbuscacoti" method="post" action="?c=inv07&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=ReporteGuiadetallado" >
