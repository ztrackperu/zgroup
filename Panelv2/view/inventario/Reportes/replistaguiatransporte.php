...
<div class="panel panel-primary ">
  ...
  <div class="panel-heading">REPORTE DE GUIA TRANSPORTE</div>
</div>
<form action="?c=inv07&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=ReporteGuiaexcel" method="post" target="_blank" id="FormularioExportacion">
...
<?php $xsw=$_REQUEST['valorcambio'];
			 ...
			 $xff=$_REQUEST['ffinal'];?>
<table width="570" class="table table-hover" id="Exportar_a_Excel" style="font-size:12px">
    <thead>
		<tr>
          <td colspan="6">
            <input id="buscar" size="45" type="text" class="form-control" placeholder="Filtre aqui ingrese nro Guia y/o Cliente" />
          </td>
          <td><a class="btn btn-info" href="indexa.php?c=inv09&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Retornar</a>&nbsp;<a href="" class="botonExcel" ><img src="assets/images/excel.png"  class="img-thumbnail" width="35" height="35"></a></td>
        </tr>
        <tr>
    ...
    <tbody>
    <?php foreach($this->model->ListaReporteGuiatransporte($xsw,$zsw,$cli,$fi,$ff) as $r): $i=0; $i++; ?>
        <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo $r->c_numguia; ?></td>
            <td><?php echo utf8_encode($r->c_nomdes); ?></td>
            <td>
			<?php  echo $r->d_fecgui; ?><!--</a>--></td>
...
<div class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">              	   
                  ...
                  <li><a href="?c=inv09&a=ImprimirGuiaTransporte&c_numguia=<?php echo $r->c_numguia?>&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>" >Imprimir</a></li>
