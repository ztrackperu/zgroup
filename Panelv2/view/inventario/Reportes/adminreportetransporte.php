...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">FILTROS REPORTE DE GUIAS TRANSPORTE</div>
  
 <form class="form-horizontal" id="frmbuscacoti" name="frmbuscacoti" method="post" action="?c=inv07&a=ReporteGuiaTransporte&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>" >
 <table width="997" class="table table-striped"> 
  	 ...
  	 <tr>
     	<td width="92" align="center" bgcolor="#99CCFF"><input name="sw" type="radio" id="sw" onClick="habilitarcoti()" value="1">
     	  Filtrar</td>	
        <td width="10">:</td>
        <td width="218">
        ...
        <td width="93" align="center" bgcolor="#FFFFCC"><input name="radio" type="radio" id="swf" onClick="habilitarafecrango()" value="swf">
     ...
     <tr>
       <td align="center" bgcolor="#99CCFF"><input name="sw" type="radio" id="sw" onClick="habilitarasig()" value="2" checked="CHECKED" >
         Todos</td>
       <td>&nbsp;</td>
       <td>
       ...
       <td width="93" align="center" bgcolor="#FFFFCC"><input name="radio" type="radio" id="swf2" onClick="habilitarafectodos()" value="swf" checked="CHECKED">
         Todos</td>
       <td width="13"></td>
       <td width="144"></td>
       <td width="185"></td>
