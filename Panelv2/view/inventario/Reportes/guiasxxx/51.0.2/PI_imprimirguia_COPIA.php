...
<li><a href="#nogo" onclick="window.print();"><b>Imprimir</b></a></li>
    ...
    <form id="frmImpresion" name="formElem" method="post" >
        ...
        <table width="1400" border="1" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:14px;font-family:sans-serif">
            <tr>
	          <td width="38208" colspan="8">
             
                <table width="1400" border="1" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:14px;font:sans-serif">
