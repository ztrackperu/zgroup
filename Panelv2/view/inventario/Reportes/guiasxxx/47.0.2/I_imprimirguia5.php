...
<li><a href="#nogo" onclick="window.print();"><b>Imprimir</b></a></li>
    ...
    <form id="frmImpresion" name="formElem" method="post" >
        ...
        <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:16px;font-family:'Times New Roman', Times, serif">
            <tr>
	          <td width="38208" colspan="8">
             
                <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font:sans-serif;font-size:14px">
