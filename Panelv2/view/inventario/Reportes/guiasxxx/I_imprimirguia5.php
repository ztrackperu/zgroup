...
<li><a href="#nogo" onclick="window.print();"><b>Imprimir</b></a></li>
    ...
    <form id="frmImpresion" name="formElem" method="post" >
        ...
        <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:14px;font-family:'Times New Roman', Times, serif; letter-spacing: 6px">
            <tr>
	          <td width="38208" colspan="8">
             
                <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font:sans-serif;font-size:14px; letter-spacing: 6px">
