    ...
    <form id="frmImpresion" name="formElem" method="post" >
        ...
        <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-weight:bold; font-size:12px;font-family:sans-serif; letter-spacing: 6px">
            ...
            <tr>
              ...
              <td colspan="8"><?php echo $itemD->c_desprd.'- //'.strtoupper($itemD->c_codprd).' '.strtoupper($itemD->c_obsprd) ?><br />
              </td>
              </tr>
                  <?php 	
					$i++;
            ...
            <!-- QUITAR -->
             <tr>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td colspan="7"><br><?php echo $mensaje ?></td>
              </tr>
              <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
 ...
 <!--           <tr>
          ...
          <!-- QUITAR <tr>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td align="center" valign="right"><?php echo $c_licenci; ?></td>
              <td>&nbsp;</td>
              <td align="center" valign="center"><?php echo $c_marca; ?></td>
              <td align="right">&nbsp;</td>
