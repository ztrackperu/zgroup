...
<div class="panel panel-primary ">
  ...
  <div class="panel-heading">REPORTE ASIGNACIONES PENDIENTES</div>
</div>
<table width="696" class="table table-hover" id="tabla" style="font-size:12px">
    <thead>
		<tr>
          <td colspan="8">
        ...
        <tr>
            ...
            <th width="93" style="width:150px;">Cotizacion</th>
            <th width="50"style="width:150px;">Vendedor</th>
            <th width="50"style="width:300px;">Cliente</th>
            <th width="50" style="width:300px;">Producto</th>
            <th width="50" style="width:50px;">Fecha Pre-Aprobacion</th>
    ...
    <tbody>
    <?php $i=0; foreach($this->model->AsignacionPendientes() as $r):  $i++; 
	
	
	//c_numped,c_nomcli,d_fecapr ?>
        <tr>
            <td><?php echo $i; ?></td>
            ...
            <td>&nbsp;</td>
            <td><a href="indexa.php?c=03&a=ImpCotizaciones&ncoti=<?php echo $r->c_numped?>&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Imprimir</a>
