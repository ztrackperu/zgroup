...
//var INPUT_NAME_PRE = 'c_codcont'; // this is being set via script c
var INPUT_NAME_CAN = 'c_obsprd'; // this is being set via script e
...
function addRowToTable(num)
{
	...
	var can=document.getElementById("c_obsprd").value
	...
	if (hasLoaded) {
		...
		row.myRow = new myRowObject(textNode,txtInpa,txtInpb,txtInpc,txtInpd,txtInpde,txtInpf);
	...
	if (hasLoaded) {
		if (tbl.tBodies[0].rows[startingIndex]) {
			...
			for (var i=startingIndex; i<tbl.tBodies[0].rows.length; i++) {
				...
				tbl.tBodies[0].rows[i].myRow.cuatro.name = INPUT_NAME_EQP + count;			
				tbl.tBodies[0].rows[i].myRow.cinco.name = INPUT_NAME_CAN + count;					
				tbl.tBodies[0].rows[i].myRow.seis.name = INPUT_NAME_ESTA + count;
				tbl.tBodies[0].rows[i].myRow.siete.name = INPUT_NAME_TIPPED + count;		
         ...
         <div class="form-group"> 
           <label class="control-label col-xs-2">Lugar de Partida</label>
            <div class="col-xs-3">
             ...
             <input name="c_parti" id="c_parti" type="text" class="form-control input-sm"   value="AV NESTOR GAMBETTA KM 7, CALLAO"  />
        	</div>               
            <div class="col-xs-2">
       ...
       <div class="row">
            <div class="col-xs-2"> 
             ...
             <input id="c_tipped" name="c_tipped" type="hidden"  value="" />
                    ...
                    <div class="col-xs-2">
                        <input name="c_codcont" type="text"  id="c_codcont" onFocus="abrirmodalEqp();" readonly  /> 
                    ...
                    <div class="col-xs-2"> 
                    	<input name="c_estaequipo" type="text" class="form-control input-sm" id="c_estaequipo" placeholder="Estado Equipo"  />                    	
