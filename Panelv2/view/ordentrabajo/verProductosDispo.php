<!--usado para registrar asignacion sin cotizacion y guia sin doc-->	
    ...
    <tbody>
        ...
        <tr>
          ...
          <td> <a href="javascript:pon_prefijo('<?php echo $IN_CODI?>','<?php echo $IN_ARTI?>','<?php echo $IN_UVTA?>','<?php echo $IN_STOK?>','<?php echo $IN_COST?>','<?php echo $c_equipo?>')"><span class="glyphicon glyphicon-check"></span></a> </td>          
...
<script>
	...
	function pon_prefijo(IN_CODI,IN_ARTI,IN_UVTA,IN_STOK,IN_COST,c_equipo) {		
		...
		document.getElementById('c_desequipo').value=IN_ARTI;
