            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    response($.map(data, function (item) {
                        return { /*CC_RUC,CC_RAZO,CC_TELE,CC_EMAI,CC_RESP*/
                            id:item.CC_RUC,
                            value:item.CC_RAZO,
...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">BÚSQUEDA DE CRONOGRAMA </div>
  
 <form class="form-horizontal" id="frmbuscacoti" name="frmbuscacoti" method="post" action="?c=05&a=ListarCronograma&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>" >
 <table width="836" class="table table-striped"> 
  	 <tr>
        ...
        <td width="270" rowspan="2"> <br><a class="btn btn-default" onClick="validar()" >Consultar</a></td>  		
     </tr> 
     ...
     <tr>
       ...
       <td>
         <input autocomplete="off" id="numcoti" name="numcoti" class="form-control input-sm" type="text" placeholder="Ingrese Numero Cotización" readonly  />
         ...
         <input type="hidden" name="c_codprd" id="c_codprd"><input type="hidden" name="login" id="login" value="<?php echo $login ?>  " /></td>
       </tr>
     </table>
