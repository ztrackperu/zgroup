...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">BÚSQUEDA DE  COTIZACIONES</div>
 ...
 <table width="836" class="table table-striped"> 
  	 <tr>
        ...
        <td width="263">
        <?php /*?><input  id="xc_nomcli" name="xc_nomcli" class="form-control input-sm" type="text" placeholder="Ingrese Nombre Cliente"  /><?php */?>
        
        
        <select id="xc_nomcli" name="xc_nomcli"  class="js-example-basic-single form-control input-sm" onChange="combocli()" >
...
$(document).ready(function() {
  $("#xc_nomcli").select2();
     ...
     <tr>
     	 <td width="140"> <input name="sw" id="sw" type="radio" value="3" onClick="habilitarmoti()"> 
