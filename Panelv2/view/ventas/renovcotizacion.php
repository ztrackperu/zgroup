...
endforeach*/
foreach($this->model->ObtenerDataCotizacion($_REQUEST['nrocoti']) as $r):
		$c_numped=$r->c_numped;
		$c_codmon=$r->c_codmon;
		$c_tipped=$r->c_tipped;
		$c_asunto=$r->c_asunto;
...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">COBRO CUOTA  DE COTIZACIONES
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp (Tipo Cambio=<?php echo $tcambio ?>)<input name="n_tcamb"  id="n_tcamb" type="hidden" value="<?php echo $tcambio ?>" /></div>
  <div>
<div class="form-control-static" align="right">
<!--<a class="btn btn-success" onClick="guardar()" href="#">Guardar</a>-->
<input class="btn btn-success" type="button" onClick="guardar()" value="Registrar"/>

&nbsp;<a class="btn btn-danger" href="?c=03&a=GuardarCronoCoti&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Cancelar</a>&nbsp;<a class="btn btn-warning" href="?c=05&a=GuardarCronoCoti&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Refrescar</a>&nbsp;<a class="btn btn-info" href="indexa.php?c=05&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Salir</a>&nbsp;
</div>
...
<table  id="tblSample" class="table table-striped">
    ...
    <tr>
      ...
      <input type="hidden" id="<?php echo "c_codprd_".$i; ?>"  name="<?php echo "c_codprd_".$i; ?>" readonly  
      ...
      <th><input type="text" id="<?php echo "c_obsdoc".$i; ?>"  name="<?php echo "c_obsdoc_".$i; ?>"   value="<?php echo 'DEL '.$fven.' AL '.$ffin; ?>" class="form-control input-sm" size="40" /></th>
      <th><input type="hidden" name="<?php echo "c_codcla_".$i; ?>" id="<?php echo "c_codcla_".$i; ?>" value="<?php echo $itemD->c_codcla ?>"></th>
      <th> <input name="<?php echo "c_tipped_".$i; ?>" type="TEXT" id="<?php echo "c_tipped_".$i; ?>"  value="<?php echo $itemD->c_clase; ?>" readonly/>
&nbsp;</th>
      ...
      <th><input name="<?php echo "c_fecini_".$i; ?>" type="text" id="<?php echo "c_fecini_".$i; ?>"   value="<?php echo $fven;  ?>" class='form-control input-sm' onClick="abreVentanaF(this.name)"/></th>
      <th><input name="<?php echo "c_fecfin_".$i; ?>" type="text" id="<?php echo "c_fecfin_".$i; ?>"   value="<?php echo $ffin;  ?>" class='form-control input-sm'/></th>
...
<table  class="table">
           ...
           <label class="control-label col-xs-1">L.Entrega</label>
            ...
            <div class="col-xs-2">
              ...
              <?php foreach($this->maestro->ListarFpago() as $a): ?>
				...
				<?php echo $c_codpga == $a->TP_CODI ? 'selected' : ''; ?>> <?php echo $a->TP_DESC; ?> 
               </option>
                <?php  endforeach;	 ?>
             </select>	
  ...
  <?php /*?>         <label class="control-label col-xs-1">Cronograma</label>
           ...
           <input name="c_gencrono" id="c_gencrono" type="hidden" value="0" />          
