...
<div class="container-fluid listado-facturas-container">
    <div class="panel panel-danger">
        <div class="panel-heading">Buscar Cotizaciones por fecha de aprobacion - usuario</div>
        <div class="panel-body">
			<div class="row">
				<form class="form-horizontal" role="form">
					<div class="form-group">
						<label for="ejemplo_email_3" class="col-lg-2 control-label">Fecha Inicial Aprobacion</label>
						<div class="col-lg-2">
						  <input type="text" class="form-control" id="txtFechaI" value="01/01/2020" name="txtFechaI" required placeholder="Fecha Inicial">
						</div>
					</div>
					<div class="form-group">
						<label for="ejemplo_email_3" class="col-lg-2 control-label">Fecha Final Aprobacion</label>
						<div class="col-lg-2">
			 ...
			 $('#FacturasListaLoadMSG').html('<div class="loading" style="text-align:center;"><img src="assets/vendor/images/spinner.gif" style="height: 85px;width: 85px;" alt="loading" /><br/>Un momento, por favor...</div>');			 
			  ...
			  var txtusuario2=$("#txtusuario2").val();			 		 	
					var tabla=$('#example').dataTable( {
					  "ajax": {
						"url": "indexa.php?c=17&a=BuscarCotizacionAprobadasxUsuGerencia",
						"data": function ( d ) {
							return $.extend( {}, d, {
							"txtFechaI": txtFechaI,
							"txtFechaF": txtFechaF,
