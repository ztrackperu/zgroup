...
<div class="panel panel-primary ">
  ...
  <div class="panel-heading">REPORTE COTIZACIONES POR FACTURAR</div>
</div>
<table width="570" class="table table-hover" id="tabla" style="font-size:12px">
    <thead>
        ...
        <tr>
            ...
            <th width="93" style="width:150px;">Estado</th>
    ...
    <tbody>
    <?php $i=0; foreach($this->model->ListaCotixFacturar() as $r):  $i++; //c_numped,c_nomcli,d_fecapr ?>
        <tr>
            <td><?php echo $i; ?></td>
