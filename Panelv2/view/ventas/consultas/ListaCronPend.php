...
<div class="panel panel-primary ">
  ...
  <div class="panel-heading">REPORTE CRONOGRAMAS PENDIENTES.</div>
</div>
<table width="570" class="table table-hover" id="tabla" style="font-size:12px">
    <thead>
        ...
        <tr>
            ...
            <th width="93" style="width:300px;">Documento</th>
	...
	$usuario=$_REQUEST['udni'];
		...
		foreach($this->model->ObtenerUsuarioM($usuario) as $usercrono):
	...
	$i=0; foreach($this->model->ListaCotiCronograma($UsuarioCr) as $r):  
	
	$i++; //c_numped,c_nomcli,d_fecapr ?>
        <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo $r->c_numped; ?></td>
            <td><?php echo utf8_encode($r->c_nomcli); ?></td>
            <td>
			<?php  echo $r->c_fecreg; ?><!--</a>--></td>
            <td>&nbsp;</td>
            <?php /*?><td><a href="?c=03&a=ImpCotizaciones&ncoti=<?php echo $r->c_numped?>&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Imprimir</a><?php */?>
