...
<div class="panel panel-primary ">
  ...
  <div class="panel-heading">ADMINISTRACION COTIZACIONES FORWARDER</div>
</div>
<table width="570" class="table table-hover" id="tabla" style="font-size:12px">
    <thead>
		<tr>
          ...
          <td><a class="btn btn-info" href="indexa.php?c=02&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Salir</a></td>
	...
	//echo '<br>';
	//echo $sw;
	foreach($this->model->Listar_CotizacionesForwarderM($valor) as $r): ?>
        <tr>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" role="menu">
   <li><a href="#my_modal2" data-toggle="modal" 
    ...
    <?php }?>
    <li><a href="?c=03&a=DuplicarCotizacion&ncoti=<?php echo $r->c_numped?>&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Duplicar</a></li>
   <?php if($r->n_swtapr==0 && $r->c_estado==0){?>
    ...
    <li><a href="?c=03&a=LibCotizaciones&ncoti=<?php echo $r->c_numped?>&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Liberar</a></li>  
    <?php }?>  
