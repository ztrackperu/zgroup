...
// alert (contador);
    ...
    if(cont==0){
        ...
        if(confirm("Seguro de Renovar Cuotas Seleccionadas ?")){
...
<form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=05&a=GuardarCronoCoti&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">
...
<div class="panel panel-primary ">
  ...
  <div class="panel-heading">DETALLE DE CRONOGRAMA DE PAGO.</div>
</div>
...
<!--          <a class="btn btn-success" onClick="renovar()" >Renovar</a>&nbsp;
  ...
  <input class="btn btn-success" type="button" onClick="renovar()" value="Cobrar Cuota"/>
&nbsp;
<input class="btn btn-warning" type="button" onClick="ampliacion()" value="Ampliar Cronograma"/>
&nbsp;
  
  
  
 <!-- <a class="btn btn-danger" href="?c=03&a=RegCotizaciones">Anular Cuota</a>&nbsp;-->
  <a class="btn btn-primary" href="#my_modal" data-toggle="modal">Cerrar Cronograma</a>&nbsp;
          <a class="btn btn-default" href="indexa.php?c=05&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Imprimir</a>&nbsp;
...
<table width="825" class="table table-hover" id="tabla" style="font-size:12px">
    <thead>
		<tr>
            ...
            <th width="49" bgcolor="#CCCCFF" style="width:50px;">Fecha Inicio/ Vcto</th>
