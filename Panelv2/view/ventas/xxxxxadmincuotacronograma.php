...
<table width="760" class="table table-hover" id="tabla" style="font-size:12px">
    <thead>
		<tr>
          <td colspan="9">&nbsp;</td>
        ...
        <tr>
          <th colspan="2" style="width:100px;"><input id="buscar" size="45" type="text" class="form-control" placeholder="Filtre aqui ingrese nro cotizacion y/o asunto" /></th>
        ...
        <tr>
            <th width="99" style="width:40px;">Cuota </th>
            <th width="93" style="width:100px;">Cotizacion Renovacion</th>
            <th width="50"style="width:10px;">&nbsp;</th>
            <th width="50"style="width:300px;">Descripcion</th>
            <th width="50" style="width:50px;">Equipo</th>
            <th width="49" style="width:50px;">Monto</th>
            <th width="49" style="width:50px;">Fecha Vcto</th>
            <th width="59" style="width:10px;">Nro Factura</th>
            <th width="59" style="width:10px;">Estado Cuota</th>
    ...
    <?php foreach($this->model->ListarCronograma($valor,$sw) as $r): ?>
        <tr>
            ...
            <?php if( $r->c_estado==0){ echo '<strong style="color:#0D1FC6">Generado</strong>'; 
			  ...
			  }elseif($r->c_estado==2 ){ echo '<strong style="color:#FF0000">Cerrado</strong>';} ?>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" role="menu">
      ...
      <?php if($r->c_estado==0){?>
    <li><a href="?c=05&a=ListaCuotasCronograma&ncoti=<?php echo $r->c_numped?>">Ver detalle</a></li>
    <?php }?>
