...
function agregardetalle(){
		...
		nuevaCelda=nuevaFila.insertCell(-1);
		nuevaCelda.innerHTML="<td><input name='c_codcla"+posicionCampo+"' type='hidden'  id='c_codcla"+posicionCampo+"'  size='5'  class='form-control input-sm'/>
		...
		nuevaCelda=nuevaFila.insertCell(-1);
		nuevaCelda.innerHTML="<td><input name='c_tipped"+posicionCampo+"' type='text'  id='c_tipped"+posicionCampo+"'  size='5'  class='form-control input-sm' readonly='readonly'/>";
			nuevaCelda=nuevaFila.insertCell(-1);
...
/*			glosa = document.getElementById("glosa" + posicionCampo);
			...
			c_codcla = document.getElementById("c_codcla" + posicionCampo);
			c_codcla.value = document.Frmregcoti.c_codcla.value;
...
<form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=03&a=UpdateCotizacion&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">
<!--modal fechas-->
<!-- Modal -->
...
<div class="panel panel-info">
  ...
  <div class="panel-heading">ACTUALIZACION DE COTIZACIONES
 </div>
  <div>
<div class="form-control-static" align="right">
<a class="btn btn-success" onClick="guardar()" href="#">Actualizar</a>&nbsp;<a class="btn btn-danger" href="?c=03&a=UpdCotizaciones&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Cancelar</a>&nbsp;<a class="btn btn-warning" href="?c=03&a=UpdCotizaciones&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Refrescar</a>&nbsp;<a class="btn btn-info" href="indexa.php?c=02&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">Salir</a>&nbsp;
</div>
   ...
   <div class="form-group">
       ...
       <div class="form-group">
           <label class="control-label col-xs-1">Nro</label>
            <div class="col-xs-2">
             <input type="text" name="c_numped" id="c_numped" value="<?php echo $c_numped ?>" class="form-control input-sm" placeholder=" Nro autogenerado" data-validacion-tipo="requerido" />  
        	 <input type="hidden" name="n_swtapr" id="n_swtapr" value="0" /><input type="TEXT" name="login" id="login" value="<?php echo trim($login) ?>  " /></div>                       
       ...
       <div class="form-group">
           <label class="control-label col-xs-1">Cliente</label>
            ...
            <div class="col-xs-2">
             ...
             <input name="c_via" id="c_via" type="hidden" value="<?php echo $c_via ?>" />
        	</div>     
      </div>
        <!--fila 3-->    
       <div class="form-group"> 
    ...
    <div class="row">
            ...
            <div class="col-xs-2"> 
             ...
             <input id="c_tipped" name="c_tipped" type="hidden"  value="" />
                    ...
                    <div class="col-xs-1">
                        <input name="n_canprd" type="text" class="form-control input-sm" id="n_canprd" placeholder="Cant" autocomplete="off" value="1" maxlength="3" onKeyUp="abrir()" />
                    </div>
                    <div class="col-xs-2">
...
<table  id="tblSample" class="table table-striped">
	...
	?>
    <tr>
      <th><input type="hidden" id="<?php echo "c_codprd".$i; ?>"  name="<?php echo "c_codprd".$i; ?>" readonly  value="<?php echo $itemD->c_codprd ?>" class='form-control input-sm' /></th>
      ...
      <th><input type="text" id="<?php echo "c_obsdoc".$i; ?>"  name="<?php echo "c_obsdoc".$i; ?>"   value="<?php echo utf8_encode($itemD->c_obsdoc); ?>" class="form-control input-sm" size="40" /></th>
      <th>
      
      <input type="hidden" name="<?php echo "c_codcla".$i; ?>" id="<?php echo "c_codcla".$i; ?>" value="<?php echo $itemD->c_codcla ?>" class="form-control input-sm">
      
      
            <?php /*?><input type="hidden" name="<?php echo "c_almdesp".$i; ?>" id="<?php echo "c_almdesp".$i; ?>" value="<?php echo $itemD->c_almdesp ?>" class="form-control input-sm">
      
      
            <input type="hidden" name="<?php echo "c_numguiadesp".$i; ?>" id="<?php echo "c_numguiadesp".$i; ?>" value="<?php echo $itemD->c_numguiadesp ?>" class="form-control input-sm"><?php */?>
      
      </th>
      <th> <input name="<?php echo "c_tipped".$i; ?>" type="text" id="<?php echo "c_tipped".$i; ?>"  value="<?php echo $itemD->clase; ?>" class="form-control input-sm" size="5" readonly/>
&nbsp;</th>
      <th><input  name="<?php echo "c_codcont".$i; ?>" type="text" id="<?php echo "c_codcont".$i; ?>"  value="<?php echo $itemD->c_codcont ?>"  size="18" readonly class="form-control input-sm" /></th>
      ...
      <input type="button" name="button3" id="button3" value="delete"  class="btn btn-danger btn-sm" onClick="eliminarUsuario(this)" /><?php }?></th>
    </tr>
    <?php  endforeach; ?>  
