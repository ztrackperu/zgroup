...
//maxDate: fecha tope D=días | M=mes | Y=año
   ...
   $( "#NT_FDOC" ).datepicker({ minDate: "-1D", maxDate: "+1M +10D" });   
  ...
  function validarguardar(){
	  ...
	  var NT_RESPO=document.getElementById('NT_RESPO').value;
	   if(NT_RESPO==''){			
			var mensje = "Falta Ingresar la persona Responsable de la Salida ...!!!";
				$('#alertone').modal('show');
				$('#mensaje').val(mensje);
          ...
          <input name="c_codalm" type="hidden" id="c_codalm" value="000001"   />         	
            ...
            <div class="col-xs-2">
             <select id="NT_TRAN" name="NT_TRAN"  class="form-control input-sm" o  >
                 <option value="">SELECCIONE</option>
                  <?php 
                    $listar=$this->model->ListartransacIngresoM(); 
           ...
           <label class="control-label col-xs-1">Usuario</label>
            <div class="col-xs-2">
               <input type="text" id="login" name="login" value="<?php echo $login; ?>" class="form-control input-sm"  />              
       	    </div>         
      </div>  
      <!--FILA 3-->
       <div class="form-group">
           <label class="control-label col-xs-2">Razon Social</label>
            ...
            <div class="col-xs-2">
             <input type="text" id="NT_CCLI" name="NT_CCLI" value="" class="form-control input-sm" placeholder="Codigo" readonly="readonly" />  
             
         </div>
         	<label class="control-label col-xs-1">Responsable</label>
            <div class="col-xs-2">
              <input type="hidden" id="c_ruccli" name="c_ruccli" value="" class="form-control input-sm" placeholder="Ruc" readonly="readonly" />  
        ...
        <div class="form-group">
        	<label class="control-label col-xs-2">OC/Transf.</label>
             <div class="col-xs-1">
                 <select name="elegir" id="elegir" class="form-control input-sm"  > 
                  <option value="0">NO</option> 
                  <option value="1">SI</option>
                 </select>             
        	 </div> 
            <div class="col-xs-2">
             <input type="text" id="NT_NOC" name="NT_NOC"  class="form-control input-sm"  autocomplete="off" />              
        	</div> 
           <label class="control-label col-xs-1">Moneda</label>
            ...
            <div class="col-xs-1">
             <input type="text" id="NT_TCAMB" name="NT_TCAMB" value="<?php echo $tcambio; ?>" class="form-control input-sm"
        ...
        <div class="form-group">
            ...
            <div class="col-xs-2">
             <select name="NT_TREM" id="NT_TREM" class="form-control input-sm"  > 
              <option value="">.:SELECCIONE:.</option> 
              <?php foreach($this->model->ListarDocuIngresoM() as $moneda):	 ?>                                 
         ...
         <div class="form-group"> 
           <label class="control-label col-xs-2">Proveedor </label>
            <div class="col-xs-3">
             <input autocomplete="off" type="text" name="c_nomtra" id="c_nomtra" value="" class="form-control input-sm" placeholder="Nombre o RUC" onclick="validarot();" onkeypress="validarot();" />  
        	</div>
            ...
            <div class="col-xs-2">
            <input type="text" id="NT_FGUI" name="NT_FGUI" class="form-control datepicker input-sm" placeholder="Fecha Dcto Referencia"  />
        	</div>           
        </div>              
