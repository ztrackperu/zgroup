...
<div class="container-fluid listado-facturas-container">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">Registro de Orden de Trabajo</div>
        <div class="panel-info panel-body">
			<div class="col-lg-4">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" class="form-control" id="txtCod" name="txtCod" placeholder="NRO REPORTE" value="<?php echo $Id_cabpre?>" >
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label  class="col-lg-4 control-label">Trabajo a realizar:</label>
					<div class="col-lg-8">
						<select name="cboMod" id="cboMod" class="select2 form-control" <?php echo $ObjetoDisable?>>
									<option value="SELECCIONE">SELECCIONE</option>  
									<?php foreach($this->maestro->ListaConceptosOT() as $modelo):	 ?>                                               
									<option value="<?php echo $modelo->descripcion; ?>"  <?php echo $modelo->descripcion == $descripcionOt ? 'selected' : ''; ?>  > <?php echo $modelo->descripcion; ?> </option>
									<?php  endforeach;	 ?>            
								  </select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" class="form-control" id="txtAsunto" name="txtAsunto" placeholder="Asunto" value="<?php echo $Id_cabpre?>" >
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-8">
						<select name="cboMod" id="cboMod" class="select2 form-control" <?php echo $ObjetoDisable?>>
									<option value="SELECCIONE">SELECCIONE</option>  
									<?php foreach($this->maestro->ListaSolicitanteOT() as $modelo):	 ?>                                               
			...
			<div class="col-lg-4">	
				<div class="form-group">
					<label  class="col-lg-4 control-label">Ejecutado por</label>
					<div class="col-lg-8">
						<input type="text" class="form-control" id="txtEjecutado" name="txtEjecutado" placeholder="Ejecutado por" value="<?php echo $Id_cabpre?>" >
					</div>
				</div>
				<div class="form-group">
					<label  class="col-lg-4 control-label">Fecha de Entrega</label>
					<div class="col-lg-8">
						<input type="date" class="form-control" id="txtFechaE" name="txtFechaE" placeholder="Fecha Entrega"  value="<?php echo date_format(new DateTime($Fecha_ingreso),"Y-m-d")?>" <?php echo $ObjetoDisable?>>
					</div>
				</div>
				<div class="form-group">
					<label  class="col-lg-4 control-label">Hora Inicio OT</label>
					<div class="col-lg-8">
						<input type="time" class="form-control" id="txtHinicio" name="txtHinicio" max="23:59:59" min="00:01:01" step="1" value="<?php echo $Built_year?>" placeholder="Hora inicio" <?php echo $ObjetoDisable?>>
					</div>
				</div>
				<div class="form-group">
					<label  class="col-lg-4 control-label">Serie de Equipo</label>
					<div class="col-lg-8">
						<input type="text" class="form-control" id="txtSerie" name="txtSerie" value="<?php echo $Built_year?>" placeholder="Controlador" <?php echo $ObjetoDisable?>>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="col-lg-4">
				<div class="form-group">
					...
					<div class="col-lg-8">
						<select name="cboMod" id="cboMod" class="select2 form-control" <?php echo $ObjetoDisable?>>
									<option value="SELECCIONE">SELECCIONE</option>  
									<?php foreach($this->maestro->ListaSupervisadoOT() as $modelo):	 ?>                                               
									<option value="<?php echo $modelo->c_desitm; ?>"  <?php echo $modelo->c_desitm == $codigoOt ? 'selected' : ''; ?>  > <?php echo $modelo->c_desitm; ?> </option>
									<?php  endforeach;	 ?>            
								  </select>
					</div>
				...
				<div class="col-lg-6">
					<div class="form-group">
						...
						<div class="col-lg-8">
							<select name="cboIgv" id="cboIgv" class="select2 form-control" <?php echo $ObjetoDisable?>>
							<option value="SELECCIONE">SELECCIONE</option>  
							<?php foreach($this->maestro->ListaConceptosOT() as $concot):	 ?>                                               
							<option value="<?php echo $concot->codigo; ?>"  <?php echo $concot->codigo == $ConcOt ? 'selected' : ''; ?>  > <?php echo $concot->descripcion; ?> </option>
							<?php  endforeach;	 ?>            
					  </select>
						</div>
					</div>
