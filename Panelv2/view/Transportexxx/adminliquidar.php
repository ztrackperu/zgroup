    ...
    <form class="form-horizontal" id="frmliquidar" name="frmliquidar" method="post" action="?c=01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $_GET['udni']?>&a=GuardarUpdLiquidacion">
      ...
      <table>
        ...
        <tr>
          ...
          <td style="width:150px;">
            <?php echo $mon. ' '.$listarliquidartot->n_importe;?>
          </td>
          <td style="width:150px;">
            <strong>IMPORTE GASTADO</strong>
          </td>
          <td style="width:150px;">
            <?php echo $mon. ' '.$listarliquidartot->n_impogastot;?>
          </td>
          <td style="width:70px;">
            <strong>SALDO</strong>
          </td>
          ...
          <tr>
            ...
            <td>
              ...
              <select id="" name="" class="form-control input-sm" disabled>
			    ...
			    foreach ($conceptoviaticos as $convia){
			  ?>
                <option value="<?php echo $convia->C_NUMITM; ?>" <?php if($convia->C_NUMITM==$r->c_idconcepto){?>selected
                  <?php }?>>
            ...
            <td>
              <?php 
				 	if($r->c_coddes==NULL){
						 echo $r->c_descripcion; 
					}else{
				?>
              <select id="xxxx" name="xxxx" class="form-control input-sm" disabled>
                <option value="SELECCIONE">SELECCIONE</option>
                <?php 
                    $conceptoviaticos=$this->model->BuscarPeaje(); 
                    foreach ($conceptoviaticos as $convia){
                  ?>
                <option value="<?php echo $convia->c_codpeaje; ?>" <?php if($convia->c_codpeaje==$r->c_coddes){?>selected
                  <?php }?>>
                  <?php echo utf8_encode($convia->descripcion); ?>
                </option>
                <?php } ?>
              </select>
