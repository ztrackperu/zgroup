    ...
    <td colspan="4"><table width="700" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="8"><table width="605" border="0" align="center">
            ...
            <tr align="center">
                <td width="5%"><strong>Nro</strong></td>
                <td width="25%"><strong>Personal</strong></td>
                <td width="10%"><strong>Importe</strong></td>
                <td width="15%"><strong>Tipo Dcto</strong></td>
                <td width="10%"><strong>Serie Dcto</strong></td>
                <td width="10%"><strong>N° Dcto</strong></td>
                <td width="15%"><strong>F.  Dcto</strong></td>
                <td width="15%"><strong>Usuario Liquidó</strong></td>
            </tr>
              <?php 
                    $j=1;
            ...
            <tr align="center">
                <td><?php echo $j; ?></td>
                <td><?php echo $c_personal=$item->c_personal; ?></td>
