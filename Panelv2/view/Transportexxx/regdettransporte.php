...
<div class="container-fluid">
    <div class="panel panel-primary">
        ...
        <div class="panel-heading">REGISTRAR DETALLE DE SERVICIO DE TRANSPORTE.</div>
        <div>
            <!-- Inicio Modal alerts -->
            ...
            <form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $_GET['udni']?>&a=GuardarDetTransporte" >
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation">
                        <a href="#otros" aria-controls="otros" role="tab" data-toggle="tab" >Otros Datos / kILOMETRAJE</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" id="impo" class="tab-pane active">
                        ...
                        <div class="tab-content">
                            <?php
                            require_once 'regdet/importaciones/forwarder_tab.php';
                            require_once 'regdet/importaciones/contenedor_tab.php';
                            require_once 'regdet/importaciones/almacen_tab.php';
                            require_once 'regdet/importaciones/terminal_salida_tab.php';
                            require_once 'regdet/importaciones/terminal_ingreso_tab.php';
                            require_once 'regdet/importaciones/factura_tab.php';
                            require_once 'regdet/importaciones/aduana_tab.php';
                            ?>
                        </div>
 	                </div>
                    <?php } ?>
                    ...
                    <div role="tabpanel" id="expo"  class="tab-pane active">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#fwexpo">Datos Forwarder</a></li>
                            <li><a data-toggle="tab" href="#contenedor">Datos Contenedor</a></li>
                            <li><a data-toggle="tab" href="#retiro">Datos Terminal Salida</a></li>
                            <li><a data-toggle="tab" href="#ing">Datos Terminal Ingreso</a></li>
                            <li><a data-toggle="tab" href="#fac">Datos Factura</a></li>
                            <li><a data-toggle="tab" href="#aduexpo">Datos Aduana</a></li>
                        </ul>
                        <div class="tab-content">
                            <?php
                            require_once 'regdet/exportaciones/forwarder_tab.php';
                            require_once 'regdet/exportaciones/contenedor_tab.php';
                            require_once 'regdet/exportaciones/terminal_salida_tab.php';
                            require_once 'regdet/exportaciones/terminal_ingreso_tab.php';
                            require_once 'regdet/exportaciones/factura_tab.php';
                            require_once 'regdet/exportaciones/aduana_tab.php';
                            ?>
                        </div>
                    </div>
                    <?php } ?>
