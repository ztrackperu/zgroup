...
<form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=cli02&a=GuardarCliente&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>">
...
<div class="panel panel-primary">
  <!-- Default panel contents -->
	...
	<a class="btn btn-success" onclick="guardar()" href="#">Registrar</a><a class="btn btn-info"  >Salir</a>&nbsp;
	</div>
       ...
       <!--fila 1-->       
         <div class="form-group">
           <label class="control-label col-xs-1">Tipo</label>
            <div class="col-xs-3">
              <select name="cc_tcli" id="cc_tcli" class="form-control input-sm" onchange="showContent()" >  
                             <option value="0">[SELECCIONE]</option>          
              <?php foreach($this->maestro->ListaTipoPersona() as $cert):	 ?>                                 
                <option value="<?php echo $cert->c_camitm; ?>"><?php echo $cert->c_desitm; ?></option>
                <?php  endforeach;	 ?>
             </select>	 
        	 <input name="xcc_tcli" type="hidden" id="xcc_tcli" value="0"  />
            ...
            <div class="col-xs-2">
             <select name="cc_tdoc" id="cc_tdoc" class="form-control input-sm" onchange="tipodoc()"  >  
                             <option value="0">[SELECCIONE]</option>          
              <?php foreach($this->maestro->ListaDocumentosPersona() as $cert):	 ?>                                 
                <option value="<?php echo $cert->c_coddoc; ?>"><?php echo $cert->c_desdoc; ?></option>
                <?php  endforeach;	 ?>
             </select>	  
             
             <input name="xcc_tdoc" type="hidden" id="xcc_tdoc" value="99" />
           </div>
         	<label class="control-label col-xs-1">Nro Dcto</label>
            <div class="col-xs-2">
              <input type="text" id="CC_NRUC" name="CC_NRUC" value="" class="form-control input-sm" placeholder="Nro documento"   /> 
        	</div>   
      </div>     
   <!--fila 2-->
    <div id="contentx" style="display: none;">
         <div class="form-group">
           <label class="control-label col-xs-1">R. Social</label>
            <div class="col-xs-4">
             <input autocomplete="off" type="text" name="CC_RAZO" id="C_RAZO" value="" class="form-control input-sm" placeholder="Razon Social"/>  
            </div>                         
         	<label class="control-label col-xs-1">Nombre</label>
            <div class="col-xs-4">
              <input type="text" id="CC_NCOM" name="CC_NCOM" value="" class="form-control input-sm" placeholder="Nombre Comercial"   /> 
        	</div>   
      </div>
      </div><!--fin coulcta-->
      <!--fila 2.1-->
      <div id="content" style="display: none;">
         <div class="form-group">
           <label class="control-label col-xs-1">Apellidos</label>
            <div class="col-xs-2">
             <input autocomplete="off" type="text" name="CC_APAT" id="CC_APAT" value="" class="form-control input-sm" placeholder="Apellido Paterno"/>          	 
        	 <input type="hidden" name="filas" id="filas">
            </div>                     
            <!--<label class="control-label col-xs-1">Nombre 1</label>-->
            <div class="col-xs-2">
             <input name="CC_AMAT" type="text" class="form-control input-sm" id="CC_AMAT" placeholder="Apellido Materno" value=""    />  
         </div>
         <label class="control-label col-xs-1">Nombres</label>
            <div class="col-xs-2">
             <input name="CC_NOMB" type="text" class="form-control input-sm" id="CC_NOMB" placeholder="Primer nombre" value=""    />               
         </div>
         	<div class="col-xs-2">
             <input name="CC_NOMB2" type="text" class="form-control input-sm" id="CC_NOMB2" placeholder="Segundo nombre" value=""    />               
         </div>              
      </div>
          </div><!--fin ocultar-->    
        <!--fila 3-->                 
        <div class="form-group">
           <label class="control-label col-xs-1">Dirección</label>
            <div class="col-xs-3">
             <input type="text" id="CC_DIR1" name="CC_DIR1" value="" class="form-control input-sm"
            ...
            <div class="col-xs-2">
              ...
              <?php foreach($this->maestro->ListaLocalidad() as $cert):	 ?>                                 
                <option value="<?php echo $cert->dl_codi; ?>"><?php echo utf8_decode($cert->dl_desc); ?></option>
                <?php  endforeach;	 ?>
             </select>	</div>                           
        ...
        <!--fila 4-->
         <div class="form-group"> 
           <label class="control-label col-xs-1">Contact</label>
            <div class="col-xs-3">
             <input type="text" id="CC_RESP" name="CC_RESP" value="" class="form-control input-sm" placeholder="Contacto"   />  
        	</div>                       
            <label class="control-label col-xs-1">Email</label>
            <div class="col-xs-2">
             <input type="text" id="CC_EMAI" name="CC_EMAI" value="" class="form-control input-sm" placeholder="Email"   />  
   ...
   <!--fila 4-->
         <div class="form-group"> 
           <label class="control-label col-xs-1">Telefono</label>
            <div class="col-xs-3">
             <input type="text" id="CC_TELE" name="CC_TELE" value="" class="form-control input-sm" placeholder="Teledono"   />  
        	</div>                       
