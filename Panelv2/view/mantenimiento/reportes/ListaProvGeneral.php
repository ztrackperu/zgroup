...
<div class="panel panel-primary ">
  ...
  <div class="panel-heading">REPORTE LISTADO DE PROVEEDORES</div>
...
<table width="834" class="table table-hover" style="font-size:12px" id="datos_a_enviar">
    ...
    <tbody>
    <?php $i=0; foreach($this->model->ListaProveedoresFrecuentes() as $r):  $i++; ?>
        <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo $r->PR_RUC; ?></td>
            <td><?php echo $r->PR_NRUC; ?></td>
            <td><?php echo utf8_encode($r->PR_RAZO); ?></td>
