...
<table id="tablas" class="table table-hover" style="font-size:12px;">
    ...
    <thead>   
      ...
      <tr align="center">
        <th style="width:4%;">FW / COTI / ROUTING</th>    
        <th style="width:3%;">ITEM</th>
        <th style="width:10%;">CLIENTE</th>               
        <th style="width:9%;">EQUIPO</th>
            <th style="width:8%;">GUIA REMISIÓN</th>
            <th style="width:8%;">FECHA GUIA REMISIÓN</th>
            <th style="width:9%;">PLACA / CARRETA</th>
            <th style="width:9%;">DIRECCION DE SALIDA</th>
            <th style="width:9%;">DIRECCION DE LLEGADA</th>
        <th style="width:10%;">CHOFER SALIDA</th>
            <th style="width:8%;">GUIA LLENO</th>
            <th style="width:8%;">GUIA VACIO</th>
            <th style="width:8%;">KM SALIDA</th>
            <th style="width:8%;">KM LLEGADA</th>
	...
	?>
        <tr align="center">
          ...
          <td><?php echo $c_numequipo;?> </td>
                ...
                <td><?php echo $r->c_diresal;?> </td>
                <td><?php echo $r->c_direlle;?> </td>
          <td><?php echo $r->c_chofer;?> </td>
                <td><?php echo $r->c_guiatranslleno;?> </td>
                <td><?php echo $r->c_guiatransvacio;?> </td>
                <td><?php echo $r->km_salida;?> </td>
                <td><?php echo $r->km_llegada;?> </td>
