				...
				<div class="tab-content">
					<div role="tabpanel" id="alm" class="tab-pane active">
						...
						<div class="form-group">
							...
							<label class="control-label col-xs-2">Placa de la Unidad</label>
							<div class="col-xs-2">						
								<input type="text" name="c_placa" id="c_placa" class="form-control input-sm" placeholder="Placa de la unidad"/>
							</div>
