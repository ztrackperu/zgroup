...
<div role="tabpanel" id="translocal" class="tab-pane" >
    ...
    <div class="form-group">
        ...
        <div class="col-xs-3">
            <input type="text" name="km_salida" id="km_salida"  class="form-control input-sm" value="" placeholder="Km de Salida"  />
        </div>
        <label class="control-label col-xs-2">Km - Llegada</label>
        <div class="col-xs-3">
            <input type="text" name="km_llegada" id="km_llegada"  class="form-control input-sm" value="" placeholder="Km de Llegada"  />
        </div>
    </div>
