...
<!--fin modal alertas info-->   
 ...
 <form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $_GET['udni']?>&a=GuardarUpdDetViaticos" >
 	...
 	<ul class="nav nav-tabs" role="tablist">
               <?php /*?> <li role="presentation" <?php if($_GET['mod']!='1'){?> class="active"<?php } ?> ><a href="#alm" aria-controls="alm" role="tab" data-toggle="tab" <?php if($_GET['mod']=='1'){?> onClick="desahilitardg()" <?php } ?> >Datos Generales</a></li>
        		<li role="presentation" <?php if($_GET['mod']=='1'){?> class="active"<?php } ?> ><a href="#con" aria-controls="con" role="tab" data-toggle="tab" <?php if($_GET['mod']!='1'){?> onClick="desahilitardep()" <?php } ?> >Datos Deposito</a></li><?php */?>
    			<li role="presentation" class="active" ><a href="#alm" aria-controls="alm" role="tab" data-toggle="tab" onClick="desahilitardg()"  >Datos Generales</a></li>
        		<li role="presentation"  ><a href="#con" aria-controls="con" role="tab" data-toggle="tab"  onClick="desahilitardep()"  >Datos Deposito</a></li>
    </ul> 
    <!-- Inicia Tab panes -->
	<div class="tab-content">      
	<?php /*?><div role="tabpanel" id="alm"  <?php if($_GET['mod']!='1'){ ?> class="tab-pane active"  <?php }else{ ?> class="tab-pane"<?php } ?>  ><?php */?>
    <div role="tabpanel" id="alm"  class="tab-pane active"  >
      ...
      <!-- para volver-->
       ...
       <div class="form-group">       		                
			...
			<label class="control-label col-xs-2">Placa de unidad</label>
            <div class="col-xs-2">
             <input type="text" name="c_placa" id="c_placa"  class="form-control input-sm" placeholder="Placa de la Unidad" value="<?php echo utf8_encode($listarupdviatico->c_placa); ?>" />
        	</div>
       ...
       <div class="form-group">
        ...
        <?php /*?><div role="tabpanel" id="con" <?php if($_GET['mod']=='1'){ ?>   class="tab-pane active"  <?php }else{ ?> class="tab-pane"<?php } ?>  ><?php */?>
