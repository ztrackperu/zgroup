...
<div class="container-fluid">
    <div class="panel panel-danger">
        ...
        <div class="panel-heading">CABECERA DE SERVICIO TECNICO</div>
        <div>
            <!-- Inicio Modal alerts -->
            ...
            <form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=03&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $_GET['udni']?>&a=GuardarCabServTecnico">
                <div class="form-control-static" align="right">
                    ...
                    <a class="btn btn-danger" href="?c=03&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $_GET['udni']?>&a=AdminServiciosTecnicos">Cancelar</a>&nbsp;
...
$(document).ready(function () {
    ...
    $("#cotizacion").autocomplete({
        ...
        source: function (request, response) {
            jQuery.ajax({
                url: '?c=01&a=BuscarCotiAprobadasTra',
                type: "post",
                dataType: "json",
                data: {
