  ...
  <div id="mainAdminTransporte" class="container-fluid">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <br/>
        <a class="btn btn-primary" href="?c=01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $_GET['udni']?>&a=RegTransporte">NUEVO SERVICIO DE TRANSPORTE</a>
        <a class="btn btn-primary" href="?c=01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $_GET['udni']?>&a=ReporteDetallado" target="_black">VER REPORTE DETALLADO</a>
        <br/>
        <div id="adminServTransSummaryMSG" style="display:none;text-align:center;">
            Cargando...
            <br>
            <img src="assets/vendor/images/spinner.gif" style="height: 85px;width: 85px;">
        </div>
        <div id="adminServTransSummaryMSGEmpty" style="display:none;text-align:center;color:#ff0000;">
            <strong>Sin Resultados</strong>
        </div>
        <table id="adminServTransSummaryTable" class="table table-bordered table-hover table-striped" style="font-size: 0.8em; text-align:center;">
        </table>       
      </div>
    </div>
