...
<table id="tbllista" class="display table table-striped table-responsive" cellspacing="0" width="100%" style="font-size: 12px;">
                        <thead>
                            <tr>
 ...
 if($cert->n_swtapr==0 && $cert->c_estado==0 && $cert->n_preapb!=2){ $Estado="GENERADO"; //generado
						 ...
						 if($cert->n_swtapr==0 && $cert->c_estado==0 && $cert->n_preapb!=2){ $color="#0D1FC6"; //generado
							 ...
							 ?>   
                            <tr  >
                              <th style="text-align:center"><?php echo $cert->c_numped; ?>&nbsp;</th>
                              <th style="text-align:center"><?php echo $cert->c_nomcli; ?>&nbsp;</th>
                              <th style="text-align:center"><?php echo $cert->c_asunto; ?>&nbsp;</th>
                              <th style="text-align:center"><?php echo $cert->c_login; ?>&nbsp;</th>
                              <th  style="color:<?php echo $color?>"><?php echo $Estado; ?>&nbsp;</th>
                              <th style="text-align:center"><?php echo vfecha(substr($cert->d_fecrea,0,10)); ?>&nbsp;</th>
                              <th style="text-align:center"><?php echo $moneda ?>&nbsp;</th>
                              <th style="text-align:center"><?php echo $cert->n_tcamb; ?>&nbsp;</th>
                              <th style="text-align:center"><?php echo $simbolo.$cert->n_totped; ?>&nbsp;</th>
