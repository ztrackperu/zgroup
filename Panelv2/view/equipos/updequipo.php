      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="recipient-name" class="control-label">Equipo</label><input type="hidden" name="login" id="login"
  ...
  <div class="modal fade" id="my_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="recipient-name" class="control-label">Producto</label><input type="hidden" name="login" id="login"
              value="<?php echo $login ?>  " />
...
<script type="text/javascript">
  ...
  function volver() {
    location.href = "?c=equi01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>";
...
<div class="container-fluid">
  ...
  <div class="panel panel-primary">
    ...
    <br />
    <form action="?c=inv01&a=ExportarExcelEquipos" method="post" id="FormularioExportacion">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="VOLVER" class="btn btn-primary" onClick="volver()" />
    <table class="table table-hover" id="testTable">
      <thead>
        ...
        <tr>
          ...
          <th style="width:100px;">Tomar Foto</th>
      ...
      <tbody>
        <?php 
		foreach($this->model->ListarEquiposSerie($serie) as $r):
			//$r->c_nacional;
	 ...
	 ?>
        <tr>
          ...
          <td>
            <?php echo $r->c_refnaci; ?>
          </td>
          <td>
            <?php echo $r->c_codsit; ?>
          </td>
          <td>
            <?php echo $r->c_codsitalm; ?>
          </td>
          <td><a href="?c=inv00&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=tomarfoto&c_nserie=<?php echo $r->c_nserie; ?>&amp;reg=equi01">Tomar Foto</a></td>
          <td><a href="?c=equi01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=Editar&id=<?php echo $r->c_idequipo; ?>&cod_tipo=<?php echo $r->COD_TIPO; ?>">Editar</a></td>
          <td>
            <?php /*?>
            <?php 
					 if($r->c_codsit!=''){
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <?php 
                                if($evalua=='0'){
                              ?>
                <li> <a href="?c=inv03&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=RegEirEntradaReguOc&serie=<?php echo $r->c_nserie; ?>">Regularizar O/C</a></li>
                <!--funcion se encuentra en procesoseir.controller.php-->
                <?php 
                                }else if($evalua=='1'){
                              ?>
                ...
                <li><a href="#my_modal" data-toggle="modal" data-id="<?php echo $r->c_idequipo.'|'.$r->IN_ARTI.'|'.$r->c_codsitalm; ?>">Reg. Estado</a></li>
                <?php }?>
            ...
            <?php }else{ ?>
            <a onClick="modalmotielim('<?php echo $r->c_motivoelim ?>')">
              <font color="#FF0000">Eliminado</font>
            </a>
            <?php } ?>
            <?php */?>
