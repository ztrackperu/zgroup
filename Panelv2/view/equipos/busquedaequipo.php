...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">BUSCAR EQUIPOS</div>
<div>  
<form class="form-horizontal" id="frm-VerDetalleRegUpd" method="post" action="?c=equi01&mod=<?php echo $_GET['mod']; ?>&udni=<?php echo $udni; ?>&a=VerListadoequipos" >
     <table class="table table-striped">
      <tr>
        <td colspan="2">         
            <?php
              $descripcion = isset($descripcion)?$descripcion:"";
              $cod_tipo = isset($cod_tipo)?$cod_tipo:"";
            ?>
            ...
            <!--<input id="cadena1" name="cadena1"        class="form-control" type="hidden"  /> -->           
             <div class="form-group" style="margin-left:10px;" >
                <label   style="width:50%;float:left">Ejemplo: ZGRU123456-1 y/o 12345 (colocando solo algunos numeros del equipo..)</label>
                <div class="col-xs-2">
