...
class Procesosinv
{
	...
	public function consultarTodosEquipos(){
		...
		$msg = '';
		$data = array();
		$sql = "SELECT  c_nronis, c_codsit, c_codsitalm, c_nserie, d_fecing, c_idequipo, IN_ARTI, c_refnaci, c_fisico, c_fisico2, COD_TIPO, c_motivoelim, doc.c_numeoc as orden_compra, 'INVENTARIO' as procedencia, pti, c_codalm, tipo, c_codmar
						FROM ((invequipo e 
						...
						'' as c_fisico, '' as c_fisico2, COD_TIPO, '' as c_motivoelim, d.c_numeoc & ' ||Fecha : ' & d.d_fecreg as  orden_compra, 'PENDIENTES' as procedencia, '' as pti, '' as c_codalm, '' as tipo, '' as c_codmar
