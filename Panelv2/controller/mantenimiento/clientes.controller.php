...
/* 									if($ejecutar){
										$mensaje="Cliente Grabado Correctamente1".var_dump($ejecutar);
									}else{
										$mensaje=$ejecutar;
									} */
									...
									require_once 'view/principal/header.php';
									require_once 'view/principal/principal.php';
									//header('location:indexm.php?c=cli02&udni'.$_REQUEST["udniz"].'&mod='.$_REQUEST["mod"]);	
									require_once 'view/mantenimiento/regcliente.php';
									require_once 'view/principal/footer.php';		
	...
	public function UpdCliente(){
			$ruc=$_GET['id'];
			$obclie=$this->model->ObtieneCliente($ruc);
			require_once 'view/principal/header.php';		
			require_once 'view/principal/principal.php';
			require_once 'view/mantenimiento/updcliente.php';
			require_once 'view/principal/footer.php';
		}	
