...
<form id="form1" name="form1" method="post" action="file://///SZGROUP/Panel/MVC_Controlador/cajaC.php?acc=rep01&amp;udni=<?php echo $_GET['udni']; ?>&amp;mod=<?php echo $_GET['mod']; ?>">
      ...
      <td height="113"><table width="200" border="1">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
          <thead>
            ...
            <tr align="center">
              <td colspan="5" bgcolor="#00FFFF">BIENVENIDO USTED TIENE LAS SIGUIENTES COTIZACIONES POR APROBAR<a href="#nogo" onclick="window.print();" class="nover"><b></b></a></td>
            </tr>
            <tr align="center">
