      ...
      <div class="TabbedPanelsContent" >
        <table width="867" border="0">
          ...
          <tr>
            ...
            <td><input name="unidad" type="text" required="required"  class="texto" id="unidad" onclick="abreVentana(this.name)" size="35" onkeypress="copiatext()" onblur="copiatext()" readonly="readonly"/><input name="codigoequipo" type="text" id="codigoequipo" size="5" readonly="readonly" class="texto" /></td>
          </tr>
          <tr>
            <td colspan="4"><hr /></td>
          </tr>
