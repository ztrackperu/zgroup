...
<strong>Nuevo</strong><a href="../MVC_Controlador/OrdenTrabajoC.php?acc=formos&udni=<?php echo $val;?>"><img src="../images/nuevo.png" width="48" height="48" /></a><strong>Plantilla Trans. Fluvial</strong><a href="../MVC_Controlador/OrdenTrabajoC.php?acc=formosplantilla&udni=<?php echo $val;?>"><img src="../images/icono-sistemas.png" width="48" height="48" /></a><br class="clear"/>
                    <div class="content">
                        <table style="font-size:11px" class="data" width="894" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                  <th colspan="11" style="width:5%"><input type="radio" name="sw" id="sw" value="1" />
                                  ...
                                  Nro de Orden de Servicio(EJM=45)/</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="../images/icon_edit.png" alt="editar" width="18" height="18" class="help" title="Editar" />Editar&nbsp;<img src="../images/pdf.gif" alt="1" width="19" height="19" title="Ver Orden" />imprime&nbsp; <img src="../images/icon_delete.png" alt="2" width="18" height="18" title="Eliminar" />elimina/Anula&nbsp; <img src="../images/Coherence.png" alt="3" width="22" height="22" title="Aprobar" />aprueba <img src="../images/iconos/doc.png" alt="5" width="20" height="20" />Libera</th>
                                </tr>
                                <tr>
                                  <th width="2%"  >&nbsp;</th>
                                    <th width="7%"  >Nro Orden</th>
                                    <th width="12%" >Proveedor</th>
                                    <th width="6%" >Fecha</th>
                                  <th width="15%" >Asunto</th>
                                  <th width="8%" >Cotizacion Referencia</th>
                                  <th width="6%" >Documento Referencia</th>
                                  <th width="6%" >Estado</th>
                                  <th width="9%" >Duplicar</th>
                                  <th width="9%" >Aprueba<br />/Libera</th>
                                  <th width="26%" >Administrar</th>
										...
										if($listaos!=NULL)
{
            ...
            ?>
                                <tr>
								  ...
								  if($item["c_tipdoc"]=='001'){$d='F';}elseif($item["c_tipdoc"]=='002'){$d='B';}else{$d="";} echo $d.$item['c_serdoc'].$item['c_nrodoc']  ?>&nbsp;</td>
			  ...
			  }elseif($item['c_estado']==2 && $item['n_swtapr']==1){ echo '<strong style="color:#CC9900">Cerrado</strong>';}elseif($item['c_estado']==4){ echo '<strong style="color:#FF0000">ANULADO</strong>';} ?>&nbsp;</td>
               ...
               <?php if($item['n_swtapr']=='0' && $item['c_estado']=='0' && $mod=='1'){ ?>
                                 <a href="../MVC_Controlador/OrdenTrabajoC.php?acc=veraprobacion&amp;os=<?php echo $item["c_numos"];?>&amp;udni=<?php echo $_GET['udni'];?>"><img src="../images/Coherence.png" width="32" height="32" title="Aprobar Orden Servicio" /></a></td>
                                  <?php }?>
...
<?php if($item['n_swtapr']=='0' && $item['c_estado']=='0'){ ?>
 ...
 <?php }?> <a href="../MVC_Controlador/OrdenTrabajoC.php?acc=verfrmref&os=<?php echo $item["c_numos"]; ?>&udni=<?php echo $udni;?>">
