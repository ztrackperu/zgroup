...
$(document).ready(function(){
   $(".button3").click(function(){
        //var item = $(this).data("rolei");
        alert("Hola Mundo " +  $().data("rolei"));
   });
});
$().ready(function() {
...
if (hasLoaded) {
		...
		var btnSA = document.createElement('input');
		btnSA.setAttribute('type', 'button');
		btnSA.setAttribute('value', 'Actualizar');
		btnSA.onclick = function () {saveUpdateOTRow(this);};
		cell14.appendChild(btnSA);
...
function agregarUsuario(){
	...
	nuevaFila = document.getElementById("tablaDiagnostico").insertRow(-1);
		...
		nuevaCelda=nuevaFila.insertCell(-1);
                ...
                nuevaCelda=nuevaFila.insertCell(-1);
                nuevaCelda.innerHTML="<td bgcolor='#CCCCCC'> <input value='Actualizar' type='button' onclick='saveUsuario(this)'></td> ";
...
<body>
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=actualizaot">
  <div id="TabbedPanels1" class="TabbedPanels" style="width:1550px">
    <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0">Actualiza Cabecera OT</li>
    ...
    <img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
       ...
       <option value="<?php echo $item["c_desitm"]?>"<?php if($item["c_desitm"]==$c_solicita){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
              ...
              <tr>
                <td>Ejecutado por:</td>
                <td>
                <input name="c_ejecuta" type="text"  class="texto" id="c_ejecuta" size="25" required="required"  onfocus="validamoneda()" value="<?php echo $c_ejecuta ?>"/></td>
    ...
    <img src="../images/calendario.jpg" name="Image2" id="Image2" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        ...
        <div class="TabbedPanelsContent" >
            <table width="867" border="0">
                ...
                <tr>
                  ...
                  <td><input name="unidad" type="text" required="required"  class="texto" id="unidad" onclick="abreVentana(this.name)" size="35" value="<?php echo $unidad ?>" onkeypress="copiatext()" onblur="copiatext()"/><input name="codigoequipo" type="hidden" id="codigoequipo" size="5" readonly="readonly" class="texto" value="<?php echo $unidad ?>" /></td>
                </tr>
                <tr>
                  <td colspan="4"><hr /></td>
                </tr>
      ...
      <!--            <input type="hidden" name="n_igvd" id="n_igvd" />
        ...
        <table width="962" border="1" cellpadding="0" cellspacing="0" bordercolor="#003366" bgcolor="#FFFFFF" id="tablaDiagnostico" style="font-size:12px">
          <tr>
            ...
            <!--td width="95" align="center" valign="middle" bgcolor="#FFFFCC"><strong>Actualizar</strong></td-->
          </tr>
                  <?php 
                    if(!empty($reporteot))
                    {		
          ...
          <tr>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input type="hidden" name="<?php echo "c_rucprov".$i; ?>" id="<?php echo "c_rucprov".$i; ?>" value="<?php echo $itemD["c_rucprov"]; ?>"  />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "c_nomprov".$i; ?>" type="text" class="texto" id="<?php echo "c_nomprov".$i; ?>" value="<?php echo $itemD["c_nomprov"]; ?>" size="35" <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "concepto".$i; ?>" type="text" class="texto" id="<?php echo "concepto".$i; ?>" value="<?php echo $itemD["concepto"]; ?>" size="35" <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "c_tecnico".$i; ?>" type="text" class="texto" id="<?php echo "c_tecnico".$i; ?>" value="<?php echo $itemD["c_tecnico"]; ?>" size="12" <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "tdoc".$i; ?>" type="text" id="<?php echo "tdoc".$i; ?>" size="8" class="texto"value="<?php echo $itemD["tdoc"]; ?>"  <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "ndoc".$i; ?>" type="text" id="<?php echo "ndoc".$i; ?>" size="8" class="texto"value="<?php echo $itemD["ndoc"]; ?>" <?php echo !empty($itemD["fdoc"])?"disable":""; ?>  />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "fdoc".$i; ?>" type="text" id="<?php echo "fdocs".$i; ?>" size="8" class="texto"value="<?php echo $itemD["fdoc"]; ?>"  <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#99CCFF">
                <input name="<?php echo "monto".$i; ?>" type="text" id="<?php echo "monto".$i; ?>" size="8" class="texto"value="<?php echo $itemD["monto"]; ?>" <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "n_cant".$i; ?>" type="text" id="<?php echo "n_cant".$i; ?>" size="8" class="texto" value="<?php echo $itemD["n_cant"]; ?>" <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "n_igvd".$i; ?>" type="text" id="<?php echo "n_igvd".$i; ?>" size="8" class="texto" value="<?php echo $itemD["n_igvd"]; ?>" <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input name="<?php echo "n_totd".$i; ?>" type="text" id="<?php echo "n_totd".$i; ?>" size="8" class="texto" value="<?php echo $itemD["n_totd"]; ?>" <?php echo !empty($itemD["fdoc"])?"disable":""; ?>/>
            </td>
            <td align="center" valign="middle" bgcolor="#99CCFF">
                <input name="<?php echo "montop".$i; ?>" type="text" id="<?php echo "montop".$i; ?>" size="8" class="texto" value="<?php echo $itemD["montop"]; ?>" <?php echo !empty($itemD["fdoc"])?"disable":""; ?> />
            </td>
            <td align="center" valign="middle" bgcolor="#FFFFCC">
                <input type="button" name="button2" id="button2" value="Delete" onclick="eliminarUsuario(this);" />
            </td>
            <!--td align="center" valign="middle" bgcolor="#FFFFCC">
                <input type="button" name="button3" class="button3" data-rolei="<?php echo $i; ?>" value="Actualizar"  />
            </td-->
          </tr>
        <?php
                    $i++;
