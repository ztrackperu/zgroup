...
onkeyup = "compUsuario(event)" tabindex="1" autocomplete="off"/>
      ...
      <td><div id="DivDestino" style="width:150px">
      </div></td>
    </tr>
    <tr>
      <td>Tipo Ord. Serv.</td>
...
:
   ...
   <option value="<?php echo $item["c_numitm"]?>"><?php echo $item["c_desitm"]?></option>
    ...
    <tr>
      ...
      <td>:</td>
      <td colspan="2">
      <input type="text" name="c_codprov" id="c_codprov"  class="texto"/>
  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td>
        ...
        <a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" border="0" /></a>&nbsp; <input name="c_rh" type="checkbox" id="c_rh" value="1" onclick="rh()" />
        <label for="c_rh">Recibo /Honorario
