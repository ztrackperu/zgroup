...
cantFilas = theTable.rows.length;
		...
		alert ('Falta Detalle de Orden Servicio');
...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=guardaos">
<strong style="text-align:center">REGISTRO DE ORDEN SERVICIO</strong>(Plantilla Transporte Fluvial)
<fieldset class="fieldset legend">
 ...
 <input name="c_numos" type="text" disabled="disabled"  class="texto" id="c_numos" value="Autogenerado" readonly="readonly"/></td>
      ...
      <td width="14">:</td>
      <td width="549"><label for="c_refcoti"></label>
        <input name="c_refcoti" type="text"  class="texto" id="c_refcoti" value="100201" maxlength="11"/>
        Usuario:
        <input name="c_opcrea" type="text" id="c_opcrea" value="<?php echo $udni; ?>" readonly="readonly" class="texto"/></td>
    </tr>
    <tr>
      <td>Tipo Ord. Serv.</td>
      <td>:</td>
   ...
   <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_desitm"]=='COMPRA SERVICIO'){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
      ...
      <td>:</td>
      <td><label for="c_concepto"><input name="d_fecos" type="text"  class="texto" id="d_fecos" size="12"  value="<?php echo date('d/m/Y');?>" onkeyup = "this.value=formateafecha(this.value); "/><img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'"></label></td>
    </tr>
    <tr>
      <td>Moneda</td>
      <td>:</td>
   ...
   <option value="<?php echo $item["c_numitm"]?>"><?php echo $item["c_desitm"]?></option>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
      <input name="c_nomprov" type="text" required  class="texto" id="c_nomprov"  placeholder="Digite para Busqueda Proveedor " value="COLOME FLORTES FLOR DE MARIA" size="40"/>
     </td>
      <td>&nbsp;</td>
      <td>Ruc Proveedor</td>
      <td>:</td>
      <td>
      <input name="c_codprov" type="text"  class="texto" id="c_codprov" value="10407989169"/>
      Fecha -Inicio
      <label for="c_fecinicio"></label>
      <input name="c_fecinicio" type="text" id="c_fecinicio" size="12" class="texto" onkeyup = "this.value=formateafecha(this.value); " /><img src="../images/calendario.jpg" name="Image2" id="Image2" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
    ...
    <tr>
      <td>Asunto</td>
      <td>:</td>
      <td><input name="c_asunto" type="text"  class="texto" id="c_asunto" value="TRANSPORTE FLUVIAL PUCALLPA-IQUITOS " size="40"/></td>
      <td>&nbsp;</td>
      <td>Contacto</td>
      <td>:</td>
      <td><label for="c_contacto"></label>
        <input name="c_contacto" type="text" class="texto" id="c_contacto" value="HENRY COLOME" />
        Fecha Entrega    
        <label for="c_fecentrega"></label>
        <input name="c_fecentrega" type="text" id="c_fecentrega" class="texto" size="12" onkeyup = "this.value=formateafecha(this.value); " /><img src="../images/calendario.jpg" name="Image3" id="Image3" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
 ...
 <a style='cursor: pointer;' onClick="muestra_oculta('contenido_a_mostrar')" title=""><strong style="color:#B72643">Datos Adicionales Para Glosa Servicio</strong> <img src="../images/Transfer Document.png" alt="" width="18" height="18" /></a>
  ...
  <table width="984" border="0" cellspacing="0" cellpadding="0">
   ...
   <option value="<?php echo utf8_encode($item["c_desitm"]);?>"<?php if($item["c_desitm"]=='PUCALLPA'){?>selected<?php }?>><?php echo utf8_encode($item["c_desitm"]);?></option>
            <?php }	?>
          </select></td>
      ...
      <td width="177" bgcolor="#66CCCC"><label for="destino"></label><?php $ven = ListalugarM();?>
        <select name="destino" id="destino" class="Combos texto">
          ...
          <option value="<?php echo utf8_encode($item["c_desitm"]);?>"<?php if($item["c_desitm"]=='IQUITOS'){?>selected<?php }?>><?php echo utf8_encode($item["c_desitm"])?></option>
          <?php }	?>
        </select></td>
  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td><label for="descripcion"></label>
        <input name="descripcion" type="text"  class="texto" id="descripcion" value="SERVICIO DE TRANSPORTE" size="40"/>
        Glosa
        <label for="glosa"></label>
        <input name="glosa" type="text" class="texto" id="glosa" value="FLUVIAL - PUCALLPA - IQUITOS /   REEFER 40 TN 25" size="40" />
        <input name="codigo" type="hidden" id="codigo" value="NDND0000" size="5" />        Precio Unitario
        <label for="precio"></label>
        <input name="precio" type="text"  class="texto" id="precio" value="3000" size="5"/>        Cantidad
        <label for="cantidad"></label>
        <input name="cantidad" type="text"  class="texto" id="cantidad" value="1" size="5" />
        <input type="hidden" name="imp" id="imp" size="5"/> <a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" border="0" /></a>&nbsp;<input name="c_rh" type="checkbox" id="c_rh" onclick="rh()" value="1" checked="checked" />
        <label for="c_rh">R/H
    ...
    <tr>
      ...
      <td width="287">
        ...
        <select name="c_tratopag" id="c_tratopag" class="Combos texto">
          ...
          <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_desitm"]=='CONTADO'){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
          <?php }	?>
        </select></td>
      ...
      <td width="339"><label for="st"></label>
        <input name="st" type="text" class="texto" id="st" value="0" size="10"/></td>
    </tr>
    <tr>
      <td>Factura Pago</td>
      <td>&nbsp;</td>
      <td><?php $ven = ListaPlazoM();?>
        <select name="c_codpgf" id="c_codpgf"  class="Combos texto" onchange="formapago();">
         <option value="0">.::SELECCIONE::.</option>
          <?php foreach($ven as $item){?>
          <option value="<?php echo utf8_encode($item["c_numitm"])?>"<?php if($item["c_desitm"]=='CONTADO'){?>selected<?php }?>><?php echo utf8_encode($item["c_desitm"])?></option>
          <?php }	?>
        </select>
      ...
      <td><label for="igv"></label>
        <input name="igv" type="text" class="texto" id="igv" value="0" size="10"/></td>
    </tr>
    <tr>
      ...
      <td><label for="bi"></label>
        <input name="bi" type="text" class="texto" id="bi" value="0" size="10"/></td>
    </tr>
    <tr>
