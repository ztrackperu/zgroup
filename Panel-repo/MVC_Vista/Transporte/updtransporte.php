...
<div class="panel panel-primary">
  ...
  <div class="panel-heading">ACTUALIZAR CABECERA DE SERVICIO DE TRANSPORTE <?php echo $Id_servicio ?></div>
 <div>   
...
<!--fin modal alertas info-->   
 ...
 <form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=01&udni=<?php echo $_GET['udni']?>&mod=<?php echo $_GET['mod']?>&a=GuardarUpdCabTransporte" >
 	<div class="form-control-static" align="right">
       ...
       <div class="form-group">
          ...
          <div class="col-xs-2">
           <input autocomplete="off" id="forwarder" class="form-control input-sm"  type="text" placeholder="Nº Forwarder" value="<?php echo $DatosCabServ->c_nrofw ?>" readonly     />     	 
           <input id="c_nrofw" name="c_nrofw"  type="hidden" value="<?php echo $DatosCabServ->c_nrofw ?>"    />            
          </div>
          <div class="col-xs-1">             	 
             <label>S/F</label>  <input id="desab1" name="desab1"  type="checkbox" onClick="desabilitar1()" disabled   />            
          </div>          
                   		
            <label class="control-label col-xs-1">Tipo</label>
            <div class="col-xs-2">
             <input type="text" name="tipmov" id="tipmov" class="form-control input-sm" placeholder="Tipo Movimiento" value="<?php echo $tipmov ?>" readonly />
       ...
       <div class="form-group">       		
           ...
           <div class="col-xs-2">
             <input type="text" name="c_ruccli" id="c_ruccli"  class="form-control input-sm" value="<?php echo $DatosCabServ->c_ruccli ?>"   readonly />  
           </div> 
           <label class="control-label col-xs-1">Cliente</label>
           <div class="col-xs-3">
             <input type="text" name="c_nomcli" id="c_nomcli"  class="form-control input-sm" value="<?php echo utf8_encode($DatosCabServ->c_nomcli) ?>"  readonly /> 
            ...
            <div class="col-xs-2">
             <input type="text" name="d_fectran" id="d_fectran" <?php $d_fectran=$DatosCabServ->d_fectran; if($d_fectran!=""){$d_fectran=vfecha(substr($DatosCabServ->d_fectran,0,10));} ?>  value="<?php echo $d_fectran  ?>"  class="form-control datepicker input-sm" placeholder="Fecha de Servicio" />
        	</div>          
