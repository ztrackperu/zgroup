...
<!--fin modal alertas info-->   
 ...
 <form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=01&udni=<?php echo $_GET['udni']?>&mod=<?php echo $_GET['mod']?>&a=GuardarDetViaticos" >
 	...
 	<ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a  href="#alm" aria-controls="alm" role="tab" data-toggle="tab" >Datos Generales</a></li>
        <li role="presentation" ><a  href="#con" aria-controls="con" role="tab" data-toggle="tab" >Datos Deposito</a></li>
    </ul> 
    <!-- Inicia Tab panes -->
       ...
       <div class="form-group">
          ...
          <div class="col-xs-2">
             <select id="c_tipo" name="c_tipo"  class="form-control input-sm">
			  ...
			  ?>
              <option value="<?php echo $tippag->C_NUMITM; ?>"><?php echo $tippag->C_DESITM; ?></option>
              <?php } ?>
              </select>            
          </div>
          ...
          <div class="col-xs-2">
             <select id="c_moneda" name="c_moneda"  class="form-control input-sm">
			  ...
			  ?>
              <option value="<?php echo $tipmon->C_NUMITM; ?>"><?php echo $tipmon->C_DESITM; ?></option>
              <?php } ?>
              </select> 
          </div>	
          	<label class="control-label col-xs-1">Importe</label>
          <div class="col-xs-2">
           <input type="text"  name="n_importe"  id="n_importe" class="form-control input-sm" placeholder="Importe" onBlur="validaImporte();" onkeypress="return validaDecimal(event)"    />   	 
          </div>
       </div>         
