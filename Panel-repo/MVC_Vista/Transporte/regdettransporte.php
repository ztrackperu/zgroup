         ...
         <div class="form-group">
          ...
          <?php */?>
           <select id="c_codconsig" name="c_codconsig"  class="form-control input-sm" onChange="cambiarconsig()">
			  ...
			  ?>
              <option value="<?php echo $enti->Ent_Codi; ?>" <?php if($enti->Ent_Codi==$listarDetForwarder->Fwd_Csne){?>selected<?php }?>><?php echo $enti->Ent_Rsoc; ?></option>
              <?php } ?>
              </select>
     ...
     <div role="tabpanel"  <?php if($c_tipmov=='E'){ ?> id="expo"  class="tab-pane active"  <?php }else{ ?> class="tab-pane"<?php } ?>  >
	  ...
	  <div class="tab-content">      
        <div role="tabpanel" id="fwexpo" class="tab-pane active" >
         ...
         <div class="form-group">
          ...
          <div class="col-xs-3">
             ...
             <select id="Ec_idlinemar" name="Ec_idlinemar"  class="js-example-basic-single form-control input-sm" onChange="cambiarlineaexpo()">
              <option value="">SELECCIONE</option>
              <?php 
			  	$ListarLineaMaritima=$this->model->ListarLineaMaritima(); 
			    foreach ($ListarLineaMaritima as $lineamar){
       ...
       <div class="form-group">
            ...
            <div class="col-xs-1">
             <input type="text" name="horaretiro"  id="horaretiro" class="form-control input-sm" placeholder="Hora Retiro" style="width:85px;"  />            
            </div>           
