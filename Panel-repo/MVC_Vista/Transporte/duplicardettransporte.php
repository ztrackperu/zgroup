...
<!--fin modal alertas info-->   
 ...
 <form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=01&udni=<?php echo $_GET['udni']?>&mod=<?php echo $_GET['mod']?>&a=GuardarDetTransporte" >
 	<div class="form-control-static" align="right">
   	 <a class="btn btn-success" onClick="validarguardar();" href="#">Registrar</a>&nbsp;<a class="btn btn-danger" href="?c=01&udni=<?php echo $_GET['udni']?>&mod=<?php echo $_GET['mod']?>&a=AdminTransporte">Cancelar</a>&nbsp;<a class="btn btn-warning" onClick="location.reload();" >Refrescar</a>&nbsp;
    </div>  
	...
	<div role="tabpanel"  <?php if($c_tipmov=='I'){ ?> id="impo"  class="tab-pane active"  <?php }else{ ?> class="tab-pane"<?php } ?>  >
	  ...
	  <div class="tab-content">      
       ...
       <div class="form-group">
            ...
            <div class="col-xs-1">
             <input type="text" name="c_condemb" id="c_condemb"  class="form-control input-sm"  />
        	</div>          
            ...
            <?php /*?> <input type="text" name="c_idconsolidador"  id="c_idconsolidador" class="form-control input-sm" value="<?php echo $ListarDetalleUpd->c_idconsolidador; ?>"  /><?php */?><!-- solo en importacion-->            
             <select id="c_idconsolidador" name="c_idconsolidador"  class="form-control input-sm" onChange="cambiarconsolidador()">
              ...
              <input type="hidden" name="c_nomconsolidador"  id="c_nomconsolidador" class="form-control input-sm" value=""  /><!-- solo en importacion-->            
            </div>           
       ...
       <div class="form-group">  		         
            ...
            <div class="col-xs-2">
             <input type="text" name="c_numequipo" id="c_numequipo"  class="form-control input-sm" value="" placeholder="N° Equipo" />
        	</div>  
        ...
        <div class="form-group">                
            ...
            <div class="col-xs-1" >
             <input type="text" name="n_peso"  id="n_peso" class="form-control input-sm"  value=""   />            
            </div>
            <div class="col-xs-1">
            ...
            <div class="col-xs-1">
               <input type="text" name="n_volumen" id="n_volumen"  class="form-control input-sm" value=""  />  
            </div> 
            <div class="col-xs-1">
       ...
       <div class="form-group">    
            ...
            <div class="col-xs-1">
             <input type="text" name="n_pesobru"  id="n_pesobru" class="form-control input-sm" value="" />            
            </div>
            <div class="col-xs-1">
            ...
            <div class="col-xs-2">
             <input type="text" name="n_tara"  id="n_tara" class="form-control input-sm" value="" />            
            </div>
            <div class="col-xs-1">
            ...
            <div class="col-xs-1">
             <input type="text" name="n_payload"  id="n_payload" class="form-control input-sm" value="" />            
            </div>
            <div class="col-xs-1">
       ...
       <div class="form-group">
            ...
            <!-- <input type="text" name="c_idalmacen" id="c_idalmacen"  class="form-control input-sm" placeholder="Codigo" />   -->          
             ...
             <input type="hidden" name="c_nomalmacen" id="c_nomalmacen"  class="form-control input-sm" value="" placeholder="Nombre" />
            </div> 
       ...
       <div class="form-group">
            ...
            <div class="col-xs-2">
             <input type="text" name="n_impthc" id="n_impthc"  class="form-control input-sm" placeholder="Importe THC"  />
        	</div>               
            <div class="col-xs-2">
       ...
       <div class="form-group">  		         
            ...
            <div class="col-xs-1">
               <input type="text" name="n_impvb" id="n_impvb"  class="form-control input-sm"  placeholder="Importe VB"  />  
            </div>            
            <div class="col-xs-2">
            ...
            <div class="col-xs-2">
             <input type="text" name="n_dlibres"  id="n_dlibres" class="form-control input-sm"  placeholder="Sobreestadia"   />            
            </div>             
            <div class="col-xs-2">
             <input type="text" name="n_dlibelect" id="n_dlibelect"  class="form-control input-sm"  placeholder="Electricidad"  />
        	</div>   
    ...
    <div role="tabpanel"  <?php if($c_tipmov=='L'){ ?> id="local"  class="tab-pane active"  <?php }else{ ?> class="tab-pane"<?php } ?>  >
	  ...
	  <div class="tab-content">      
       ...
       <div class="form-group">  		         
            ...
            <div class="col-xs-2">
             <input type="text" name="c_eirconten" id="c_eirconten"  class="form-control input-sm"  placeholder="N° EIR" />
        	</div>
            <label class="control-label col-xs-3">Descripcion Contenedor</label>
            <div class="col-xs-3">
             <input type="text" name="c_desconten" id="c_desconten"  class="form-control input-sm"  placeholder="Descripcion Contenedor" />
        	</div>
        </div>      
         <!--fila8 -->
       <div class="form-group">  		         
       ...
       <div class="form-group">    
            ...
            <div class="col-xs-2">
             <input type="text" name="c_eirgen" id="c_eirgen"  class="form-control input-sm"  placeholder="N° EIR" />
        	</div>
            <label class="control-label col-xs-2">Descripcion Gen.</label>
            <div class="col-xs-2">
             <input type="text" name="c_desgen" id="c_desgen"  class="form-control input-sm" placeholder="Descripcion Generador" />
        	</div>
            <label class="control-label col-xs-1">Generador</label>
            <div class="col-xs-2">
             <input type="text" name="c_numgen" id="c_numgen"  class="form-control input-sm" placeholder="N° Generador" />
        	</div> 
        </div>
        <!--fin fila 9-->        
        ...
        <!--fin fila 10--> 
         ...
         <div class="form-group"> 
           <label class="control-label col-xs-2">Empresa Transporte </label>
            <div class="col-xs-2">
             <input autocomplete="off" type="text" name="c_nomtranspotel" id="c_nomtranspotel"  class="form-control input-sm" placeholder="Nombre o RUC"/>  
        	 <input type="hidden" id="c_ructransportel" name="c_ructransportel"   />  
             </div>
             <div class="col-xs-1">
            ...
            <div class="col-xs-2">
             <input type="text" name="c_choferl" id="c_choferl"  class="form-control input-sm" placeholder="Chofer" onFocus="abrirmodalTransl();" readonly />  
            </div>
            <div class="col-xs-1">
            ...
            <div class="col-xs-2">
             <input type="text" style="width:100px;" name="c_telefonol" id="c_telefonol"  class="form-control input-sm" placeholder="Telefono"  />  
            </div>         	   
        </div>
         <!--fila 6--> 
         <div class="form-group"> 
            ...
            <div class="col-xs-2">
            <input type="text" name="c_licencil" id="c_licencil"  class="form-control input-sm" placeholder="Licencia" data-validacion-tipo="requerido" /> 
        	</div>         	 
           <label class="control-label col-xs-1">Marca </label>
            <div class="col-xs-2">
             <input type="text" name="c_marcal" id="c_marcal"  class="form-control input-sm" placeholder="Marca" data-validacion-tipo="requerido" />  
        	</div>                       
            <label class="control-label col-xs-1">Placas</label>
            <div class="col-xs-2">
             <input type="text" name="c_placal" id="c_placal" class="form-control input-sm"  placeholder="Tracto"  data-validacion-tipo="requerido" />  
            </div> 
            <div class="col-xs-1">
             <input type="text" style="width:100px;" name="c_placa2l" id="c_placa2l" class="form-control input-sm"  placeholder="Carreta"  data-validacion-tipo="requerido" />  
            </div> 
     ...
     <div role="tabpanel"  <?php if($c_tipmov=='E'){ ?> id="expo"  class="tab-pane active"  <?php }else{ ?> class="tab-pane"<?php } ?>  >
	  ...
	  <div class="tab-content">      
       ...
       <div class="form-group">  		         
            <label class="control-label col-xs-2">N° Conten.</label>
            <div class="col-xs-2">
             <input type="text" name="Ec_numequipo" id="Ec_numequipo"  class="form-control input-sm" placeholder="N° Equipo"   />
        	</div> 
            <label class="control-label col-xs-2">Tipo de Contenedor</label>
            <div class="col-xs-2">
            ...
            <label class="control-label col-xs-2">Peso Carga</label>
            <div class="col-xs-2">
             <input type="text" name="En_peso"  id="En_peso" class="form-control input-sm"    />            
            </div>
            <div class="col-xs-1">
            ...
            <div class="col-xs-1">
               <input type="text" name="En_volumen" id="En_volumen"  class="form-control input-sm"  />  
            </div> 
            <div class="col-xs-1">
       ...
       <div class="form-group">    
            <label class="control-label col-xs-2">Peso Bruto</label>
            <div class="col-xs-1">
             <input type="text" name="En_pesobru"  id="En_pesobru" class="form-control input-sm"  />            
            </div>
            <div class="col-xs-1">
            ...
            <label class="control-label col-xs-1">Tara</label>
            <div class="col-xs-2">
             <input type="text" name="En_tara"  id="En_tara" class="form-control input-sm" />            
            </div>
            <div class="col-xs-1">
            ...
            <label class="control-label col-xs-1">Payload</label>
            <div class="col-xs-1">
             <input type="text" name="En_payload"  id="En_payload" class="form-control input-sm"  />            
            </div>
            <div class="col-xs-1">
       ...
       <div class="form-group">
            ...
            <div class="col-xs-1">
             <input type="text" name="horaretiro"  id="horaretiro" class="form-control input-sm" value="<?php echo $horaretiro; ?>" placeholder="Hora Retiro" style="width:85px;"  />            
            </div>          
        ...
        <!--fin fila 7-->  
         ...
         <div class="form-group"> 
           <label class="control-label col-xs-2">Empresa Transporte </label>
            <div class="col-xs-3">
             <input autocomplete="off" type="text" name="c_nomtranspote" id="c_nomtranspote" class="form-control input-sm" placeholder="Nombre o RUC"/>  
        	 <input type="hidden" id="c_ructransporte" name="c_ructransporte"   />  
             </div>
             <div class="col-xs-1">
                <button class="btn btn-success btn-sm" id="btn-agregar" type="button" onclick="agregarEmpTrans();"> 
                	<i class="glyphicon glyphicon-plus"></i>
            ...
            <label class="control-label col-xs-1">Chofer </label>
            <div class="col-xs-2">
             <input type="text" name="c_chofer" id="c_chofer"  class="form-control input-sm" placeholder="Chofer" onFocus="abrirmodalTrans();" readonly />  
            </div>
            <div class="col-xs-1">
         ...
         <div class="form-group"> 
         	<label class="control-label col-xs-2">Licencia Chofer</label>
            <div class="col-xs-2">
            <input type="text" name="c_licenci" id="c_licenci"  class="form-control input-sm" placeholder="Licencia" data-validacion-tipo="requerido" /> 
        	</div>         	 
           <label class="control-label col-xs-1">Marca </label>
            <div class="col-xs-2">
             <input type="text" name="c_marca" id="c_marca"  class="form-control input-sm" placeholder="Marca" data-validacion-tipo="requerido" />  
        	</div>                       
            <label class="control-label col-xs-1">Placas</label>
            <div class="col-xs-2">
             <input type="text" name="c_placa" id="c_placa" class="form-control input-sm"  placeholder="Tracto"  data-validacion-tipo="requerido" />  
            </div> 
            <div class="col-xs-1">
             <input type="text" style="width:100px;" name="c_placa2" id="c_placa2" class="form-control input-sm"  placeholder="Carreta"  data-validacion-tipo="requerido" />  
            </div> 
       ...
       <div class="form-group">
            ...
            <div class="col-xs-1">
             <input type="text" style="width:90px;" name="c_generador1" id="c_generador1"  class="form-control input-sm" placeholder="Principal" />  
        	</div>            
            <div class="col-xs-1">
             <input type="text" style="width:90px;" name="c_generador2" id="c_generador2"  class="form-control input-sm" placeholder="Reserva" />  
        	</div>             
       ...
       <div class="form-group">
			...
			?>
             ...
             <div class="col-xs-1">   
             <input type="text" name="horaingreso"  id="horaingreso" class="form-control input-sm" value="<?php echo $horaingreso; ?>" placeholder="Hora Ingreso" style="width:85px;"  />    
             </div>  
        ...
        <!--fin fila 9--> 
         ...
         <div class="form-group"> 
           <label class="control-label col-xs-2">Empresa Transporte </label>
            <div class="col-xs-3">
             <input autocomplete="off" type="text" name="c_nomtranspoteb" id="c_nomtranspoteb"  class="form-control input-sm" placeholder="Nombre o RUC"/>  
        	 <input type="hidden" id="c_ructransporteb" name="c_ructransporteb"   />  
             </div>
             <div class="col-xs-1">
                <button class="btn btn-success btn-sm" id="btn-agregar" type="button" onclick="agregarEmpTrans();"> 
                	<i class="glyphicon glyphicon-plus"></i>
            ...
            <label class="control-label col-xs-1">Chofer </label>
            <div class="col-xs-2">
             <input type="text" name="c_choferb" id="c_choferb" class="form-control input-sm" placeholder="Chofer" onFocus="abrirmodalTransb();" readonly />  
            </div>
            <div class="col-xs-1">
         ...
         <div class="form-group"> 
         	<label class="control-label col-xs-2">Licencia Chofer</label>
            <div class="col-xs-2">
            <input type="text" name="c_licencib" id="c_licencib"  class="form-control input-sm" placeholder="Licencia" data-validacion-tipo="requerido" /> 
        	</div>         	 
           <label class="control-label col-xs-1">Marca </label>
            <div class="col-xs-2">
             <input type="text" name="c_marcab" id="c_marcab"  class="form-control input-sm" placeholder="Marca" data-validacion-tipo="requerido" />  
        	</div>                       
            <label class="control-label col-xs-1">Placas</label>
            <div class="col-xs-2">
             <input type="text" name="c_placab" id="c_placab" class="form-control input-sm"  placeholder="Tracto"  data-validacion-tipo="requerido" />  
            </div> 
            <div class="col-xs-1">
             <input type="text" style="width:100px;" name="c_placa2b" id="c_placa2b" class="form-control input-sm"  placeholder="Carreta"  data-validacion-tipo="requerido" />  
            </div> 
       ...
       <div class="form-group">
       		<label class="control-label col-xs-2">Telefono</label>
            <div class="col-xs-2">
             <input type="text" name="c_telefonob" id="c_telefonob"  class="form-control datepicker input-sm" placeholder="Telefono"  />
        	</div> 
       		 <label class="control-label col-xs-1">Generadores</label>
            <div class="col-xs-1">
             <input type="text" style="width:90px;" name="c_generador1b" id="c_generador1b"  class="form-control input-sm" placeholder="Principal" />  
        	</div>            
            <div class="col-xs-1">
             <input type="text" style="width:90px;" name="c_generador2b" id="c_generador2b"  class="form-control input-sm" placeholder="Reserva" />  
        	</div>  	        
            <label class="control-label col-xs-2">Guia Transporte</label>
            <div class="col-xs-1">
       ...
       <div class="form-group"> 
            ...
            <div class="col-xs-2">
              ...
              <?php } ?>
               ...
               <input type="hidden" name="Ec_nomageaduana" id="Ec_nomageaduana"  placeholder="Nombre"   />
            </div>  
         ...
         <div class="form-group">
            ...
            <div class="col-xs-2">
              ...
              <?php } ?>
             	...
             	<input type="hidden" name="Ec_nomagemari" id="Ec_nomagemari" class="form-control input-sm" placeholder="Nombre"   />
        	 </div>          
    ...
    <!-- Fin Tab panes exportacion --> 
	 ...
	 <div role="tabpanel"  id="otros"  class="tab-pane">
         ...
         <div class="form-group">
            ...
            <div class="col-xs-2">
            	<input type="text" name="c_precivacio" id="c_precivacio" class="form-control input-sm" value="" placeholder="Precinto Vacio"  />             
            </div>                   
            <label class="control-label col-xs-1" style="width:150px;">Precinto Aduana</label>
            <div class="col-xs-2">
             <input type="text" name="c_preciaduana"  id="c_preciaduana" class="form-control input-sm" value="" placeholder="Precinto Aduana"   />            
            </div> 
            <label class="control-label col-xs-1" style="width:150px;">Precinto Zgroup</label>
            <div class="col-xs-2">
               <input type="text" name="c_precizgroup" id="c_precizgroup"  class="form-control input-sm" value="" placeholder="Precinto Zgroup"  />  
            </div>              
         </div>
         <!--fila 1-->        
         <div class="form-group">
            ...
            <div class="col-xs-2">
               <input type="text" name="c_precilinea" id="c_precilinea"  class="form-control input-sm" value="" placeholder="Precinto Linea 1"  />  
            </div>                   
            <label class="control-label col-xs-1" style="width:150px;">Precinto Linea 2</label>
            <div class="col-xs-2">
             <input type="text" name="c_precilinea2"  id="c_precilinea2" class="form-control input-sm" value="" placeholder="Precinto Linea 2"   />            
            </div> 
            <label class="control-label col-xs-1" style="width:150px;">Precinto Linea 3</label>
            <div class="col-xs-2">
               <input type="text" name="c_precilinea3" id="c_precilinea3"  class="form-control input-sm" value="" placeholder="Precinto Linea 3"  />  
            </div>              
         </div>
		<!--fila 2-->        
         <div class="form-group">       		                  
            ...
            <div class="col-xs-2">
             <input type="text" name="c_codterm1"  id="c_codterm1" class="form-control input-sm" value="" placeholder="Cod. Termoregistrador 1"   />            
            </div> 
            <label class="control-label col-xs-1" style="width:150px;">Cod. Termoreg.2</label>
            <div class="col-xs-2">
               <input type="text" name="c_codterm2" id="c_codterm2"  class="form-control input-sm" value="" placeholder="Cod. Termoregistrador 2"  />  
            </div>              
         </div>
		 <!--fila 3-->        
         <div class="form-group">
            ...
            <div class="col-xs-2">
            	<input type="text" name="c_temp" id="c_temp" class="form-control input-sm" value="" placeholder="Temperatura"  />             
            </div>                   
            <label class="control-label col-xs-1" style="width:150px;">Ventilacion</label>
            <div class="col-xs-2">
             <input type="text" name="c_venti"  id="c_venti" class="form-control input-sm" value="" placeholder="Ventilacion"   />            
            </div> 
            <label class="control-label col-xs-1" style="width:150px;">Humedad</label>
            <div class="col-xs-2">
               <input type="text" name="c_humedad" id="c_humedad"  class="form-control input-sm" value="" placeholder="Humedad"  />  
            </div>              
         </div>
		 <!--fila 4-->        
         <div class="form-group">
            ...
            <div class="col-xs-2">
            	<input type="text" name="c_oxigeno" id="c_oxigeno" class="form-control input-sm" value="" placeholder="%Oxigeno"   />             
            </div>                   
            <label class="control-label col-xs-1" style="width:150px;">%Diox.Carb.(CO2)</label>
            <div class="col-xs-2">
             <input type="text" name="c_dioxido"  id="c_dioxido" class="form-control input-sm" value="" placeholder="%Dioxido de Carbono"   />            
            </div> 
            <label class="control-label col-xs-1" style="width:150px;">Codigo Purfresh</label>
            <div class="col-xs-2">
               <input type="text" name="c_codpurfresh" id="c_codpurfresh"  class="form-control input-sm" value="" placeholder="Codigo Purfresh"  />  
            </div>              
         </div>
	 </div> <!--fin div otros-->
