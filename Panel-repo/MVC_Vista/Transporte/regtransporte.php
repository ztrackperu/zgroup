...
<!--fin modal alertas info-->   
 ...
 <form class="form-horizontal" id="Frmregcoti" name="Frmregcoti" method="post" action="?c=01&udni=<?php echo $_GET['udni']?>&mod=<?php echo $_GET['mod']?>&a=GuardarCabTransporte" >
 	<div class="form-control-static" align="right">
       ...
       <div class="form-group">
          ...
          <div class="col-xs-2">
           <input autocomplete="off" id="forwarder" class="form-control input-sm"  type="text" placeholder="Nº Forwarder"   />     	 
           <input id="c_nrofw" name="c_nrofw"  type="hidden"   />            
          </div>
          <div class="col-xs-1">             	 
             <label>Local</label>  <input id="desab1" name="desab1" value="1" type="checkbox" onClick="desabilitar1()"   />            
          </div>          
                   		
            <label class="control-label col-xs-1">Tipo</label>
            <div class="col-xs-2">
             <input type="text" name="tipmov" id="tipmov" class="form-control input-sm" placeholder="Tipo Movimiento" />
        	 <input type="hidden" name="c_tipmov" id="c_tipmov" />
        	</div>        
