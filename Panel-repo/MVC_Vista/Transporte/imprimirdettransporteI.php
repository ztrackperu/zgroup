...
<table width="750" border="0">
   <tr>
    <td colspan="2">
        <img src="assets/img/logo.png" width="46%" height="14%" /> 
    </td>
    <td colspan="2" align="center">        
        <img src="assets/img/pscargo.jpg" width="55%" height="14%" />
    </td>
  </tr>
  <tr>
    <td colspan="4"><b>REPORTE IMPORTACION FW NRO:</b> <?php echo $ListarDetalleUpd->c_nrofw ?></td>
    </tr>
  <tr>
