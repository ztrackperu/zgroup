...
if(c_idconcepto=='PEAJE'){
		...
		$("#c_descripcion").autocomplete({
			...
			select: function (e, ui) {
				...
				$("#c_descripcion").val(ui.item.c_descripcion);         
			}
		})
...
//maxDate: fecha tope D=días | M=mes | Y=año
  ...
  function validarguardar(){
	 ...
	 //requerido para el area contable mod=1
	 if(mod=='1'){
      ...
      <!-- para volver-->
       ...
       <div class="form-group">       		                
            ...
            <div class="col-xs-2">
             ...
             <input type="text" name="c_descripcion" id="c_descripcion"  class="form-control input-sm" placeholder="Descripcion" value="<?php echo $listarupdviatico->c_descripcion ?>" />
        	</div> 
