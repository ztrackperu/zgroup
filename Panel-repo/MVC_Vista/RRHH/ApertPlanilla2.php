...
var suel = cant.substring(7,10);
	...
	var dscf=(parseFloat(Sueldob)/30)*dif;
	...
	var salud=(parseFloat(trb)-(parseFloat(desc_falt)+parseFloat(desc_adel)))*0.09;  
	document.getElementById("AE_Salud"+im10).value=Math.round(salud*100)/100;
	
	
	var remun=trb-d_pagos;
	document.getElementById("total_pag"+im8).value=Math.round(remun*100)/100;
	...
	if(anio==fecActual && mes<7){
	 ...
	 if(remubrutaproyectada >deduuit)
	 {
	   ...
	   if(rentaAquinta<=(27*uit)){
	    	var impuestoa=rentaAquinta*0.15;
	   }
	   if(rentaAquinta>(27*uit) && rentaAquinta<=(54*uit) ){
		    var impuestoa=rentaAquinta*0.21;
	   }
	    if(rentaAquinta>(54*uit) ){
		    var impuestoa=rentaAquinta*0.30;
	   }
...
<form id="formElem" name="formElem" method="post" action="../MVC_Controlador/rrhhC.php?acc=IngresaPlani">
 ...
 <table width="1050" height="108" border="1" cellspacing="0" id="tablaDiagnostico">
          <thead>
            <tr>
              ...
              <div align="center">PLANILLA2 - <label>PERIODO  </label><label><?php echo $_GET['nm'].'-'.$_GET['an'];?></label><label>EMPRESA: <?PHP echo $_GET['emp']?></label></div>
              </th>
            </tr>
            <tr>
              <th width="8"  bgcolor="#66CCCC">#</th>
              <th width="52" bgcolor="#66CCCC">Usuario</th>
              <th width="52" bgcolor="#66CCCC">Empleado</th>
              ...
              <th width="75" bgcolor="#66CCCC">Aporte Oblig.</th>
              ...
              <th width="60" bgcolor="#66CCCC">Otros Desc. </th>
   ...
   <!--           <th width="27" bgcolor="#66CCCC">Sctr</th>
    ...
    $dm=(domingos_del_mes($mes,$anno));
          ...
          <td height="28"><input name="<?php echo "userid".$i; ?>" type="text" id="<?php echo "userid".$i; ?>" value="<?php echo $itemD["userid"];  ?>"  class="texto" size="8"/></td>
          <td><label for="textfield"></label>
            <input type="text" name="<?php echo "nombre".$i; ?>" id="<?php echo "nombre".$i; ?>" value="<?php echo $itemD["nombre"];  ?>" class="texto"/></td>
          <td><input name="<?php echo "d_trab".$i; ?>" type="text"  class="texto" id="<?php echo "d_trab".$i; ?>"  value="<?php echo '30';  ?>" size="6" onkeyup="calcular(this.name)"/></td>
          <td><input name="<?php echo "d_falt".$i; ?>" type="text" class="texto" id="<?php echo "d_falt".$i; ?>"  value="<?php  echo '0' ?> " size="6" onkeyup="calcular(this.name)" /></td>
          <td height="30"><input name="<?php echo "basico".$i; ?>" type="text" id="<?php echo "basico".$i; ?>" value="<?php echo $sb=$itemD["sueldob"];  ?>" readonly="readonly" class="texto"  size="6" onkeyup="calcular(this.name)"/></td>
          <td><input name="<?php echo "asig_fam".$i; ?>" type="text" id="<?php echo "asig_fam".$i; ?>" value="<?php echo $itemD["asigf"] ?>" readonly="readonly"  class="texto" size="8" onkeyup="calcular(this.name)"/></td>
          <td><input name="<?php echo "Otros_Ing".$i; ?>" type="text"  class="texto" id="<?php echo "Otros_Ing".$i; ?>" value="<?php echo $itemD["Otros_Ing"] ?>" size="6"/>
            <a href="#" onclick="abreVentana('<?php echo $itemD["userid"];?>','<?php echo $_GET['me'];?>','<?php echo $_GET['an'];?>')"><img src="../images/ico_ver.png" width="14" height="16" border="0" /></a></td>
          <td><input name="<?php echo "TotalRemuB".$i; ?>" type="text"  class="texto" id="<?php echo "TotalRemuB".$i; ?>" value="<?php echo $itemD["TotalRemub"] ?>" onkeyup="calcular(this.name)" size="6"/></td>
		  <td><input type="text" name="<?php echo "SistemaP".$i; ?>" id="<?php echo "SistemaP".$i; ?>" class="texto"  size="6" value="<?php echo $itemD["SistemaP"];?>" /></td>
          <td><input name="<?php echo "AprtObl".$i; ?>" type="text" class="texto" id="<?php echo "AprtObl".$i; ?>" onkeyup="calcular()" value="<?php echo  $itemD["AprtObl"];?>" size="8" readonly="readonly"/></td>
          <td><input name="<?php echo "ComiRA".$i; ?>" type="text" class="texto" id="<?php echo "ComiRA".$i; ?>" onkeyup="calcular()" value="<?php echo $itemD["ComiRA"];?>"  size="8" readonly="readonly"/></td>
          <td><input name="<?php echo "PrmSeg".$i; ?>" type="text" class="texto" id="<?php echo "PrmSeg".$i; ?>" onkeyup="calcular()" value="<?php  echo $itemD["PrmSeg"];?>" size="10" readonly="readonly"/></td>
          <td><input name="<?php echo "DescToPen".$i; ?>" type="text" class="texto" id="<?php echo "DescToPen".$i; ?>"  value="<?php  echo $itemD["DescToPen"];?>" onkeyup="calcular()"  size="8"/></td>
          <td><input name="<?php echo "desc_falt".$i; ?>" type="text"  class="texto" id="<?php echo "desc_falt".$i; ?>" value="<?php  echo $itemD["desc_falt"];?>" onkeyup="calcular()" size="8"/></td>
          
          <td><input name="<?php echo "desc_adel".$i; ?>" type="text" id="<?php echo "desc_adel".$i; ?>" value="<?php $t=$itemD["desc_adel"]; if($t==NULL){echo '0';}else{echo $itemD['desc_adel'];} ?>"   class="texto" onkeyup="calcular()" size="8"/><a href="#" onclick="abreVentana2('<?php echo $itemD["userid"];?>','<?php echo $_GET['me'];?>','<?php echo $_GET['an'];?>')"><img src="../images/ico_ver.png" width="14" height="16" border="0" /></a></td>
          <td><input name="<?php echo "desc_quinta".$i; ?>" type="text" id="<?php echo "desc_quinta".$i; ?>"   class="texto" value="<?php  echo $itemD["desc_falt"];?>" onkeyup="calcular()" size="8"/></td>
          <td><input name="<?php echo "d_pagos".$i; ?>" type="text" class="texto" id="<?php echo "d_pagos".$i; ?>" value="<?php  echo $itemD["d_pagos"];?>" onkeyup="calcular()"  size="8"/></td>
          <td><input name="<?php echo "total_pag".$i; ?>" type="text"  class="texto" id="<?php echo "total_pag".$i; ?>"  value="<?php  echo $itemD["total_pag"];?>" onkeyup="calcular()"/ size="8"></td>
             <td height="28"><label for="textfield22"></label>
      <input name="<?php echo "AE_Salud".$i; ?>" type="text"  class="texto" id="<?php echo "AE_Salud".$i; ?>" value="<?php echo $itemD["AE_Salud"]; ?>" size="8"/></td>
    <td>
