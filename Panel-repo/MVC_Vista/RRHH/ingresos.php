...
<body>
<form id="form1" name="form1" method="post" action="../MVC_Controlador/rrhhC.php?acc=InsIngr" >
<table border="1" bgcolor="#E1E1E1">
  <tr>
    <td colspan="5" align="center"><strong>Registro de Ingresos</strong></td>
    </tr>
  <tr>
    <td width="110">Mes</td>
    ...
    <td width="114">Tipo Ingreso</td>
    <td width="144"><?php $ven = listartipoingC(); ?>
      <select name="tipoing" id="tipoing" class="Combos texto"  >
  ...
  <tr>
    ...
    <td><label for="docref"></label>
      <input type="text" name="docref" id="docref" class="texto" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Fecha de Adelanto</td>
    <td>
    <input name="fechaAde"  class="texto" id="fechaAde" type="text" onkeyup = "this.value=formateafecha(this.value); " required  placeholder="Ingrese fecha->" />
    ...
    <td>Monto</td>
    <td><input type="number" name="monto" id="monto" class="texto"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
