...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/MisturaC.php?acc=m31">
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>HISTORIAL DE PAQUETES INGRESADOS Y RETIRADOS</div>
      <br class="clear"/>
					<div class="content">
					  <table width="85%" border="1" align="center" cellpadding="0" cellspacing="0"  >
					    ...
					    <tr>
					      <td align="right" >Ver Todos</td>
					      <td align="left" ><input name="checkbox" type="checkbox" id="checkbox" value="1" />
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data">
                          <thead>
                              <tr align="center">
                                <td colspan="5"><a href="../MVC_Controlador/MisturaC.php?acc=m30">Retornar</a>&nbsp;</td>
                              </tr>
                              <tr align="center">
                                <td width="27" bgcolor="#CCCCCC">Nro</td>
      <td width="116" bgcolor="#CCCCCC">Cliente</td>
      <td width="85" bgcolor="#CCCCCC">Total Paquetes Ingresado </td>
      <td width="93" bgcolor="#CCCCCC">Total Paquetes Retirados</td>
      <td width="85" bgcolor="#CCCCCC">Diferencia</td>
      </tr>
                          </thead>
                          <tbody>
                              <?php 
      ...
      <td align="center"><?php echo $item["totalingresados"];?></td>
      <td align="center"><?php echo $item["totalretirados"];?></td>
      <td align="center"><?php echo $dif=$item["totalingresados"]-$item["totalretirados"];?></td>
      </tr>
