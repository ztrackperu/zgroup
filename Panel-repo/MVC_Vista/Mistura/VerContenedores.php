...
<body>
<div class="onecolumn">
                    <div class="header"> <span>CONTENEDORES</span></div>
                    <br class="clear"/>
                    <div class="content">
                        <table class="data" width="764" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            ...
                            <tbody>
                            <?php $verListaNosotros = ListaContenedor2C();?>
                                <?php 
                    $i = 1;
            ...
            ?>
                                <tr>
                                  ...
                                  <td bgcolor="#E5E5E5"> <B><?php echo $item["descripcion_contenedor"];?> </td>
                                    
                                  <td bgcolor="#FFFFCC"><?php if($item["estado"]==1){echo "Activo";}else{echo"No Activo";}?></td>
                                    <td bgcolor="#FFFFFF"><a href="../MVC_Controlador/MisturaC.php?acc=m2&amp;dato=<?php echo $item["id_contenedor"];?>&amp;udni=<? echo $udni;?>"> <img src="../images/icon_edit.png" alt="editar" width="20" height="20" class="help" title="Editar" /></a>&nbsp;</td>
                                   <?php  if($tbu!="c1"){?> <?php }?>
                                </tr>
                                <?php
                        $i += 1;
            ...
            ?>
                        ...
                        Agregar <a href="../MVC_Controlador/MisturaC.php?acc=m4&amp;udni=<? echo $_GET['udni'];?>"><img src="../images/nuevo.png" width="48" height="48" /></a>
