...
<body>
<div class="onecolumn">
                    <div class="header">GRUPOS DE CLIENTES (USUARIOS MISTURA)</div>
                       Agregar <a href="../MVC_Controlador/MisturaC.php?acc=m9&amp;udni=<? echo $_GET['udni'];?>"><img src="../images/nuevo.png" width="48" height="48" /></a><br class="clear"/>
                    <div class="content">
                        <table class="data" width="764" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            ...
                            <tbody>
                            <?php $verListaNosotros = ListagrupoC();?>
                                <?php 
                    $i = 1;
            ...
            ?>
                                <tr>
                                    <td><?php echo $item["id_grupo"];?></td>
                                  <td bgcolor="#E5E5E5"> <B><?php echo $item["nombre_grupo"];?> </td>
                                    
                                  <td bgcolor="#FFFFCC"><?php if($item["estado"]==1){echo "Activo";}else{echo"No Activo";}?></td>
                                    <td bgcolor="#FFFFFF"><a href="../MVC_Controlador/MisturaC.php?acc=m7&amp;dato=<?php echo $item["id_grupo"];?>&amp;udni=<? echo $udni;?>"> <img src="../images/icon_edit.png" alt="editar" width="20" height="20" class="help" title="Editar" /></a>&nbsp;</td>
                                   <?php  if($tbu!="c1"){?> <?php }?>
                                </tr>
                                <?php
                        $i += 1;
