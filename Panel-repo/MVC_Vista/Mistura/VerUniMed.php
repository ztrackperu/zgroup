...
<body>
<div class="onecolumn">
                    <div class="header">UNIDAD DE MEDIDA</div>
                      Agregar <a href="../MVC_Controlador/MisturaC.php?acc=m19&amp;udni=<? echo $_GET['udni'];?>"><img src="../images/nuevo.png" width="48" height="48" /></a><br class="clear"/>
                    <div class="content">
                        <table class="data" width="764" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                    <th width="6%" style="width:5%">Item</th>
                                    <th width="35%" style="width:30%"><p>Medida<BR>
                                    </p></th>
                            ...
                            <tbody>
                            <?php $verunidad = ListaunidadmedidaC();?>
                                <?php 
                    $i = 1;
                    foreach($verunidad as $item)
                    {
            ?>
                                <tr>
                                    <td><?php echo $item["id_medida"];?></td>
                                  <td bgcolor="#E5E5E5"> <B><?php echo $item["nombre_medida"];?> </td>
                                    
                                  <td bgcolor="#FFFFCC"><?php if($item["estado"]==1){echo "Activo";}else{echo"No Activo";}?></td>
                                    <td bgcolor="#FFFFFF"><a href="../MVC_Controlador/MisturaC.php?acc=m17&amp;dato=<?php echo $item["id_medida"];?>&amp;udni=<? echo $udni;?>"> <img src="../images/icon_edit.png" alt="editar" width="20" height="20" class="help" title="Editar" /></a>&nbsp;</td>
                                   <?php  if($tbu!="c1"){?> <?php }?>
                                </tr>
                                <?php
                        $i += 1;
