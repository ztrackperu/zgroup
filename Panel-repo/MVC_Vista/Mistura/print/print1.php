...
function Header()
{
	...
	$this->Cell(0,0,'INGRESO DE PAQUETES',0,1,'B');
	$this->Ln(1);
...
and id_empleado=udni and p.id_usuario = '$idusuario' and p.id_empleado='$idempleado' and m.estado='1'  order by id_paquete desc";
