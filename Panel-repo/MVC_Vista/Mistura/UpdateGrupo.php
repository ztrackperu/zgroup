<?php 
if($obtenergrupo!=NULL)
{
	foreach ($obtenergrupo as $item)
	{
...
<form name="form1" id="form1" method="post" 
 action="../MVC_Controlador/MisturaC.php?acc=m8">
<table width="531" border="0">
  <tr>
    <td style="color:#039">MODIFICACION DATOS DE GRUPOS</td>
  </tr>
</table>
...
<table width="532" border="0">
  <tr>
    ...
    <td width="518"><input name="textfield"  class="texto" type="text" id="textfield" value="<?=$nombre_grupo?>" size="25">
      <input type="hidden" name="hiddenField" id="hiddenField" value="<?php echo $id_grupo?>">
      <input type="hidden" name="hiddenField2" id="hiddenField2" value="<?php echo $_GET['udni'];?>"></td>
  </tr>
  <tr>
    <td width="159">Descripcion</td>
    <td><input name="textfield2"  class="texto" type="text" value="<?=$descripcion_grupo?>" size="25"></td>
  </tr>
  <tr>
