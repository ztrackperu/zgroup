...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/MisturaC.php?acc=m27">
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>VER DETALLE DE PAQUETES</div>
      <br class="clear"/>
					<div class="content">
					  <table width="85%" border="1" align="center" cellpadding="0" cellspacing="0"  >
					    <tr>
					      <td width="50%" height="39" align="right" >Ingresar Paquete</td>
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data">
                            <thead>
                                <tr align="center">
                                  <td colspan="11"><a href="../MVC_Controlador/MisturaC.php?acc=m26">Retornar</a>&nbsp;</td>
                                </tr>
                                <tr align="center">
      ...
      <td width="88" bgcolor="#CCCCCC">Registrado por</td>
      <td width="75" bgcolor="#CCCCCC">Fecha Ingreso</td>
      <td width="73" bgcolor="#CCCCCC">Hora Ingreso</td>
      <td width="79" bgcolor="#CCCCCC">Fecha Egreso</td>
      <td width="70" bgcolor="#CCCCCC">Hora Egreso</td>
      </tr>
                            </thead>
                            <tbody>
                                <?php 
      ...
      <td align="center"><?php echo $item["id_empleado"];?></td>
      <td align="center"><?php echo $item["fecha"];?></td>
      <td align="center"><?php echo $item["hora"];?></td>
      <td align="center"><?php echo $item["fecha_egreso"];?></td>
      <td align="center"><?php echo $item["hora_egreso"];?></td>
      </tr>
