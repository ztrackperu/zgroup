...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=mguia">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>Reporte de Guias de Remision</div>
      <br class="clear"/>
					<div class="content">
  ...
  <option value="PDF" id="opcion3">PDF </option>
					    ...
					    <tr>
					      <td colspan="3" ><strong>Guias Generadas en  Almacen</strong></td>
				        </tr>
				      </table>
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
                            <thead>
                                <tr align="center">
                                  <td colspan="8">
                                  Leyenda:Venta=V,Alquiler A,Reparacion R<br /><a href="../MVC_Controlador/cajaC.php?acc=re27">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a></td>
                                </tr>
                                <tr align="center">
                                  <td width="40" bgcolor="#CCCCCC">Nro</td>
      <td width="75" bgcolor="#CCCCCC">Nro Guia</td>
      <td width="165" bgcolor="#CCCCCC">Cliente</td>
      <td width="119" bgcolor="#CCCCCC">Fecha Emision</td>
      <td width="166" bgcolor="#CCCCCC">Descripcion Producto</td>
      <td width="122" bgcolor="#CCCCCC">Serie Producto</td>
      <td width="145" bgcolor="#CCCCCC">Estado  Producto</td>
      ...
      <td align="center"><?php echo $item["c_codprd"];?></td>
