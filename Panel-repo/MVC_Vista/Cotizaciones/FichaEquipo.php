        ...
        <table width="796" border="0" align="left" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="3"><input name="c_codprd" type="text" class="texto" id="c_codprd" value="<?php echo $des ?>" size="35" />
              ...
              <input type="text" name="c_idequipo" id="c_idequipo"  value="<?php echo $idequipo ?>" class="texto" /></td>
          </tr>
          <tr>
...
<?php */?>
          ...
          <tr>
            ...
            <td>Fabricacante</td>
            <td><input type="text" name="c_cfabri" id="c_cfabri" class="texto" value="<?php echo $c_cfabri ?>" /></td>
          </tr>
          <tr>
            <td>Color</td>
          ...
          <tr>
            ...
            <!---->
            <td>Serial Nro</td>
            <td><input type="text" name="c_serieequipo" id="c_serieequipo" class="texto"  value="<?php echo $c_serieequipo ?>"/></td>
          </tr>
          <tr>
            <td>Procedencia</td>
