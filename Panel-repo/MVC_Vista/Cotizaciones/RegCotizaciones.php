...
document.getElementById('idmoneda').value=document.formElem.moneda.options[document.formElem.moneda.selectedIndex].value;
...
//	var sw=document.getElementById("vcombo").value
    var cambio=document.getElementById('prueba').value;
	//var moneda=document.formElem.moneda.value;
	//var idmoneda=document.getElementById('idmoneda').value;	

    $("#moneda").change(function(){
        var moneda = $("#moneda").val().replace('moneda ','');
      
			
	//$("#descripcion").autocomplete("../MVC_Controlador/cajaC.php?acc=proautocoti2", {
	$("#descripcion").autocomplete("../MVC_Controlador/cajaC.php?acc=proautocoti2&moneda="+moneda+"&cambio="+cambio+"", {	
		width: 260, 											
		matchContains: true,
		selectFirst: false
	});		
...
function ventanaArticulos(){	
 ...
 var idmoneda=document.getElementById('idmoneda').value;	
	...
	if (codigo=="") {
		...
		miPopup = window.open("../MVC_Controlador/cajaC.php?acc=verarti&udni=<?php echo $udni;?>&moneda="+idmoneda+"&cambio="+cambio+"","miwin","width=700,height=500,scrollbars=yes");
		miPopup.focus();
	}
}				
</script>
...
<form action="../MVC_Controlador/cajaC.php?acc=guardacoti"  method="post" enctype="multipart/form-data" name="formElem" id="formElem">
  ...
  <fieldset class="fieldset legend">
    ...
    <table width="1110" height="144" border="0">
   ...
   <option value="<?php //echo $item["c_numitm"]?>"><?php //echo $item["c_desitm"]?></option>
           ...
           <td width="201" bgcolor="#CCCCCC"><?php $ven = ListaMonedaC();?>
...
<option value="0">-</option>
    ...
    <tr>
      ...
      <td colspan="7" bgcolor="#CCCCCC"><!--<button type="button" class="positive" name="save5" onclick="linki2()"> Consultar</button>-->
        ...
        Codigo        
        <input name="hc" type="text" id="hc" size="10" class="texto"/>
        Direccion
        <input name="direc" type="text" id="direc" size="30" class="texto" />
         Dcto Ref
     
        <input type="text" size="10" name="c_numocref" id="c_numocref"  class="texto" /></td>
      </tr>
    <tr>
