...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=repcoti01">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>COTIZACIONES PARA FACTURAR</div>
      <br class="clear"/>
					<div class="content">
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
                          <thead>
                              ...
                              <tr align="center">
                                <td width="35" bgcolor="#CCCCCC">Nro</td>
      <td width="94" bgcolor="#CCCCCC">Nro Pedido</td>
      <td width="128" bgcolor="#CCCCCC">Cliente</td>
      <td width="171" bgcolor="#CCCCCC">Descripcion</td>
      <td width="138" bgcolor="#CCCCCC">Contacto</td>
      <td width="100" bgcolor="#CCCCCC">Telefono</td>
      <td width="83" bgcolor="#CCCCCC">Fecha</td>
      <td width="69" bgcolor="#CCCCCC">Ver detalle</td>
      </tr>
                          </thead>
                          <tbody>
                              <?php 
