...
<table width="773" border="1" align="left">
  ...
  <tr>
    <td>Razon Social</td>
    <td colspan="3"><input name="textfield3" type="text" class="texto" id="textfield3" size="50" value="<?php echo $razon;?>" /></td>
  </tr>
  <tr>
    <td>Nombre Comercial</td>
    <td colspan="3"><input name="textfield4" type="text" class="texto" id="textfield4" size="50" value="<?php echo $razon2; ?>" /></td>
  </tr>
  <tr>
    <td>Direccion 1</td>
    <td colspan="3"><input name="textfield5" type="text" id="textfield5" class="texto" size="70" value="<?php echo  utf8_decode($dir1); ?>" /></td>
  </tr>
  <tr>
    <td>Direccion 2</td>
    <td colspan="3"><input name="textfield6" type="text" id="textfield6" class="texto" size="70" value="<?php echo utf8_decode($dir2) ?>"/></td>
  </tr>
  <tr>
    <td>Telf:</td>
