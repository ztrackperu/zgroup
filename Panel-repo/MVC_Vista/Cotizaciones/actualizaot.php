...
<title>Actualiza de Orden Trabajo</title>
...
var valor2 = <?php echo $cantDiagnosticos; ?>;
var posicionCampo2=valor2+1;
...
function linkgraba(){
		// sumarcolumnatabla();
		 	 if(confirm("Seguro de Actualizar Orden Trabajo ?")){
...
<body>
Actualiza de Orden de Trabajo
<form action="../MVC_Controlador/cajaC.php?acc=updateot"  method="post"  name="formElem" id="formElem">
...
<table width="910" height="162" border="0">
  ...
  <tr>
    ...
    <td colspan="3"><label for="textfield"></label>
      <input name="textfield"  class="texto" type="text" id="textfield" size="70"  value="<?php echo $ot_descr ?>"/>
      <input type="hidden" name="hiddenField2" id="hiddenField2" value="<?php echo $_GET['udni']; ?>" /></td>
    <td width="266" bgcolor="#FFFFFF">Nro de Orden
      <input name="ot_nro"  type="text" class="texto" id="ot_nro" value="<?php echo $ot_nro ?>" size="15" />      <input type="hidden" name="hiddenField" id="hiddenField" value="<?php echo $_GET['udni']; ?>"/></td>
  </tr>
  <tr>
    <td>REALIZADO POR</td>
  ...
  <tr>
    <td>Buscar Equipo</td>
    <td width="240">
      <input name="textfield3"  class="texto" type="text" id="textfield3" size="40" value="<?php echo $ot_equipo ?>"/>
   </td>
    <td width="111">Marca</td>
    <td width="137"><input name="textfield7"  class="texto" type="text" id="textfield7" size="20" value="<?php echo $ot_mar ?>" /></td>
    </tr>
  <tr>
    <td>Serie</td>
    <td><input name="textfield9"  class="texto" type="text" id="textfield9" size="40" value="<?php echo $ot_serie ?>" /></td>
    <td>Modelo</td>
    <td><input name="textfield8"  class="texto" type="text" id="textfield8" size="20" value="<?php echo $ot_mod ?>"/></td>
    </tr>
  <tr>
    <td>Solicitado Por</td>
    <td colspan="4">
      <input name="textfield5"  class="texto" type="text" id="textfield5" size="30" value="<?php echo $ot_soli ?>"/>
      Resp.de Ejecucion</label>
      
      <input name="textfield10"  class="texto" type="text" id="textfield10" size="30" value="<?php echo $ot_res ?>" />
      Fecha  ejecucion
<input name="fecha"  type="text" class="texto" id="fecha" size="12" readonly="readonly" value="<?php 
echo vfecha(substr($ot_fecejc,0,10))?>"/>
  ...
  <tr>
    ...
    <td colspan="4"><input name="textfield6"  class="texto" type="text" id="textfield6" size="30" value="<?php echo $ot_aut ?>"/>
      Sup Ejecucion&nbsp;&nbsp;&nbsp;  
      <label for="textfield11"></label>
      <input name="textfield11"  class="texto" type="text" id="textfield11" size="30" value="<?php echo $ot_sup ?>" />  Ref. Tipo Cambio:
       <?php 
  ...
  <tr>
    ...
    <?php 
						if($imprimeotde1 != NULL)
							...
							?>
                             <tr>
             <td height="24" bgcolor="#CCCCCC"><input type="text" class="texto" id="<?php echo "tarea".$i; ?>"  name="<?php echo "tarea".$i; ?>" readonly  size="45" value="<?php echo $itemD["ot_tarea"]; ?>"></td>
    <td bgcolor="#CCCCCC"><strong>
      <input type="text" id="<?php echo "timees".$i; ?>" class="texto"  name="<?php echo "timees".$i; ?>"  size="10" value="<?php echo $itemD["ot_h1"]; ?>">
      <label for="textfield4"></label>
    </strong></td>
    <td bgcolor="#CCCCCC"><strong>
       <input type="text" id="<?php echo "timere".$i; ?>" class="texto" name="<?php echo "timere".$i; ?>"  size="10" value="<?php echo $itemD["ot_h2"]; ?>">
      <a href='#'> <img src='../images/user_logout.png' width="15" height="15"  onclick='eliminarUsuario(this)' value='Eliminar'></a></strong></td>
...
<table width="800" border="0"  id="tablaDiagnostico2">
  <tr>
    <td width="166">Material
    ...
    <td width="136"><a href="#" onclick="add2();"><img src="../images/agregar.png" width="20" height="20" border="0"  />&nbsp;</a><a href="#" onclick="eliminarDiagnosticos2();"><img align="top" src="../images/icon_delete.png" width="20" height="20" border="0" /></a>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
        ...
        <?php 
							...
							?>
                             <tr>
             <td height="24" bgcolor="#CCCCCC"><input type="text" id="<?php echo "material".$i; ?>"  name="<?php echo "material".$i; ?>" readonly  size="25" class="texto" value="<?php echo $itemD["ot_material"]; ?>"></td>
    <td bgcolor="#CCCCCC"><strong>
      <input type="text" id="<?php echo "unidad".$i; ?>"  class="texto" name="<?php echo "unidad".$i; ?>"  size="20" value="<?php echo $itemD["ot_uni"]; ?>">
      <label for="textfield4"></label>
    </strong></td>
    <td bgcolor="#CCCCCC"><strong>
       <input type="text" id="<?php echo "cant".$i; ?>" class="texto" name="<?php echo "cant".$i; ?>"  size="10" value="<?php echo $itemD["ot_cant1"]; ?>">
      </strong></td>
      
       <td bgcolor="#CCCCCC"><strong>
       <input type="text" id="<?php echo "cantutil".$i; ?>" class="texto"  name="<?php echo "cantutil".$i; ?>"  size="10" value="<?php echo $itemD["ot_cant2"]; ?>">
      </strong></td>
      
    <td bgcolor="#CCCCCC"><strong>
      <input type="text" id="<?php echo "costo".$i; ?>" class="texto" name="<?php echo "costo".$i; ?>"  size="10" value="<?php echo $itemD["ot_costo"]; ?>">
      </strong></td>
    <td bgcolor="#CCCCCC"><strong>
     <input type="text" id="<?php echo "costodol".$i; ?>" class="texto" name="<?php echo "costodol".$i; ?>"  size="10" value="<?php echo $itemD["ot_costodol"]; ?>">
    <a href='#'> <img src='../images/user_logout.png' width="15" height="15"  onclick='eliminarUsuario(this)' value='Eliminar'></a></strong></td>
            </tr>
             <?php 	
								$i++;
...
<table width="858" border="0">
  ...
  <tr>
    ...
    <input type="text" name="textfield22"  class="texto" id="textfield22" value="<?php echo $ot_personal; ?>" /></td>
    <td><label for="textfield23"></label>
    <input type="text" name="textfield23"  class="texto" id="textfield23" value="<?php echo $ot_h1; ?>" /></td>
    <td><label for="textfield24"></label>
    <input type="text" name="textfield24"  class="texto" id="textfield24" value="<?php echo $ot_h2; ?>"/></td>
    <td><label for="textfield25"></label>
    <input type="text" name="textfield25"  class="texto" id="textfield25" value="<?php echo $ot_h3; ?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>MEDIDAS DE SEGURIDA</td>
    <td colspan="4"><label for="textfield20"></label>
    <input name="textfield20" type="text"  class="texto" id="textfield20" size="60" value="<?php echo $ot_med; ?>" /></td>
  </tr>
  <tr>
    <td>OBSERVACIONES</td>
    <td colspan="4"><label for="textfield21"></label>
    <input name="textfield21" type="text"  class="texto" id="textfield21" size="60" value="<?php echo $ot_obs; ?>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<p>
  <input type="button" name="Grabar" id="Grabar" value="ACTUALIZAR ORDEN" onclick="validagraba()" />
