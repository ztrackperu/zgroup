...
<script type="text/javascript">	
$().ready(function() {
	$("#producto").autocomplete("../MVC_Controlador/cajaC.php?acc=proauto", {
		width: 260, 
		matchContains: true,
		selectFirst: false
	});	
...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=m27">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>Reporte de Contenedores</div>
      <br class="clear"/>
					<div class="content">
					  <table width="85%" border="1" align="center" cellpadding="0" cellspacing="0"  >
					    <tr>
					      <td height="21" align="right" >&nbsp;</td>
					      <td >Filtre el Producto</td>
					      <td align="center" >&nbsp;</td>
				        </tr>
					    <tr>
					      <td width="50%" height="26" align="right" ><input type="hidden" name="codigo" id="codigo" /></td>
					      <td width="25%" >
				         
				          <input name="producto" type="text" id="producto" size="60" /></td>
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
                            <thead>
                                <tr align="center">
                                  <td colspan="13"><a href="../MVC_Controlador/cajaC.php?acc=re27">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a></td>
                                </tr>
                                <tr align="center">
                                  <td width="26" bgcolor="#CCCCCC">Nro</td>
      <td width="49" bgcolor="#CCCCCC">Serie</td>
      <td width="107" bgcolor="#CCCCCC">Descripcion</td>
      <td width="77" bgcolor="#CCCCCC">Costo de Compra</td>
      <td width="82" bgcolor="#CCCCCC">Costo de Aduana</td>
      <td width="78" bgcolor="#CCCCCC">Costo Maritimo</td>
      <td width="78" bgcolor="#CCCCCC">Costo Agente</td>
      <td width="75" bgcolor="#CCCCCC">Costo Flete local</td>
      <td width="57" bgcolor="#CCCCCC">Costo Gute In</td>
      <td width="71" bgcolor="#CCCCCC">Costo de trabajo</td>
      <td width="64" bgcolor="#CCCCCC">Precio Lista</td>
      <td width="64" bgcolor="#CCCCCC">Precio Venta</td>
      <td width="70" bgcolor="#CCCCCC">Otros Datos</td>
      </tr>
                            </thead>
                            <tbody>
                                <?php 
      ...
      <td align="center"><?php echo $item["oc_serie"];?></td>
      <td align="center"><?php echo $item["oc_desc"];?></td>
      <td align="center"><?php echo $item["oc_precio"];?></td>
      <td align="center"><?php echo $item["c_costadu"];?></td>
      <td align="center"><?php echo $item["c_costmar"];?></td>
      <td align="center"><?php echo $item["c_costage"];?></td>
      <td align="center"><?php echo $item["c_costalm"];?></td>
      <td align="center"><?php echo $item["c_costgute"];?></td>
      <td align="center"><?php echo $item["c_costotr"];?></td>
      <td align="center"><?php echo $item["c_preclist"];?></td>
      <td align="center"><?php echo $item["c_precvent"];?></td>
