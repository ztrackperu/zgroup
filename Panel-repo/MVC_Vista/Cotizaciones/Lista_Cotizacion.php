...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=rep01&udni=<?php echo $_GET['udni']; ?>&mod=<?php echo $_GET['mod']; ?>">
              ...
              <table width="135%" border="1" align="center" cellpadding="0" cellspacing="0"  >
                ...
                <tr>
                  <td width="19%"  height="24" align="right" > <input name="radio2" type="radio" id="radio2" value="2" onclick="hab1();activa1()" />
                      ...
                      Filtro x  Producto &nbsp;</td>
                  <td >
                  
                  <input name="asunto" type="text" id="asunto" size="40" />
                  <input type="hidden" name="codpro" id="codpro" /></td>
                  <td >-Ejm. Contenedor Dry</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  Por Cliente&nbsp;</td>
                  <td height="24" ><input name="cli" onclick="hab3();activa1()" type="text" id="cli" size="40" /></td>
                ...
                <tr>
                  ...
                  Por numero de Cotizacion
                  </td>
                  <td height="24" >
                  <input name="cotiz" type="text" id="cotiz" size="40" /></td>
                  <td height="24" >-Ejm. 10020139878</td>
                </tr>
                
                <tr>
                  <td height="24" align="right" ><input type="radio" name="radio2" onclick="hab4();activa1()" id="radio2" value="4" />
                  Por numero de Forwarder
                  </td>
                  <td height="24" >
                  <input name="forwarder" type="text" id="forwarder" size="40" /></td>
                  <td height="24" >-Ejm. 482</td>
             </tr>
    ...
    <tr>
      <td height="113"><table width="200" border="1">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
          <thead>
            <tr align="center">
              <td colspan="13">LISTADO DE COTIZACIONES <BR /><a href="../MVC_Controlador/cajaC.php?acc=r01">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a><br />
              <strong style="color:#930">Para Vizualizar  el numero de guia remision es necesario haber remitido el nro de cotizacion al area de Almacen (se empieza a implementar desde el 17/06/15 17:07 pm</strong></td>
            </tr>
            <tr align="center">
              ...
              <td width="76" bgcolor="#CCCCCC"><strong style="color:#930">Guia Despacho</strong></td>
              <td width="76" bgcolor="#CCCCCC">Cronograma ?</td>
  ...
  <a href="../MVC_Controlador/InventarioC.php?acc=imprimeguia&guia=<?php echo $item["c_numguia"];  ?>&coti=<?php echo $item["c_numped"];?>&udni=<?php echo $_GET['udni'];?>"><?php echo $item['c_numguia']?></a>
			  ...
			  }elseif($item['c_estado']==1 || $item['c_estado']==2 && $item['n_swtapr']==1){ echo '<strong style="color:#FF0000">Facturado</strong>';} ?>
              
              </td>
              <td align="center">
                
                <?php if($item['n_swtapr']==0 && $item['c_estado']==0 && $mod=='1'){ ?>
                <a href="../MVC_Controlador/cajaC.php?acc=adiciona&cod=<?php echo $item["c_codcli"];?>&coti=<?php echo $item["c_numped"];?>&udni=<?php echo $_GET['udni'];?>"><img src="../images/Coherence.png" width="25" height="25" title="Aprobar Cotizacion" /></a>     
                <?php 			  
				  }?>
              ...
              <td align="center"><a href="../MVC_Controlador/cajaC.php?acc=vercoti2&cod=<?php echo $item["c_codcli"];?>&coti=<?php echo $item["c_numped"];?>&udni=<?php echo $_GET['udni'];?>"><img src="../images/icono-descargas.jpg" width="25" height="25" title="Generar Cotizacion" /></a></td>
          ...
          <?php /*?> <a href="../MVC_Controlador/cajaC.php?acc=rdet01&cod=<?php echo $item["c_codcli"];?>&coti=<?php echo $item["c_numped"];?>&obs=<?php echo nl2br(strip_tags(utf8_encode($item['c_obsped'])));?>&gral=<?php echo nl2br(strip_tags(utf8_encode($item['c_desgral'])))?>"><img src="../images/doc.png" width="16" height="16" title="Ver Cotizacion en Pantalla" /></a><?php ?><?php */?>&nbsp;&nbsp;
                ...
                <a href="../MVC_Controlador/cajaC.php?acc=vercoti&cod=<?php echo $item["c_codcli"];?>&coti=<?php echo $item["c_numped"];?>&udni=<?php echo $_GET['udni'];?>"><img src="../images/icon_edit.png" width="16" height="16" title="Editar Cotizacion" /></a>&nbsp;
