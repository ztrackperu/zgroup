...
//  $mail->SetFrom('no-reply@zgroup.com.pe', utf8_decode('Mensaje del Sistema'));
//se asigna un tiempo limite para envío de correo
$mail->Timeout = 30;
//se activa el soporte de HTML
$mail->isHTML(true);
...
$mail->Body ='Se ha Realizado La siguiente Reserva de Equipo'.'<br>'.'Cliente: '.$c_nomcli.'<br>'.'Descripcion: '.$descripcion.'<br>'.'Equipo: '.$equipo.'<br>'.'Tipo: '.$tipo.'<br>'.'<br>'.'Informacion enviada por:'.'<br>'.'Sistema Intranet Zgroup'.'<br>'.'<br>'.'' ; 
//se asigna el asunto del mensaje
