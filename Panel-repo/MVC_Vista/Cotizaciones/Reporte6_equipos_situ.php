...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=verrep06&udni=<?php echo $_GET['udni']; ?>&mod=<?php echo $_GET['mod']; ?>">
    ...
    ?>
        <center>
          <div class="column_left" align="center">
            <div class="header">EQUIPO X SITUACION</div>
            <span> <br class="clear"/>
            <div class="content">
              ...
              <table width="135%" border="1" align="center" cellpadding="0" cellspacing="0"  >
                ...
                <tr>
                  ...
                  BUSQUE EQUIPO                  &nbsp;</td>
                  <td height="24" ><div id="apDiv2" ><input name="cli"  type="text" id="cli" size="25" /></div></td>
                  <td height="24" >-Ejm. ZGRU458742-7</td>
                </tr>
                <tr>
    ...
    <tr>
      <td height="113"><table width="200" border="1">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
          <thead>
            <tr align="center">
              <td colspan="9">DETALLE DE EQUIPO <?php echo $_POST['cli']; ?><BR /><a href="../MVC_Controlador/cajaC.php?acc=rep06">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a></td>
            </tr>
            <tr align="center">
              ...
              <td width="134" bgcolor="#CCCCCC">Obs</td>
              <td width="134" bgcolor="#CCCCCC">Obs 2</td>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr >
              ...
              <td align="center"><?php echo substr($item["PE_FDOC"],0,10);?></td>
              <td align="center"><?php echo $item["tc_desc"];?></td>
              <td align="center"><?php echo $item["c_descr2"];?></td>
              
              <td align="center"><?php echo  vfecha(substr($itemD['c_fecini'],0,10)).' -- '.(vfecha(substr($itemD['c_fecfin'],0,10))); ?>&nbsp;</td>
