...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=mot&udni=<?php echo $_GET['udni']; ?>">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>Reporte de Ordenes Trabajo</div>
      <br class="clear"/>
					<div class="content">
					  <table width="85%" border="1" align="center" cellpadding="0" cellspacing="0"  >
					    <tr>
					      <td width="100%" colspan="3" align="center" >desde 
  ...
  <option value="PDF" id="opcion3">PDF </option>
					    ...
					    <tr>
					      <td colspan="3" ><strong>Orden Trabajo Generadas en  Almacen</strong></td>
				        </tr>
				      </table>
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
                            <thead>
                                <tr align="center">
                                  <td colspan="6"><br /><a href="../MVC_Controlador/cajaC.php?acc=re27">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a></td>
                                </tr>
                                <tr align="center">
                                  <td width="40" bgcolor="#CCCCCC">Nro</td>
      <td width="75" bgcolor="#CCCCCC">Nro Orden</td>
      <td width="165" bgcolor="#CCCCCC">Cliente</td>
      <td width="119" bgcolor="#CCCCCC">Fecha Emision</td>
      <td width="166" bgcolor="#CCCCCC">Descripcion </td>
      <td width="66" bgcolor="#CCCCCC">Administrar</td>
      </tr>
                            </thead>
                            <tbody>
                                <?php 
      ...
      <td align="center"><?php echo '0000'.$item["ot_nro"];?></td>
      <td align="center"><?php echo $item["ot_soli"];?></td>
      <td align="center"><?php echo vfecha(substr($item["ot_fecreg"],0,10));?></td>
      <td align="center"><?php echo $item["ot_descr"];?></td>
      <td align="center"><a href="../MVC_Controlador/cajaC.php?acc=verot&nro=<?php echo $item["ot_nro"];?>"><img src="../images/search.png" width="16" height="16" /></a>&nbsp;<a href="../MVC_Controlador/cajaC.php?acc=verotupdateot&nro=<?php echo $item["ot_nro"];?>&udni=<?php echo $_GET['udni'] ?>"><img src="../images/icon_edit.png" width="16" height="16" /></a></td>
      </tr>
