...
<script language="javascript">
 function linki(){
	 	codigo=document.getElementById("variodescrip").options[document.getElementById("variodescrip").selectedIndex].value;
	 	location.href="../MVC_Controlador/cajaC.php?acc=glosa1"+"&cod="+codigo;
	}
</script>
 ...
 <tr>
    ...
    <tr>
      <td height="26" colspan="3" bgcolor="#FFFFFF">
        ...
        <textarea name="area2" id="area2" cols="70" rows="15"><?php echo $des ?></textarea></td>
