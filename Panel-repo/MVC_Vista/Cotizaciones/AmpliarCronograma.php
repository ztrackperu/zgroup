...
if(document.getElementById('clase'+y).value=='017' && document.getElementById('codcont'+y).value=='' ){
		...
		}else if(document.getElementById('clase'+y).value=='017' &&  document.getElementById('ffin'+y).value=='' ){
			document.getElementById('valdata').value='1';
				alert('Falta Fechas Alquiler')
		//document.getElementById('codcont'+y).focus();
		document.getElementById('valdata').value='0';
...
<body onload="cerrar();">
<strong align="center">REGISTRAR AMPLIACION CRONOGRAMA <?php echo $_GET['fi'].' AL '.$_GET['ff']; ?></strong>
<form id="formElem" name="formElem"  method="post" action="../MVC_Controlador/cajaC.php?acc=ampliarcoti&gral=<?php echo ($_GET['gral'])?>&obs=<?php echo ($_GET['obs']);?>&udni=<?php echo $_GET['udni']; ?>">
  ...
  <fieldset class="fieldset legend">
    ...
    <tr>
      ...
      <td width="194" bgcolor="#CCCCCC"><label for="doc"></label>
        <input name="doc"  type="text" class="texto" id="doc" value="<?php echo $coti; ?>"readonly="readonly" />
...
<option value="0">No Aprobado</option>
    ...
    <tr>
      ...
      <td colspan="5" bgcolor="#999966"><label for="ruc">
        ...
        <label for="n_cuota"></label>
        <input name="n_cuota" type="text" id="n_cuota" value="<?php echo number_format($cuo,0); ?>" size="5" readonly="readonly" /></td>
    </tr>
    <tr>
...
<label for="checkbox"></label>
      ...
      <tr>
        ...
        <table width="1462" border="0" id="tablaDiagnostico">
          <tr>
            ...
            <th width="210" bgcolor="#66CCCC"><strong>Ultimo Periodo Cobrado</strong></th>
            <th width="121" bgcolor="#66CCCC"><strong>Equipo</strong></th>
            <th width="282" bgcolor="#66CCCC"><strong>Inicio del Nuevo Periodo</strong></th>
 ...
 <input type="hidden" id="<?php echo "codigo".$i; ?>"  name="<?php echo "codigo".$i; ?>" readonly  size="5" value="<?php echo $itemD["c_codprd"]; ?>" class="texto" /></td>
            <td bgcolor="#CCCCCC"><strong>
             ...
             <td bgcolor="#CCCCCC"><input  name="<?php echo "codcont".$i; ?>" type="text" class="texto" id="<?php echo "codcont".$i; ?>" value="<?php echo $itemD["c_codequipo"]; ?>"  size="15" readonly="readonly"  /> <input type="hidden" id="<?php echo "codequipo".$i; ?>"  name="<?php echo "codequipo".$i; ?>" value="<?php echo $itemD["c_codequipo"]; ?>" />&nbsp;</td>
             <td bgcolor="#CCCCCC">
             
      del
       <input name="<?php echo "fini".$i; ?>" type="text" id="<?php echo "fini".$i; ?>" onclick="abreVentanaF(this.name)" value="<?php echo $fi=dameFecha($itemD['d_ffin'],1) ?>" size="10" readonly="readonly" />
      ...
      al
     <input name="<?php echo "ffin".$i; ?>" type="text" id="<?php echo "ffin".$i; ?>"  value="<?php echo $ff=dameFecha($fi,29); ?>" size="10" readonly="readonly" />
...
?>
    ...
    <td bgcolor="#CCCCCC"><strong>
       <input  name="<?php echo "precio".$i; ?>" type="text" class="texto" id="<?php echo "precio".$i; ?>" value="<?php echo $itemD["n_importe"]; ?>"  size="5" readonly="readonly">
      </strong></td>
      
       <td bgcolor="#CCCCCC"><strong>
       <input  name="<?php echo "dscto".$i; ?>" type="text" class="texto" id="<?php echo "dscto".$i; ?>" value="<?php echo $itemD["n_dscto"]; ?>"  size="5" readonly="readonly">
      </strong></td>
      
    <td bgcolor="#CCCCCC"><strong>
      <input  name="<?php echo "cantidad".$i; ?>" type="text" class="texto" id="<?php echo "cantidad".$i; ?>" onkeyup="actualizar_importe(this.name);" value="<?php echo $itemD["n_cant"]; ?>"  size="5" readonly="readonly">
      </strong></td>
    <td bgcolor="#CCCCCC"><strong>
      <input  name="<?php echo "imp".$i; ?>" type="text" class="texto" id="<?php echo "imp".$i; ?>" value="<?php echo $itemD["n_importe"]; ?>"  size="5" readonly="readonly" />
    </strong></td>
  ...
  <tr>
    <td colspan="2" bgcolor="#CCCCCC">Fecha
      ...
      <input name="lugar" type="text" id="lugar" size="35" class="texto"value="" />
       Tiempo de entrega      
      <input name="tiempo" type="text" id="tiempo" size="35" class="texto" value="<?php echo $tiempoentrega; ?>"/>
      
      <input name="cronograma" type="checkbox"  id="cronograma" onclick="" value="1" checked="checked" />
        Meses 
...
<fieldset class="fieldset legend">
  ...
  <tr>
    <td align="center" bgcolor="#CCCCCC" style="color:#930">
    
    <input name="validadata" type="button" id="validadata" onclick="recorretext();" value="Validar Datos" />
       
          <input name="valdata" type="text" id="valdata" value="0" size="5" readonly="readonly" />
  ...
  <tr>
    <td align="center" bgcolor="#CCCCCC" style="color:#930"><span class="buttons">
      <input type="button" name="button" class="boton" id="button" value="REGISTRAR" onclick="validar()" />
