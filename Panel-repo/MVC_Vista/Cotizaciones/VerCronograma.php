...
if(osb==''){
	...
	var mensaje='Seguro de Cerrar Cronograma Nro: '+nro;
	if(confirm(mensaje)){
...
<body>
   ...
   <div class="column_left" align="center">
            <div class="header"> <span><strong>CRONOGRAMA DE PAGO</strong></span></div>

<table width="982" border="0" class="data">
  <tr>
    <th width="214" align="right">Nro de Cotizacion Principal:</th>
  ...
  <tr>
    <th align="right">Observacion de Cierre:</th>
    <td>
      <input type="text" name="c_obs" id="c_obs" class="texto" size="70"/></td>
  </tr>
  </table>
<table width="964" border="1" cellpadding="1" cellspacing="1" class="data">
  <tr>
  <td align="right"><table width="1191" border="1" cellpadding="1" cellspacing="1" class="data">
    <tr>
      ...
      <th width="95" align="center" bgcolor="#CCCCCC">Obs</th>
      ...
      <th width="53" align="center" bgcolor="#CCCCCC">Estado Cuota</th>
      <th width="191" align="center" bgcolor="#CCCCCC"><strong>Acción</strong></th>
    </tr>
    <?php 
    $i = 1;
	$cont=0;
	...
	if($item["c_nrofac"]=="" && $item["estacuo"]=="0"){
		$cont+= 1;
	}
...
<input name="<?php echo'sel'.$i?>" type="checkbox" id="<?php echo'sel'.$i?>" value="<?php echo $item['n_idreg']; //$factu!=$fp ||  ?>"
 <?php if($item['c_nrofac']!=NULL ||$item['c_nroped']!=NULL ){?>   disabled="disabled"  onclick="javascript: return false;"  <?php } ?>>
      </label>       
       </td>
      ...
      <td><?php  if($item['estcuota']=='0'){
		  echo 'Activo';
	  }else{ echo 'Anulado';} ?>&nbsp;</td>
      <td><?php 
...
<table width="868" border="0">
  ...
  <tr>
    <td align="center"><input type="submit" name="button2" id="button2" value="Renovar Cronograma" onclick="" /></td>
    <td align="center"><input type="button" name="button3" id="button3" value="Ampliar Cronograma" onclick="ampliacion();" /></td>
    <td align="center"><input type="button" name="Anular Cuota" id="Anular Cuota" value="Anular Cuota" /></td>
    <td align="center"><input type="button" name="button" id="button" value="Cerrar Cronograma" onclick="cerrar()"/></td>
    <td align="center"><input type="button" name="button4" id="button4" onclick="window.print();" value="Imprimir Cronograma" /></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td align="center">&nbsp;</td>
