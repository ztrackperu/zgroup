...
//PROVEEDOR
if($resulv3!=NULL){
	foreach($resulv3 as $item2){
		$proveedor=$item2['PR_RAZO'];
	}	
}
  ?>
...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=actudatainveq&udni=<?php echo $_GET['udni'] ?>">
  <div id="TabbedPanels1" class="TabbedPanels">
    <ul class="TabbedPanelsTabGroup">
      ...
      <li class="TabbedPanelsTab" tabindex="0">Datos Nacionalizacio</li>
...
<?php */?>
              ...
              <?php } ?>
              &nbsp;</td>
            <td colspan="2"><input type="hidden" name="udni" id="udni" value="<?php echo $_GET['udni'] ?>" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php $ven = TamanoCarretaM();?>
              <select name="c_tamCarreta" id="c_tamCarreta" class="combo texto">
                <option value="0">.::SELECCIONE::.</option>
                <?php foreach($ven as $item){?>
                 <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_numitm"]==$c_tamCarreta){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
                <?php }	?>
              </select>
              &nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><?php $ven = EjesCarretaM();?>
              <select name="c_nroejes" id="c_nroejes" class="combo texto">
                <?php foreach($ven as $item){?>
              <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_numitm"]==$c_nroejes){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
                <?php }	?>
              </select>
              &nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td>Serie VIN</td>
            <td colspan="2"><input type="text" name="c_control" id="c_control"  class="texto" value="<?php echo $c_vin ?>" />
              <label for="a"></label>
            <input type="text" name="a" id="a" class="texto"/></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>Modelo</td>
            <td><input type="text" name="c_codmod" id="c_codmod" required="required" class="texto" value="<?php echo $c_cmodel ?>"/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>Procedencia</td>
            <td>
              <input type="text" name="c_procedencia" id="c_procedencia" class="texto" value="<?php echo $c_procedencia ?>">
