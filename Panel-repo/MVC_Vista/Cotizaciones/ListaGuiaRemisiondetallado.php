...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=verrepguia02">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>Reporte de Guias Remision Detallado</div>
      <br class="clear"/>
					<div class="content">
...
echo $dt_laSemanaPasada;*/?>"/><img src="../images/calendario.jpg" name="Image" id="Image" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'">
      <script type="text/javascript">
					Calendar.setup(
					  {
      ...
      <script type="text/javascript">
					...
					button     : "Image2"
					    ...
					    <tr>
				          ...
				          <label for="sw2">Todas las guia de todos los clientes</label></td>
				        </tr>
					    <tr>
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:10px">
                            <thead>
                                <tr align="center">
                                  <td colspan="10"><?php echo 'Reporte DETALLADO del '.$_POST['textfield'].' al '.$_POST['textfield2']; ?><br />
      ...
      <td width="125" bgcolor="#CCCCCC">Descripcion</td>
      <td width="125" bgcolor="#CCCCCC">Equipo</td>
      <td width="125" bgcolor="#CCCCCC">Glosa</td>
      <td width="125" bgcolor="#CCCCCC">Fecha Guia</td>
      <td width="92" bgcolor="#CCCCCC">Obs</td>
      <td width="92" bgcolor="#CCCCCC">Estado equipo</td>
      ...
      <td align="center"><?php echo  $item["c_obsprd"];?>&nbsp;</td>
