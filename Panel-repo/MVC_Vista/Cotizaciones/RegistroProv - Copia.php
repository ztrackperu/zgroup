...
<form id="formElem" name="formElem" method="post" action="../MVC_Controlador/cajaC.php?acc=valrucprov">
  <table width="773" border="0" align="left">
    <tr>
      <td width="124" colspan="2"><a href="../MVC_Controlador/cajaC.php?acc=verprov">RETORNAR</a></td>
    </tr>
    <tr>
...
<table width="773" border="0" align="left">
    ...
    <tr>
      ...
      <input name="textfield5" type="text" id="textfield5" size="70" value="<?php echo  trim($Direcciondomicilia); ?>" /></td>
    </tr>
    <tr>
