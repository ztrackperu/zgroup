...
tr.innerHTML += "<td bgcolor='#CCCCCC'><input name='" + precio + "' type='text'  id='" + precio + "' size='10' /></td>";

tr.innerHTML += "<td bgcolor='#CCCCCC'><input name='" + dscto + "' type='text'  id='" + dscto + "' size='10' onkeyup='actualizar_importe()' /> </td>";

tr.innerHTML += "<td bgcolor='#CCCCCC'><input name='" + cantidad + "' type='text' id='" + cantidad + "' size='10' onkeyup='actualizar_importe();'/> </td>";
...
function agregarUsuario(){
	...
	nuevaFila = document.getElementById("tablaDiagnostico").insertRow(-1);
		...
		nuevaCelda.innerHTML="<td bgcolor='#CCCCCC'><input name='glosa"+posicionCampo+"' type='text'  id='glosa"+posicionCampo+"'  size='40'  class='texto'/>";
			...
			nuevaCelda=nuevaFila.insertCell(-1);
		nuevaCelda.innerHTML="<td bgcolor='#CCCCCC'><input name='c_codcont"+posicionCampo+"' type='text'  id='c_codcont"+posicionCampo+"'  size='40'  class='texto'/>";
...
function escribirDiagnostico(posicionCampo)
{
	calcularimporte();
			...
			glosa.value = document.formElem.glosa.value;
				...
				c_codcont = document.getElementById("c_codcont" + posicionCampo);
			c_codcont.value = document.formElem.c_codcont.value;
...
<body onload="cerrar();">
<strong align="center">GENERACION ATRAVES DE OTRA COTIZACIONES</strong>
<form id="formElem" name="formElem"  method="post" action="../MVC_Controlador/cajaC.php?acc=guardacotigenerada&gral=<?php echo ($_GET['gral'])?>&obs=<?php echo ($_GET['obs']);?>">
  <label></label>
  <fieldset class="fieldset legend">
    ...
    <tr>
      ...
      <td width="194" bgcolor="#CCCCCC"><label for="doc"></label>
        <input name="doc"  type="text" class="texto" id="doc" value="xxxxxxxx" readonly="readonly" />
...
<option value="0">No Aprobado</option>
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC"><input name="igv" type="text" disabled="disabled" id="igv" value="0.18" size="5" maxlength="5" readonly="readonly" />
        ...
        <input name="c_cotipadre" type="text"  id="c_cotipadre" value="<?php echo $cotizacion ?>" readonly="readonly"/></td>
      </tr>
    <tr>
      ...
      <td colspan="5" bgcolor="#CCCCCC"><!--<button type="button" class="positive" name="save5" onclick="linki2()"> Consultar</button>-->
        <a href="#"> 
        <input name="razon" type="text" id="razon"  size="35"  class="texto" value="" />
        ...
        <input name="hc" type="text" id="hc" size="15" class="texto" value=""/>
        Direccion
        <input name="direc" type="text" id="direc" size="35" class="texto"value="" /></td>
      </tr>
    <tr>
      ...
      <td colspan="5" bgcolor="#999966"><label for="ruc">
        ...
        Contacto
          <input name="contacto" type="text" class="texto" id="contacto" size="15" value="" />
        Correo
        <input name="correo" type="text" class="texto" id="correo" size="15" value=""/>
        Telefono
        <input name="telefono" type="text" class="texto" id="telefono" size="8" value="" />
        Nextel
        <input name="nextel" type="text" class="texto" id="nextel" size="9" value="" />
        </label></td>
    </tr>
    <tr>
...
<table width="1050" bgcolor="#CCCCCC">
    <tr>
      <td width="374" height="26" bgcolor="#CCCCCC" style="color:#F00">Descripcion General Nota: Si desea cambiar glosa active el check y copie el contenido caso contrario desactivar el check</td>
      <td width="664" height="26" bgcolor="#FFFFFF"><select    name="variodescrip" id="variodescrip" onchange="llenardescrip()" class="Combos texto">
        ...
        Cambiar Glosa<input type="text" name="codtitulo" id="codtitulo" size="5" />
        <label for="checkbox2"></label></td>
      </tr>
    <tr>
      <td height="26" colspan="2" valign="top" bgcolor="#FFFFFF"><textarea name="area2" id="area2" cols="120" rows="15">
      <?php
  ...
  //echo  $cadenasalida=eregi_replace ($patron,$sustituto,utf8_encode($glosa));
  
   echo strip_tags(utf8_encode($glosa))
	  
	  ?>
      <?php //echo  (strip_tags(utf8_encode($glosa))) ?>
       </textarea>
    ...
    <table id="tablaDiagnosticox" width="1051" border="0">
      <tr>
        <td width="1361" height="31" colspan="6" bgcolor="#CCCCCC"><table width="1045" border="0">
          ...
          <input type="text" name="clase" id="clase" size="3" /></td>
              <td><?php /*?><?php $ruta = RutasListaC();?><select name="rutas" id="rutas" onchange="llenarcombo();" class="Combos texto">
               <option value="0">.::SELECCIONE::.</option>
            ...
            <?php }	?>
              ...
              <input type="hidden" name="zzglosa" id="zzglosa" />Cotizacion Con Cronograma de Pago
		 <input type="checkbox" name="gencrono" id="gencrono" onclick="prodform()" /></td>
...
<label for="checkbox"></label>
     ...
     <a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" border="0" /></a><a href="#" onclick="eliminarDiagnosticos();"><!--<img align="top" src="../images/errorr.png" width="16" height="16" border="0" />--></a></td>
      ...
      <tr>
        <td colspan="6" >
        <table width="1408" border="0" id="tablaDiagnostico">
          <tr>
            <td width="45" bgcolor="#66CCCC"><strong>Codigo</strong></td>
            <td width="241" bgcolor="#66CCCC"><strong>Descripcion</strong></td>
            <td width="241" bgcolor="#66CCCC"><strong>Glosa</strong></td>
            <td width="50" bgcolor="#66CCCC"><strong>Codigo Equipo</strong></td>
            <td width="50" bgcolor="#66CCCC"><strong>clase</strong></td>
            <td width="79"bgcolor="#66CCCC"><strong>Precio</strong></td>
            <td width="71"bgcolor="#66CCCC"><strong>Dscto</strong></td>
            <td width="80"bgcolor="#66CCCC"><strong>Cantidad</strong></td>
            <td width="92"bgcolor="#66CCCC"><strong>Importe</strong></td>
            <td width="417"bgcolor="#66CCCC">Delete</td>
            </tr>
            <?php 
							if($Obtenercotizaciones != NULL)
							{		
							...
							?>
          <tr>
            <td bgcolor="#CCCCCC"><input type="text" id="<?php echo "codigo".$i; ?>"  name="<?php echo "codigo".$i; ?>" readonly  size="5" value="<?php echo $itemD["c_codprd"]; ?>" class="texto" /></td>
            <td bgcolor="#CCCCCC"><strong>
              <input type="text" id="<?php echo "descripcion".$i; ?>"  name="<?php echo "descripcion".$i; ?>"  size="40" value="<?php echo $itemD["c_desprd"]; ?>" class="texto" />
            </strong></td>
             ...
             <td bgcolor="#CCCCCC">
              <input name="<?php echo "codcont".$i; ?>" type="text" id="<?php echo "codcont".$i; ?> "  readonly="readonly" <?php /*?>onclick="abreVentana(this.name,'<?php echo $itemD["c_codprd"]; ?>','<?php echo $itemD["clase"]; ?>')"<?php */?> />
              
              <input type="hidden" name="<?php echo "codequipo".$i; ?>" id="<?php echo "codequipo".$i; ?>"  size="5"  /> 
              </td>
    <td bgcolor="#CCCCCC"><strong>
      <label for="textfield4"></label>
      <!--<input name="glosa1" type="text" id="glosa1" size="30" />--><input type="text" id="<?php echo "clase".$i; ?>"  name="<?php echo "clase".$i; ?>"  size="5" value="<?php echo $itemD["clase"]; ?>" class="texto">
    </strong></td>
    <td bgcolor="#CCCCCC"><strong>
    ...
    <tr>
      <td height="26" colspan="4" valign="top" bgcolor="#FFFFFF">
		...
		//echo str_replace("<br />","\n",utf8_encode($obs));
			  $patron = "(<br />)+";//Patrón de búsqueda, que mediante expresión regular busca varios saltos seguidos
    $sustituto = "\n";//sustituye por un solo salto
 // echo  $cadenasalida=eregi_replace ($patron,$sustituto,utf8_encode($obs));
...
<fieldset class="fieldset legend">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#CCCCCC"><strong>Igv</strong><input name="im" class="texto" type="text" id="im" value="0" size="10" readonly="readonly" />
...
<fieldset class="fieldset legend">
  ...
  <tr>
    <td align="center" bgcolor="#CCCCCC" style="color:#930"><input name="chkhijo" type="checkbox" id="chkhijo" value="1" />
      <label for="checkbox3">Guardar Como Cotizacion (hijo)</label></td>
  </tr>
  <tr>
    <td align="center" bgcolor="#CCCCCC" style="color:#930"><span class="buttons">
      <input type="button" name="button" class="boton" id="button" value="GUARDAR" onclick="grabaform()" />
