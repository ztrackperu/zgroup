...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=repcotiaprobada&udni=<?php echo $_GET['udni']; ?>">
    ...
    ?>
        <center>
          <div class="column_left" align="center">
            <div class="header"> <span>COTIZACIONES APROBADAS</span></div>
            <span> <br class="clear"/>
            <div class="content">
    ...
    <tr>
      <td height="113"><table width="200" border="1">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
          <thead>
            <tr align="center">
              <td colspan="7"><a href="../MVC_Controlador/cajaC.php?acc=r01">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a></td>
            </tr>
            <tr align="center">
              <td width="34" bgcolor="#CCCCCC">Nro</td>
              <td width="90" bgcolor="#CCCCCC">Nro Cotizacion</td>
              <td width="116" bgcolor="#CCCCCC">Cliente</td>
              <td width="124" bgcolor="#CCCCCC">Descripcion</td>
              <td width="110" bgcolor="#CCCCCC">Contacto</td>
              <td width="64" bgcolor="#CCCCCC">Fecha</td>
              <td width="228" align="left" bgcolor="#CCCCCC">Ver Cotizacion</td>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr >
              ...
              <td align="left"><a href="../MVC_Controlador/cajaC.php?acc=rdet01&cod=<?php echo $item["c_codcli"];?>&coti=<?php echo $item["c_numped"];?>&obs=<?php echo nl2br(strip_tags(utf8_encode($item['c_obsped'])));?>&gral=<?php echo nl2br(strip_tags(utf8_encode($item['c_desgral'])))?>"><img src="../images/search.png" width="16" height="16" title="Ver Cotizacion en Pantalla" /></a>&nbsp;&nbsp;
                <!-- fin vizualizar cotizacion -->
               <?php /*?> <!-- aqui editar cotizacion -->
                <a href="../MVC_Controlador/cajaC.php?acc=vercoti&cod=<?php echo $item["c_codcli"];?>&coti=<?php echo $item["c_numped"];?>&obs=<?php echo ((utf8_encode($item['c_obsped'])));?>&gral=<?php echo ((utf8_encode($item['c_desgral']))) ?>&udni=<?php echo $_GET['udni'];?>"><img src="../images/icon_edit.png" width="16" height="16" title="Editar Cotizacion" /></a>&nbsp;
