...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/cajaC.php?acc=2m27">
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
                            <thead>
                                <tr align="center">
                                  <td colspan="7">
                                  Leyenda Estado:I=Sin Inspeccion(Valor por Default),K(Pto Ok),V(Vendido),A(Alquiler)<br /><a href="../MVC_Controlador/cajaC.php?acc=2m27">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a></td>
                                </tr>
                                <tr align="center">
                                  <td width="26" bgcolor="#CCCCCC">Nro</td>
      <td width="49" bgcolor="#CCCCCC">Serie</td>
      <td width="107" bgcolor="#CCCCCC">Descripcion</td>
      <td width="70" bgcolor="#CCCCCC">Categoria</td>
      <td width="70" bgcolor="#CCCCCC">Precio</td>
      <td width="70" bgcolor="#CCCCCC">Año</td>
      <td width="70" bgcolor="#CCCCCC">CONDICION</td>
      </tr>
                            </thead>
                            <tbody>
                                <?php 
      ...
      <td align="center"><?php echo $item["c_codcat"];?></td>
      <td align="center"><?php echo $item["c_precvent"];?></td>
      <td align="center"><?php echo $item["c_anno"];?></td>
      <td align="center"><?php echo $item["c_codest"];?></td>
      </tr>
