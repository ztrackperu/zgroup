...
<body>
<form action="../MVC_Controlador/cajaC.php?acc=gvarios" method="post"  name="form1">
  <table width="704" border="1" cellpadding="1" cellspacing="1" bordercolor="#3D4670">
    ...
    <tr>
      <td>Titulo</td>
      <td>
      <input name="titulo" type="text" id="titulo" size="90"></td>
    </tr>
    <tr>
      <td>Descripcion</td>
      <td><label for="textarea"></label>
      <!--<textarea name="descripcion" id="descipcion" cols="120" rows="10"></textarea>--><div id="info">Maximo 100 caracteres</div>
<textarea id="descripcion" name="descripcion"  rows="10" cols="120"></textarea>
</td>
    </tr>
    <tr>
      <td>Estado</td>
...
<table width="704" border="1" bordercolor="#3D4670">
  ...
  <tr>
    ...
    <td align="center">
<a href="../MVC_Controlador/cajaC.php?acc=avarios&cod=<?php echo $item["id"]?>">
<img src="../images/icon_edit.png" width="16" height="16" border="0" />
</a>
<a href="#">
<img src="../images/icon_delete.png" width="16" height="16" border="0" />
</a></td>
</tr>
<?php
}
