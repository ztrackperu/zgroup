...
<body>
<form id="formElem" name="formElem" method="post" action="GeneraLetra.php">
  <div class="column_left">
    <div class="header"><strong>Imprimir Letra </strong></div>
  <table width="527" border="1" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="3" align="center" valign="middle">&nbsp;</td>
      </tr>
    <tr>
      <td width="182" align="right" valign="middle">Nro de Letra</td>
      <td width="6" align="center" valign="middle">:</td>
      <td width="320" valign="middle">
        <input name="serie" type="text"  class="texto" id="serie"  size="10" maxlength="7" readonly="readonly"  value="<?php echo $c_numlet ?>"/></td>
    </tr>
    <tr>
      <td colspan="3" align="left" valign="middle">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="3" align="left" valign="middle"><strong style="color:#03F">Usuario :</strong>
       
        <input type="text" name="udni" id="udni" class="texto" value="<?php echo $udnix ?>"/></td>
    </tr>
    <tr>
      <td colspan="3" align="center" valign="middle">&nbsp;</td>
    </tr>
    <tr>
      ...
      <input type="submit" name="button" id="button" value="Generar" onclick="graba();" /></td>
    </tr>
    <tr>
      <td colspan="3" align="center" valign="middle">&nbsp;</td>
    </tr>
