...
function graba(){
	...
	jConfirm("¿Seguro de Liberar Letra?", "Mensaje Confirmacion", function(r) {
			if(r) {
...
<body >
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ContabilidadC.php?acc=liberalet&udni=<?php echo $_GET['udni']; ?>&mod=<?php echo $_GET['mod']; ?>">

<fieldset class="fieldset legend">
  <legend style="color:#03C"><strong>Liberacion  Letra Clientes</strong></legend>
...
<input name="c_nume" type="hidden"  class="texto" id="c_nume"  value="<?php echo $c_numeO ?>"/> 
    ...
    <tr>
      <td ><strong style="color:#03F">Usuario Libera</strong>
</td>
      <td >:</td>
      <td colspan="5" >
<input name="c_operapr" type="text"  class="texto" id="c_operapr" value="<?php echo $udnix ?>" readonly="readonly" />&nbsp;</td>
  ...
  <p><input type="button" name="button" id="button" value="Liberar" onclick="graba()"/>
