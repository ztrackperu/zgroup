...
if(confirm(mensaje)){
location.href="../MVC_Controlador/ContabilidadC.php?acc=eliminarlet&os="+nro+"&udni="+dni;
 }else{
 return false;
 } 
}
...
<div class="onecolumn">
                    ...
                    <div class="content">
                        <table class="data" width="894" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                  <th colspan="7" style="width:5%">CLIENTE
                                    <input name="des" type="text" id="des" size="40" />
                                  <input type="submit" name="button" id="button" value="FILTRAR" />
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="../images/icon_edit.png" alt="editar" width="18" height="18" class="help" title="Editar" />Editar&nbsp;<img src="../images/impresora.png" alt="1" width="19" height="19" title="Ver Orden" />Imprime&nbsp; <img src="../images/icon_delete.png" alt="2" width="18" height="18" title="Eliminar" />Elimina&nbsp; <img src="../images/Coherence.png" alt="3" width="22" height="22" title="Aprobar" />Aprueba <img src="../images/iconos/doc.png" alt="5" width="20" height="20" />Libera</th>
                                </tr>
                                <tr>
                                    <th width="8%"  >Nro Letra</th>
                                    <th width="32%" >Cliente</th>
                                    <th width="11%" >Fecha Dcto</th>
                                  <th width="15%" >Nro Contrato</th>
										...
										if($listalet!=NULL)
{
            ...
            ?>
                                <tr>
                                  ...
                                  <td bgcolor="#E5E5E5"><?php echo utf8_decode($item["c_nomcli"]);?> </td>
                                  <td bgcolor="#FFFFCC"><?php echo vfecha(substr($item["d_fecemi"],0,10));  ?>&nbsp;</td>
                                    
                                    
                                  <td bgcolor="#FFFFCC"><?php echo $item["c_numcont"];?></td>
 ...
 <a href="../MVC_Controlador/ContabilidadC.php?acc=updateletra&amp;ot=<?php echo $item["c_nume"];?>&amp;udni=<?php echo $_GET['udni'];?>"> <img src="../images/icon_edit.png" alt="editar" width="18" height="18" class="help" title="Editar" /></a>


 &nbsp;<a href="../MVC_Vista/contabilidad/print/GeneraLetra.php?ot=<?php echo $item["c_nume"]; ?>"><img src="../images/impresora.png" width="18" height="18" title="Imprimir Orden" /></a>&nbsp;
 
 <a href="#" onclick="eliminaros('<?php echo $item["c_numlet"];?>','<?php echo $_GET['udni'];?>')"><img src="../images/icon_delete.png" width="18" height="18" title="Eliminar" /></a>&nbsp;
 <?php }else{?>
 
 &nbsp;<a href="../MVC_Controlador/PDF.php?acc=verordentrabajo&ot=<?php echo $item["c_numlet"]; ?>"><img src="../images/search.png" width="19" height="19" title="Imprimir Orden" /></a>&nbsp;
