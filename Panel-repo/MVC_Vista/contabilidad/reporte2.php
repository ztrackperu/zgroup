...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ContabilidadC.php?acc=ver2">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> Emision Comprobantes</div>
      <br class="clear"/>
					<div class="content">
					  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0"  >
					    <tr>
					      <td align="right" valign="top" >Año
					        <label for="select"></label></td>
					      <td width="50%" align="left" ><select name="select" id="select">
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
                            <thead>
                                ...
                                <tr align="center">
                                  <td width="47" bgcolor="#CCCCCC">Nro</td>
      <td width="114" bgcolor="#CCCCCC">Documento</td>
      <td width="398" bgcolor="#CCCCCC">Razon Social</td>
      <td width="108" bgcolor="#CCCCCC">Ruc</td>
      <td width="116" bgcolor="#CCCCCC">Fecha Dcto</td>
      <td width="99" bgcolor="#CCCCCC">Importe </td>
      </tr>
                            </thead>
                            <tbody>
                                <?php 
      ...
      <td align="center"><?php echo $item["c_dcto"];?></td>
      <td align="center"><?php $nom=utf8_encode($item["c_razon"]); 
	 echo strtr(strtoupper($nom),"àèìòùáéíóúçñäëïöü?","ÀÈÌÒÙÁÉÍÓÚÇÑÄËÏÖÜÑ");
	  
	  ?>&nbsp;</td>
      <td align="center"><?php echo $item["c_ruc"];?></td>
      <td align="center"><?php echo vfecha(substr($item["c_fecdoc"],0,10));?></td>
      <td align="center"><?php echo number_format($item["c_importe"],2);?></td>
      </tr>
