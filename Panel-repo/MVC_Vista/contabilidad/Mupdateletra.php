...
onkeyup = "compUsuario(event)" value="<?php echo $c_nume ?>" readonly="readonly"/>       </td>
    ...
    <tr>
      ...
      <td >:</td>
      <td ><input name="monto" type="text" id="monto" size="10" class="texto"  value="<?php echo $n_implet ?>"/></td>
      <td >&nbsp;</td>
      <td >&nbsp;</td>
      <td width="146" >&nbsp;</td>
      <td width="271" >&nbsp;</td>
    ...
    <tr>
      ...
      <td >:</td>
      <td ><input name="fvcto" type="text" class="texto" id="fvcto" size="12" readonly="readonly" value="<?php echo vfecha(substr($d_fecven,0,10)) ?>"  /><img src="../images/calendario.jpg" name="Image2" id="Image2" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fvcto",
    ...
    <tr>
      ...
      <td >:</td>
      <td >
        <input type="text" name="cliente" id="cliente"  class="texto" value="<?php echo $c_nomcli ?>" />
    ...
    <tr>
      ...
      <td >:</td>
      <td colspan="5" >
        <input name="dire" type="text" id="dire" size="62" class="texto" value="<?php echo $c_dircli ?>"  /></td>
    </tr>
    <tr>
