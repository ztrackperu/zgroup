...
function graba(){
	...
	jConfirm("¿Seguro de Actualizar Letra?", "Mensaje Confirmacion", function(r) {
			if(r) {
...
<body >
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ContabilidadC.php?acc=guardarupdlet&udni=<?php echo $_GET['udni']; ?>&mod=<?php echo $_GET['mod']; ?>">

<fieldset class="fieldset legend">
  <legend style="color:#03C"><strong>Update  Letra Clientes</strong></legend>
...
onkeyup = "compUsuario(event)" value="<?php echo $c_numeO ?>" readonly="readonly"/>     
      <input name="c_nume" type="hidden" value="<?php echo $c_nume ?>" />
    ...
    <tr>
      ...
      <?php 
		if($d_fecemi!=""){
			$d_fecemi=vfecha(substr($d_fecemi,0,10));
		}else{
			$d_fecemi="";
		}	  
	  ?>      
      <input name="fgiro" type="text" class="texto" id="fgiro" size="12" readonly="readonly" value="<?php echo $d_fecemi ?>"  /><img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fgiro",
      ...
      <td >:</td>
      <td ><input name="fvcto" type="text" class="texto" id="fvcto" size="12" readonly="readonly" value="<?php if($d_fecven==""){$fecha="";}else{ $fecha=vfecha(substr($d_fecven,0,10));} echo $fecha; ?>"  /><img src="../images/calendario.jpg" name="Image2" id="Image2" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fvcto",
    ...
    <tr>
      ...
      <td >:</td>
      <td colspan="5" >
<input name="c_opermod" type="text"  class="texto" id="c_opermod" value="<?php echo $udnix ?>" readonly="readonly"/>&nbsp;</td>
    </tr>
    <tr>
      <td >&nbsp;</td>
      <td >&nbsp;</td>
  ...
  <p><input type="button" name="button" id="button" value="Actualizar" onclick="graba()"/>
