...
function graba(){
	...
	jConfirm("¿Seguro de Grabar Letra?", "Mensaje Confirmacion", function(r) {
			if(r) {
...
<body>
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ContabilidadC.php?acc=reglet&udni=<?php echo $_GET['udni']; ?>">

<fieldset class="fieldset legend">
  <legend style="color:#03C"><strong>Registro  Letra Clientes</strong></legend>
  ...
  <table width="838" border="0" widtd="908">
    ...
    <tr>
      <td width="94" widtd="83" ><strong>Nro Letra</strong></td>
...
onkeyup = "compUsuario(event)" onkeypress="return isNumberKey(event)"   />
    ...
    <tr>
     ...
     <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_numitm"]==$moneda){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
      ...
      <td width="6" >:</td>
      <td width="418" >
        <input name="monto" type="text" id="monto" size="12" class="texto" onkeypress="return ValidarMonto(event)" onclick="return ValidarMonto(event)"  /></td>
      <td width="10" >&nbsp;</td>
    ...
    <tr>
      ...
      <td >:</td>
      <td ><input type="text" name="ref" id="ref"  class="texto" /></td>
      <td ><strong>Nro Contrato</strong></td>
      <td >:</td>
      <td >
        <input type="text" name="contrato" id="contrato" class="texto"/></td>
      <td >&nbsp;</td>
    </tr>
    <tr>
      ...
      <td >:</td>
      <td >
        <input type="text" name="lugar" id="lugar"  class="texto" /></td>
      <td ><strong>Nro Cotizacion</strong></td>
      <td >:</td>
      <td ><input type="text" name="coti" id="coti"  class="texto" /></td>
      <td >&nbsp;</td>
    </tr>
    <tr>
      <td height="27" ><strong>Fecha Giro</strong></td>
      <td >:</td>
      <td ><input name="fgiro" type="text" class="texto" id="fgiro" size="12" readonly="readonly"  /><img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fgiro",
      ...
      <td >:</td>
      <td ><input name="fvcto" type="text" class="texto" id="fvcto" size="12" readonly="readonly"  /><img src="../images/calendario.jpg" name="Image2" id="Image2" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fvcto",
    ...
    <tr>
      ...
      <td >:</td>
      <td >
        <input type="text" name="cliente" id="cliente"  class="texto" placeholder="Ingrese Nombre Cliente" />
        <input type="hidden" name="codcli" id="codcli" /></td>
      <td ><strong>Nro Doc Cliente</strong> </td>
      <td >:</td>
      <td ><input type="text" name="ruc" id="ruc" class="texto"  /></td>
      <td >&nbsp;</td>
    </tr>
    <tr>
      ...
      <td >:</td>
      <td colspan="5" >
        <input name="dire" type="text" id="dire" size="62" class="texto"  />
     ...
     <tr>
      ...
      <td >:</td>
      <td >
        <input type="text" name="c_nomava" id="c_nomava"  class="texto" placeholder="Ingrese Nombre Aval" />
      </td>
      <td ><strong>Nro Doc Aval</strong></td>
      <td >:</td>
      <td ><input type="text" name="c_docava" id="c_docava" class="texto" onkeypress="return ValidaEntero(event)" /></td>
      <td >&nbsp;</td>
    </tr>
     <tr>
      ...
      <td >:</td>
      <td >
        <input type="text" name="c_telava" id="c_telava"  class="texto" onkeypress="return ValidaEntero(event)" />
      </td>
      <td ><strong>Direccion Aval</strong></td>
      <td >:</td>
      <td ><input type="text" name="c_dirava" id="c_dirava" class="texto"  /></td>
      <td >&nbsp;</td>
    </tr>
    <tr>
      <td ><strong style="color:#03F">Usuario</strong>
</td>
      <td >:</td>
      <td colspan="5" >
<input name="udni" type="text"  class="texto" id="udni" readonly="readonly" value="<?php echo $udnix ?>" />&nbsp;</td> <!- -->
    </tr>
    <tr>
      <td >&nbsp;</td>
      <td >&nbsp;</td>
  ...
  <p><input type="button" name="button" id="button" value="Registrar" onclick="graba()"/>
