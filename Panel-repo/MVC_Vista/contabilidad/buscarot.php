...
$().ready(function() {
	$("#txtbusca").autocomplete("../MVC_Controlador/ContabilidadC.php?acc=cargar_OT", {
		width: 260, 
		matchContains: true,
		selectFirst: false
	});	
...
<div class="column_left">
    <div class="header"><strong>BUSQUEDA DE ORDEN TRABAJO</strong></div>
  <table width="575"class="data"  cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td width="573" colspan="6">Busque OT 
