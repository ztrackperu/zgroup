...
$c_codmon=$item["c_codmon"];if($c_codmon=='0'){$moneda='S/';}else if($c_codmon=='1'){$moneda='US$';}else{$moneda='';}
...
$top_2 = 38;	
    $pdf->SetXY(38, $top_2); 
	if($c_imppal!=""){
	$c_imppalX=str_pad($c_imppal.' ', 125, '*', STR_PAD_RIGHT);
	}
...
$top_5 = 56;	
	...
	$pdf->Multicell(80,3.5, $c_dircli); //widh 65mm,separacion cada fila 2mm
...
$top_8 = 78;	
	$pdf->SetXY(52, $top_8); 
	$pdf->Multicell(65,2.5, $c_dirava);//widh 55mm,separacion cada fila 2mm
