...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ContabilidadC.php?acc=ver1">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>Reporte de Facturas Proveedores Por Vencer</div>
      <br class="clear"/>
					<div class="content">
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
      ...
      <td width="107" bgcolor="#CCCCCC">Tipo Mov</td>
      <td width="107" bgcolor="#CCCCCC">RUC Proveedor</td>
      <td width="77" bgcolor="#CCCCCC">Razon Social</td>
      <td width="77" bgcolor="#CCCCCC">Fecha Registro</td>
      <td width="82" bgcolor="#CCCCCC">Fecha Vencimiento</td>
      <td width="82" bgcolor="#CCCCCC">Monto</td>
      </tr>
                            </thead>
                            <tbody>
                                <?php 
      ...
      <td align="center"><?php echo $item["pr_ndoc"];?></td>
      <td align="center"><?php echo $item["pr_tmov"]; ?>&nbsp;</td>
      <td align="center"><?php echo $item["pr_rucc"];?></td>
      <td align="center"><?php echo $item["pr_razo"];?></td>
      <td align="center"><?php echo $item["pr_rucc"];?></td>
      <td align="center"><?php echo vfecha(substr($item["pr_fven"],0,10));?></td>
      <td align="center"><?php echo $item["pr_dtot"];?></td>
      </tr>
