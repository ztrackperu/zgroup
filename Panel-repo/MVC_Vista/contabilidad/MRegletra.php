...
onkeyup = "compUsuario(event)" value="AUTOGENERADO" readonly="readonly" />       </td>
    ...
    <tr>
      ...
      <td >:</td>
      <td ><input name="monto" type="text" id="monto" size="10" class="texto"  /></td>
      <td >&nbsp;</td>
      <td >&nbsp;</td>
      <td width="146" >&nbsp;</td>
      <td width="271" >&nbsp;</td>
    ...
    <tr>
      ...
      <td ><strong>Fac-Referencia</strong></td>
      <td >:</td>
    ...
    <tr>
      ...
      <td >:</td>
      <td colspan="5" >
        <input name="dire" type="text" id="dire" size="62" class="texto"  /></td>
    </tr>
    <tr>
...
<input name="udni" type="text"  class="texto" id="udni" value="<?php echo $udnix ?>" readonly="readonly"/>&nbsp;</td>
  ...
  <p><input type="button" name="button" id="button" value="Registrar" onclick="graba()"/>
    <input type="button" name="button2" id="button2" value="Cancelar"  />&nbsp;</p>
</fieldset>
</form>
</body>
</html>
