...
<table width="1350" border="0" style="font-size:12px;font-family:sans-serif">
  <tr>
    <td colspan="6">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="26" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $d_fecgui; ?>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="44" colspan="3" align="center" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo strtoupper($c_parti); ?>&nbsp;</td>
    <td colspan="3" align="center" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo strtoupper($c_llega); ?>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $c_deprem; ?></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $c_provrem; ?></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $c_distrem; ?></td>
  ...
  <tr>
    <td height="39" colspan="3" align="center" valign="bottom"><?php echo $c_desrem ?></td>
    <td colspan="3" align="center"><?php echo $c_nomdes; ?></td>
  </tr>
  <tr>
    <td height="31" colspan="3" align="center"><?php echo $c_rucrem ?></td>
