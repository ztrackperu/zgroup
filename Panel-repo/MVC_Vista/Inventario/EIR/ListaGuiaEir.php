...
<div class="onecolumn">
    <div class="header"><strong>GENERACION DE EIR</strong></div>
                    <strong style="color:#FFF"><?php echo $mod=$_GET['mod']; ?></strong>
<strong>Nuevo</strong><a href="../MVC_Controlador/InventarioC.php?acc=regguia&guia=<?php echo $item["c_numguia"];  ?>&udni=<?php echo $val=$_GET['udni']; ?>&mod=<?php echo $_GET['mod'];?>"><img src="../images/nuevo.png" width="35" height="35" /></a><br class="clear"/>
                    <div class="content">
										...
										if($listagr!=NULL)
{
            ...
            ?>
                                <tr>
                                  ...
                                  <td bgcolor="#FFFFFF"><?php if($item['c_numeir']==''){echo '<strong style="color:#FF0000">Pendiente</strong>';}else{
                                  ...
                                  <?php if($item['c_numeir']==''){?>
 
                                  <a href="../MVC_Controlador/InventarioC.php?acc=regeirsal&guia=<?php echo $item["c_numguia"]; ?>&udni=<?php echo $val=$_GET['udni']; ?>&mod=<?php echo $_GET['mod'];?>"><img src="../images/transporte.png" width="18" height="18" title="Generar Eir Salida" /></a>&nbsp;&nbsp;
              <?php }?>                    
