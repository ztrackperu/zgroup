...
function add2(){
	...
	longitud = claseprd.length;
	if(claseprd=="001" || claseprd=="002" || claseprd=="003" ||claseprd=="004" ||claseprd=="012" ){
		if(longitud<4){
			alert('Codigo Ingresado Para este producto no es valido');
		return 0;
			}
		}
...
<body onload="activa1()">
Registro Guía de Remisión a travez de cotizacion
...
<fieldset class="fieldset legend" style="width:100%">
  ...
  <tr>
    <td bgcolor="#FFCCCC" ><strong>Cotizacion Nro:</strong></td>
    ...
    <input type="hidden" name="idcli" id="idcli" />
      <input type="hidden" name="c_numped2" id="c_numped2" />
      ...
      <strong style="color:#F00">Solo filtra aquella cotizacion que este aprobada</strong></label>
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFCCCC"><label for="textfield"></label>
      ...
      Nro Guia
        ...
        Nro Cotizacion      </td>
    <td width="144" bgcolor="#FFCCCC"><input name="c_numped" type="text" class="texto" id="c_numped" onkeypress="return isNumberKey(event)" 
...
<label for="select2">Fecha
  ...
  <tr>
    ...
    <td colspan="4" bgcolor="#FFCCCC"><input name="textfield7"  class="texto" type="text" id="textfield7" value="<?php echo $ruc; ?>" size="20" />      Dcto Referencia
 ...
 <fieldset class="fieldset legend">
  <legend style="color:#03C"><strong>DATOS DEL TRANSPORTISTA</strong>
    </legend><table width="1086" border="0" cellpadding="0" cellspacing="0">
  <tr>
...
<fieldset class="fieldset legend">
  ...
  <table width="1086" border="0"  id="tablaDiagnostico2">
  <tr>
    ...
    <td width="226">Busque aqui codigo.
      <input name="unidad" type="text" class="texto"  id="unidad" onclick="abreVentana(this.name)" onkeypress="return ValidaEntero(event)" size="25"/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
     ...
     <?php 
							...
							?>
      <tr>
    <td bgcolor="#CCCCCC"><input name="<?php echo "codigorepuesto".$i; ?>" type="hidden" id="<?php echo "codigorepuesto".$i; ?>" size="15" value="<?php echo $itemD["c_codprd"]; ?>" /><input name="<?php echo "unidad".$i; ?>" type="hidden" id="<?php echo "unidad".$i; ?>" size="15" value="<?php echo substr($itemD["c_codcont"],2); ?>" /><input name="<?php echo "material".$i; ?>" type="text" id="<?php echo "material".$i; ?>" size="40" value="<?php echo $itemD["c_desprd"]; ?>" class="texto"/></td>
    <td bgcolor="#CCCCCC"></td>
    <td bgcolor="#CCCCCC"><input name="<?php echo "codcont".$i; ?>" type="text" id="<?php echo "codcont".$i; ?>" size="20"  class="texto" onclick="abreVentana(this.name,'<?php echo $itemD["c_codprd"]; ?>','<?php echo $itemD["c_tipped"]; ?>')" value="<?php echo substr($itemD["c_codcont"],2); ?>"/>&nbsp;
      <input type="text" size="3" name="<?php echo "codigoequipo".$i; ?>" id="<?php echo "codigoequipo".$i; ?>" value="<?php echo $itemD["c_codcont"]; ?>" /></td>
    ...
    <td bgcolor="#CCCCCC"><input name="<?php echo "estaequi".$i; ?>" type="text" id="<?php echo "estaequi".$i; ?>" size="5" value="<?php if($itemD["c_tipped"]=='001'){ echo 'V';}else{echo 'A';}?>" class="texto"/><a href='#'><img src='../images/user_logout.png' value='Eliminar'  onclick='eliminarUsuario2(this)'></a></td>
    <td>&nbsp;</td>
  </tr>
     <?php 	
								$i++;
