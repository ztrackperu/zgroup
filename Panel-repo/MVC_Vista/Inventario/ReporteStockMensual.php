...
<title>Reporte Stock Mensual</title>
...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/InventarioC.php?acc=verrepstock">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> <span>Reporte de Stock Valorizado Mensual (CT)</div>
      <br class="clear"/>
					<div class="content">
					  <table width="85%" border="1" align="center" cellpadding="0" cellspacing="0"  >
					    <tr>
					      <td width="35%" align="right" >Año</td>
					      <td width="25%" >
				          <input name="anno" type="text" id="anno" size="8" maxlength="4" class="texto" value="<?php echo date("Y") ?>" /></td>
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:10px">
                            <thead>
                                <tr align="center">
                                  <td colspan="7"><?php echo 'Reporte DETALLADO del '.$_POST['textfield'].' al '.$_POST['textfield2']; ?><br />
      ...
      <td width="120" bgcolor="#CCCCCC">Codigo</td>
      <td width="379" bgcolor="#CCCCCC">Descripcion</td>
      <td width="89" bgcolor="#CCCCCC">Unidad</td>
      <td width="96" bgcolor="#CCCCCC">Stock</td>
      <td width="126" bgcolor="#CCCCCC">Costro Promedio</td>
      <td width="132" bgcolor="#CCCCCC">Stock Valorizado</td>
      </tr>
                            </thead>
                            <tbody>
                                <?php 
      ...
      <td align="center"><?php echo $item["IN_CODI"];?></td>
      <td align="center"><?php echo utf8_decode($item["IN_ARTI"]);?></td>
      <td align="center"><?php echo $item["IN_UVTA"];?></td>
      <td align="center"><?php echo $item["IN_STOK"];?></td>
      <td align="center"><?php echo $item["IN_COST"];?></td>
      
      <td align="center"><?php echo $item["IN_STOK"]*$item["IN_COST"]?></td>
      </tr>
                                <?php
                        $i += 1;
					 }
