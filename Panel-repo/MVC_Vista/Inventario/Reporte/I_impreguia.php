			  ...
			  {	
				...
				//for($i=1;$i<=7;$i++){
				 foreach($detalle as $itemD){	
				  echo $val=$itemD['n_item'];
					if($val=='1'){
					 
					 $linea1a=  $itemD['n_canprd'];
					 $linea1b=  $itemD['c_desprd'].'- CODIGO:'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']);
					  }else{
						 $linea1a ='';
						 $linea1b='';
					}
					if($val=='2'){
					 ...
					 $linea2a=  $itemD['n_canprd'];
					 $linea2b=  $itemD['c_desprd'].'- CODIGO:'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']);
					  }else{
					...
					if($val=='3'){
					 ...
					 $linea3a=  $itemD['n_canprd'];
					 $linea3b=  $itemD['c_desprd'].'- CODIGO:'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']);
					  }else{
						 $linea3a ='';
						 $linea3b='';
					}
					if($val=='4'){
					 ...
					 $linea4a=  $itemD['n_canprd'];
					 $linea4b=  $itemD['c_desprd'].'- CODIGO:'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']);
					  }else{
						 $linea4a ='';
						 $linea4b='';
					}
					if($val=='5'){
					 ...
					 $linea5a=  $itemD['n_canprd'];
					 $linea5b=  $itemD['c_desprd'].'- CODIGO:'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']);
					  }else{
						 $linea5a ='';
						 $linea5b='';
					}																				
					if($val=='6'){
					 ...
					 $linea6a=  $itemD['n_canprd'];
					 $linea6b=  $itemD['c_desprd'].'- CODIGO:'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']);
					  }else{
						 $linea6a ='';
						 $linea6b='';
					}
					if($val=='7'){
					 ...
					 $linea7a=  $itemD['n_canprd'];
					 $linea7b=  $itemD['c_desprd'].'- CODIGO:'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']);
					  }else{
						 $linea7a ='';
						 $linea7b='';
					}
...
<div class="cuerpo1">
    ...
    <form id="frmImpresion" name="frmImpresion" method="post" >
        ...
        <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:14px;font-family:sans-serif">
            ...
            <tr>
              <td height="23">&nbsp;</td>
              <td><?php echo $linea1a ?></td>
              <td colspan="8"><?php echo $linea1b ?></td>
              </tr>
                  
            <tr>
              <td height="23">&nbsp;</td>
              <td><?php echo $linea2a ?></td>
              <td colspan="8"><?php echo $linea2b ?></td>
              </tr>
            <tr>
              <td height="23">&nbsp;</td>
              <td><?php echo $linea3a ?></td>
              <td colspan="8"><?php echo $linea3b ?></td>
              </tr>
            <tr>
              <td height="22">&nbsp;</td>
              <td><?php echo $linea4a ?></td>
              <td colspan="8"><?php echo $linea4b ?></td>
              </tr>
            <tr>
              <td height="20">&nbsp;</td>
              <td><?php echo $linea5a ?></td>
              <td colspan="8"><?php echo $linea5b ?></td>
              </tr>
            <tr>
              <td height="23">&nbsp;</td>
              <td><?php echo $linea6a ?></td>
              <td colspan="8"><?php echo $linea6b ?></td>
              </tr>
            <tr>
              <td>&nbsp;</td>
              <td><?php echo $linea7a ?></td>
              <td colspan="8"><?php echo $linea7b ?></td>
              </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
