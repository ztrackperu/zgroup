        ...
        <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:14px;font-family:sans-serif">
            <tr>
	          <td width="38208" colspan="8">
                ...
                <table width="1400" border="0" align="left" cellpadding="0" cellspacing="0" class="tablaImprimir" style="font-size:12px;font:sans-serif">
                  <tr style="font:sans-serif;font-size:12px">
                    <td height="18">&nbsp;</td>
                    <td width="5%">&nbsp;</td>
                    <td colspan="3">&nbsp;</td>
                    <td colspan="5">&nbsp;</td>
            ...
            <tr>
              ...
              <td ><?php echo $itemD['c_desprd'].'- //'.strtoupper($itemD['c_codprd']).' '.strtoupper($itemD['c_obsprd']) ?></td>
              </tr>
                  <?php 	
					$i++;
					}			
