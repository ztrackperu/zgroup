...
var dep=document.form1.c_depo.options[document.form1.c_depo.selectedIndex].text;
if(dep=='.:[Seleccione]:.'){
	jAlert('Ingrese Deposito Origen', 'Mensaje del Sistema');
   return 0;
  }	
var depD=document.form1.c_depoD.options[document.form1.c_depoD.selectedIndex].text;
if(depD=='.:[Seleccione]:.'){
	jAlert('Ingrese Deposito Destino', 'Mensaje del Sistema');
   return 0;
  }	
...
jConfirm("Seguro de Grabar EIR <?php echo ' '.$sw; ?> ?", "Mensaje Confirmacion", function(r) {
			if(r) {
...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    <div class="TabbedPanelsContent"><?php  if($c_numguia==""){echo '<strong style="color:#0000FF">El siguiente EIR se esta realizando sin guia remision</strong>';}else{echo '<strong style="color:#0000FF">El siguiente EIR se esta realizando con referencia al Nro de Guia '.$c_numguia.'</strong>';} ?>
  ...
  <tr>
    ...
    <td width="213">
      ...
      <input type="hidden" name="c_tipoio" id="c_tipoio" value="<?php if($_GET['sw']=='SALIDA'){echo '2';}else{echo '1';} ?>" />
      <input type="hidden" name="c_tipois" id="c_tipois" />
      <input type="hidden" name="c_numguia" id="c_numguia" 
      value="<?php if($c_numguia==""){echo $_GET['oc'];}else{echo $c_numguia;} ?>" />
      <input type="hidden" name="eirsal" id="eirsal" value="<?php echo $_GET['guia'] ?>" /></td>
    ...
    <td width="203">
      ...
      <input type="hidden" name="ingdirec" id="ingdirec" value="<?php echo $_GET['ingdirec'] ?>" /></td>
    </tr>
  <tr>
    <td>Cliente</td>
    <td>:</td>
  ...
  <tr>
    ...
    <td>:</td>
    <td><?php $ven = ListaDepositoM();?>
        	<select name="c_depo" id="c_depo" class="Combos texto" >
    ...
    <td align="right">Deposito Destino</td>
    <td>:</td>
    <td><?php $ven = ListaDepositoM();?>
        	<select name="c_depoD" id="c_depoD" class="Combos texto" >
            	<option value="">.:SELECCIONE:.</option>
				<?php foreach($ven as $item){
				 $nombre=$item["c_desitm"];
			     $id=$item["c_numitm"];	
...
<fieldset class="fieldset legend">
  ...
  <tr>
    <td width="125">Descripcion
      <input name="tiping" type="hidden" id="tiping" value="<?php echo $_GET['tipoing'] ?>" />
    ...
    value="<?php if($_GET['flag']=='1'){echo $c_codequipo;}else{echo substr(ltrim($c_codequipo),2,30);} //$c_codprd ?>" readonly="readonly" /><input type="text" name="c_idequipo" id="c_idequipo" value="<?php echo ltrim($c_codequipo) ?>"/></td>
    <td width="70" rowspan="3"><a rel="shadowbox;width=1500;height=760" href="../MVC_Controlador/cajaC.php?acc=datosmanufactura&amp;cod=<?php echo $c_codequipo;?>&amp;situ=<?php echo ""?>&amp;udni=<?php echo $_GET['udni'];?>&amp;codclase=<?php echo $cod_tipo;?>&swequipo=1&c_codequipo=<?php echo $_GET['c_codequipo']?>&nom=<?php echo $_GET['nom'] ?>&coprod=<?php echo $_GET['coprod']; ?>"><img src="../images/analitico.jpg" alt="" width="70" height="71" /></a></td>
    <td width="44">&nbsp;</td>
    </tr>
  <tr>
    <td>Estado Equipo</td>
...
<?php */?>          
      ...
      <input type="hidden" name="c_codprod" id="c_codprod" size="5" value="<?php echo $_GET['coprod']; ?>" />
      <input type="hidden" name="item" id="item" value="<?php echo $_GET['item'] ?>" /></td>
...
<table width="762" border="0">
  <tr>
    ...
    <td width="13">:</td>
    <td width="223"> <input name="c_fechora" type="text" id="c_fechora" size="20" class="texto" value="<?php echo date("d/m/Y H:i:s") ?>"/><img src="../images/calendario.jpg" name="fecinix" id="fecinix" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
