...
<body>
<form id="form1" name="form1" method="post" action="../MVC_Controlador/InventarioC.php?acc=regingxoc&sw=1&udni=<?php echo $val=$_GET['udni']; ?>&mod=<?php echo $_GET['mod'];?>">
<div class="onecolumn">
    <div class="header"><strong>GENERACION DE EIR</strong>(INGRESO NUEVOS EQUIPOS) *implementado desde el 08/07/2015</div>
                    <strong style="color:#FFF"><?php echo $mod=$_GET['mod']; ?></strong>
<strong></strong><a href="../MVC_Controlador/InventarioC.php?acc=regeisinguia&udni=<?php echo $val=$_GET['udni']; ?>&mod=<?php echo $_GET['mod'];?>&sw=ENTRADA&tipoing=1&ingdirec=0"></a><br class="clear"/>
                    <div class="content">
                        <table class="data" width="894" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                  <th colspan="10" bgcolor="#FF0000" style="width:5%"><input type="radio" name="sw" id="sw" value="1" /> CLIENTE / 
                                  <input name="sw" type="radio" id="sw" value="3" checked="checked" />
                                  
                                  FILTRO POR NRO DE EQUIPO</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th width="2%">&nbsp;</th>
                                    <th width="8%" align="center" valign="middle">Item</th>
                                    <th width="9%" align="center" valign="middle">Nro O/C</th>
                                    ...
                                    <th width="8%" align="center" valign="middle">Fecha N/I</th>
                                    <th width="12%" align="center" valign="middle">Estado</th>
                                    <th width="15%">Administrar</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php $listagr = $carga_list_xoc;?>
                                <?php 
                    $i = 1;
										if($listagr!=NULL)
{
            ...
            ?>
                                <tr>
                                  <td><?php echo $i; ?>&nbsp;</td>
                                  <td bgcolor="#FFFFCC"><?php echo $item[''] ?>&nbsp;</td>
                                  <td bgcolor="#CCCCFF"><?php echo $item['c_numeoc'] ?></td>
                                  <td bgcolor="#E5E5E5"><?php echo utf8_decode($item["c_nomdes"]);?> </td>
                                  <td><?php echo $item["c_desprd"];?></td>
                                  <td><?php echo $codigo=substr($item["c_desprd"],0,1).'-'.$item["c_codequipo"];?></td>
                                  <td><?php echo $item["C_CODSITALM"]; ?>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td bgcolor="#FFFFFF">
								  <?php 
                                  ...
                                  <a href="../MVC_Controlador/InventarioC.php?acc=registroxoc&guia=0&udni=<?php echo $val=$_GET['udni']; ?>&mod=<?php echo $_GET['mod'];?>&sw=ENTRADA&flag=1&swequipo=1&c_codequipo=<?php echo $codigo ?>&nom=<?php echo $item['c_desprd']; ?>&coprod=<?php echo $item['c_codprd']; ?>&oc=<?php echo $item['c_numeoc'] ?>"><img src="../images/transporte.png" width="18" height="18" title="Generar Eir Ingreso" /></a>&nbsp;&nbsp;
              <?php }?>                    
                     </td>
                   </tr>
                <?php $i++;}}?>
