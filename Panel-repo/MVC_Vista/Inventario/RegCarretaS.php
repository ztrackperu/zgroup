...
<?php */?>          
          ...
          <tr>
            ...
            <input name="transportista" type="text" id="transportista" size="35" class="texto" /><a href="#" onClick="abreVentanachofer()">
             <input type="hidden"  size="5"name="c_codcli" id="c_codcli" /><input type="hidden" name="hiddenField2" id="hiddenField2" />
            Busque Chofer</a> </td>
          </tr>
          <tr>
            <td>Placa Camion:</td>
          ...
          <tr>
            <td>Nombre Chofer:</td>
            <td><input name="c_chofer" type="text" id="c_chofer" size="50" class="texto"/>
    ...
    <?php }	?>
      ...
      <div class="TabbedPanelsContent">
        <table width="796" border="0" align="left" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td>Tamaño</td>
            <td><?php $ven = TamanoCarretaC();?>
            <select name="c_tamCarreta" id="c_tamCarreta" class="combo texto">
              <option value="0">.::SELECCIONE::.</option>
              <?php foreach($ven as $item){?>
          ...
          <tr>
            <td>Nro Ejes</td>
            <td><?php $ven = EjesCarretaC();?>
            <select name="c_nroejes" id="c_nroejes" class="combo texto">
              <?php foreach($ven as $item){?>
              <option value="<?php echo $item["c_numitm"]?>"><?php echo $item["c_desitm"]?></option>
              <?php }	?>
            </select>&nbsp;</td>
          ...
          <tr>
            ...
            <td><input type="hidden" name="c_seriemotor" id="c_seriemotor" />
            <input type="hidden" name="c_fabcaja" id="c_fabcaja" class="texto"  /></td>
            <td><input type="hidden" name="c_cmodel" id="c_cmodel" class="texto"/>
            <input type="hidden" name="c_cfabri" id="c_cfabri" class="texto"/></td>
          </tr>
          <tr>
            <td>Serie VIN</td>
            <td><input type="text" name="c_control" id="c_control" required="required"class="texto" /></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>Modelo</td>
            <td><input type="text" name="c_codmod" id="c_codmod" required="required" class="texto"/></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><label for="c_procedencia"></label>
              <input type="text" name="c_procedencia" id="c_procedencia" class="texto" required="required"/>
          ...
          <tr>
            <td>Tara</td>
            <td><input type="text" name="c_tara" id="c_tara" class="texto" required="required"  /></td>
            <td><input name="c_nacional" type="hidden" id="c_nacional" value="0" />
          ...
          <tr>
            <td>Peso Maximo</td>
            <td><input type="text" name="c_peso" id="c_peso"  class="texto" required="required"/></td>
