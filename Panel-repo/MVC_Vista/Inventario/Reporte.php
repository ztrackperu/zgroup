...
<form id="form1" name="form1" method="post" action="">
  <table width="815" height="120" border="0">
    <tr>
      <td align="center">REPORTE DE INVENTARIOS</td>
    </tr>
    <tr>
      <td height="23">1.- <a href="../MVC_Controlador/InventarioC.php?acc=reporte01&udni=<?php echo $_GET['udni']; ?>">REPORTE DE EQUIPOS TRANSITO (TRANSPORTE REFRIGERADO)</a></td>
    </tr>
    <tr>
      <td height="23">2.- <a href="../MVC_Controlador/cajaC.php?acc=repcot7&udni=<?php echo $_GET['udni']; ?>&mod=<?php echo $_GET['mod']; ?>">LISTA DE EQUIPOS POR SITUACION</a></td>
    </tr>
    <tr>
