      ...
      <div class="TabbedPanelsContent">
        <table width="796" border="0" align="left" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <!--nos encontramos en el centro de lima-->
          ...
          <tr>
            <td>Serie Motor</td>
            <td>
              <input type="text" name="c_seriemotor" id="c_seriemotor" required="required" />
           </td>
          ...
          <tr>
            <td>Serie Equipo</td>
            <td><input type="text" name="c_serieequipo" id="c_serieequipo" class="texto" required="required"/></td>
          ...
          <tr>
            ...
            <td><label for="c_procedencia"></label>
              <input type="text" name="c_procedencia" id="c_procedencia" class="texto" required="required"/ ></td>
            <td>&nbsp;</td>
