...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/InventarioC.php?acc=regeir&udni=<?php echo $_GET['udni'] ?>">
  <div id="TabbedPanels1" class="TabbedPanels">
    <ul class="TabbedPanelsTabGroup">
      ...
      <?php if($tiping=='1'){ echo 'Ingreso';}else{echo 'Salida';} ?></li>
...
<?php */?>          
          ...
          <tr>
            <td> Cliente: </td>
            <td colspan="3"><input name="c_nomcli" type="text" id="c_nomcli" size="35" class="texto" required="required"/>
              <input type="hidden"  size="5"name="c_codcli" id="c_codcli" />
              Almacen
<input name="c_almacen" type="text" id="c_almacen" size="25"  class="texto" />
<input type="hidden" name="c_licencia" id="c_licencia" /></td>
          </tr>
          <tr>
            <td>Transportista</td>
            <td colspan="3">
    ...
    <?php }	?>
      ...
      <div class="TabbedPanelsContent">
        <table width="796" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="4" align="left"> (EIR)
            <input type="hidden" name="c_tipoio" id="c_tipoio"  value="<?php echo $tiping; ?>"/></td>
          </tr>
          <tr>
            ...
            <td colspan="3"><input name="c_codprd" type="text" class="texto" id="c_codprd" value="<?php echo $nombreprod ?>" size="35" />
              Serie
              <input name="c_nserie" type="text" class="texto" id="c_nserie" value="<?php echo $equipo ?>" size="15" />
          ...
          <tr>
            ...
            <td width="260"><?php $ven = listaannoC();?>
          ...
          <tr>
            ...
            <td>Fabricacante</td>
            <td><input type="text" name="c_cfabri" id="c_cfabri" class="texto" value="<?php echo $c_cfabri ?>" required="required"/></td>
          </tr>
          <tr>
            <td>Color</td>
            ...
            <td>Modelo</td>
            <td><input type="text" name="c_cmodel" id="c_cmodel" class="texto" value="<?php echo $c_cmodel ?>" required="required"/></td>
          </tr>
          <tr>
            <td>Tipo Material</td>
            ...
            <td>Serial Nro</td>
            <td><input type="text" name="c_serieequipo" id="c_serieequipo" class="texto" required="required" value="<?php echo $c_serieequipo ?>"/></td>
          </tr>
          <tr>
            <td>Procedencia</td>
            ...
            <td>Controlador</td>
            <td><input type="text" name="c_ccontrola" id="c_ccontrola" class="texto" required="required" value="<?php echo  $c_ccontrola?>"/></td>
          </tr>
          <tr>
            <td colspan="2" bgcolor="#CCCCCC">DATOS PESO:</td>
            <td>Tipo Gas Refrigerante</td>
            <td><input name="c_tipgas" type="text"class="texto" id="c_tipgas" value="R134-A" /></td>
          </tr>
          <tr>
            <td>Tara</td>
            <td><input type="text" name="c_tara" id="c_tara" class="texto" value="<?php echo $c_tara ?>" required="required"  /></td>
            <td>
              <input type="hidden" name="c_nroejes" 	id="c_nroejes" />
              ...
              <input type="hidden" name="c_nacional"	id="c_nacional" value="0" />
          ...
          <tr>
            ...
            <input type="button" name="button" id="button" value="GUARDAR INFORMACION" onclick="valida()"/>
            </td>
          </tr>
        </table>
      </div>
      <div class="TabbedPanelsContent">
        <table width="200" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><img src="../images/1.jpg" alt="1" width="268" height="171" border="0" />&nbsp;
              <label for="textfield12"></label></td>
            <td><img src="../images/2.jpg" alt="2" width="190" height="183" border="0" />&nbsp;</td>
            <td><img src="../images/3.jpg" alt="3" width="250" height="183" border="0" />&nbsp;</td>
          </tr>
          <tr>
            <td><textarea name="img1" cols="25" rows="5" id="img1">ok</textarea></td>
            <td><textarea name="img2" cols="25" rows="5" id="img2">ok</textarea></td>
            <td><textarea name="img3" cols="25" rows="5" id="img3">ok</textarea></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
