...
<body>
<strong style="color:#99C">GENERACION DE EIR ENTRADA</strong>
<form id="form1" name="form1" method="post" action="">
<?php  if($c_numguia==NULL){echo '';}else{echo '<strong style="color:#0000FF">El siguiente EIR se esta realizando con referencia al Nro de Guia '.$c_numguia.'</strong>';} ?>
...
<fieldset class="fieldset legend">
  ...
  <tr>
    <td width="132">Descripcion
      <input name="tiping" type="hidden" id="tiping" value="1" />
    ...
    <td width="126"><a href="#" onclick="abreVentana(this.name)">Codigo Equipo</a></td>
    <td width="15">:</td>
