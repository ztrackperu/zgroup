...
<?php */?>          
          ...
          <tr>
            <td> Cliente: </td>
            <td colspan="3"><input name="c_nomcli" type="text" id="c_nomcli" size="35" class="texto"/>
              Almacen
            ...
            <td width="1701" colspan="4"><table width="796" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td><label for="c_fabcaja"></label>
                  <input type="text" name="c_fabcaja" id="c_fabcaja" class="texto"  /></td>
                <td>&nbsp;</td>
                <td>
              ...
              <tr>
                <td>Tara</td>
                <td>
                  <input type="text" name="c_tara" id="c_tara" class="texto"  /></td>
              ...
              <tr>
                <td>Peso Maximo</td>
                <td>
                  <input type="text" name="c_peso" id="c_peso"  class="texto"/></td>
