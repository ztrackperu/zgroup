...
if($resultado2 != NULL){
	foreach ($resultado2 as $itemE) {
		$c_material=$itemE['c_material'];	
$c_numeir=$itemE['c_numeir'];
$observacion=utf8_decode(strtoupper($itemE['c_obseir']));
$c_idequipo=$itemE['c_idequipo'];$c_codprd=$itemE['c_codprd'];$c_nserie=$itemE['c_nserie'];
