...
<?php */?>          
          ...
          <tr>
            ...
            <td colspan="3"><input name="c_nomcli" type="text" id="c_nomcli" size="35" class="texto" required="required"/>
               <input type="hidden"  size="5"name="c_codcli" id="c_codcli" />Almacen
    ...
    <?php }	?>
      ...
      <div class="TabbedPanelsContent">
        <table width="200" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><img src="../images/1.jpg" width="268" height="171" border="0" />&nbsp;
              <label for="textfield12"></label></td>
            <td><img src="../images/2.jpg" width="190" height="183" border="0" />&nbsp;</td>
            <td><img src="../images/3.jpg" width="250" height="183" border="0" />&nbsp;</td>
          </tr>
          <tr>
            <td><textarea name="img1" cols="25" rows="5" id="img1">ok</textarea></td>
            <td>
            <textarea name="img2" cols="25" rows="5" id="img2">ok</textarea></td>
            <td>
            <textarea name="img3" cols="25" rows="5" id="img3">ok</textarea></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
