...
<body>
<form id="formElem" name="formElem" method="post" action="../MVC_Controlador/ComprasC.php?acc=guardarefoc&udni=<?php echo $_GET['udni'] ?>">
  <div class="column_left">
    <div class="header"><strong>REFERENCIA ORDEN DE COMPRA..</strong></div>
	<?php 
