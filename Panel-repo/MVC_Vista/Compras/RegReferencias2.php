...
<body>
<form id="formElem" name="formElem" method="post" action="../MVC_Controlador/ComprasC.php?acc=guardarefoc2&udni=<?php echo $_GET['udni'] ?>">
  <div class="column_left">
    <div class="header"><strong>2DA - REFERENCIA ORDEN DE COMPRA..</strong></div>
	<?php 
 ...
 ?>
  <table width="527" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="22" align="right" valign="middle">Orden de Compra Nro</td>
      <td align="center" valign="middle">&nbsp;</td>
      <td valign="middle">
        <input type="text" name="c_numoc" id="c_numoc"  class="texto" value="<?php echo $_GET['oc'] ?>"/>
	...
	<tr>
      ...
      <td valign="middle"><label for="textfield"></label>
		<?php $ven = ListaMonedaC();  
					?>
					<select name="c_tipmon" id="c_tipmon" >
	...
	<tr>
      <td align="right" valign="middle">Importe</td>
      <td align="center" valign="middle">:</td>
      <td valign="middle"><label for="textfield"></label>
       <input name="c_importe" type="text" required="required" class="texto"  id="c_importe"  value="<?php echo $n_totoc;?>"  size="10" /></td>
    </tr>
	<tr>
