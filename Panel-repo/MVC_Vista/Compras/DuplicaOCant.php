...
function guarda(){
	 ...
	 if(confirm("Seguro de Duplicar Orden Servicio ?")){
...
<strong style="text-align:center">DUPLICAR ORDEN DE COMPRA</strong>
<fieldset class="fieldset legend">
    <legend style="color:#C33"><strong>Encabezado Orden de Compra</strong></legend>
  <table width="987" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="151">Nº Ord. Serv.</td>
      <td width="10">:</td>
      <td width="241">
      <input name="c_numeoc" type="text"  class="texto" id="c_numeoc" value="XXXXX" readonly="readonly"/></td>
      <td width="14">&nbsp;</td>
 ...
 <a style='cursor: pointer;' onClick="muestra_oculta('contenido_a_mostrar')" title=""><strong style="color:#60F">Datos Adicionales Para Glosa Servicio</strong> <img src="../images/Transfer Document.png" alt="" width="18" height="18" /></a>
  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td>
        ...
        <input type="hidden" name="imp" id="imp" size="5"/> <a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" border="0" /></a>&nbsp;<input name="c_rh" type="checkbox" id="c_rh" value="1" onclick="rh()" />
        <label for="c_rh">R/H
  ...
  <table width="990" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td>:</td>
      <td colspan="4"><textarea name="c_obs" id="c_obs" cols="60" rows="3"><?php echo $c_obs ?>
      </textarea></td>
      </tr>
      <tr>
