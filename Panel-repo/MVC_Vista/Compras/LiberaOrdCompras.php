...
<title>Liberar Orden De Compra</title>
...
function ValidarFecha(){
	...
	alert('La fecha Entrega no puede ser Menor a la fecha Registro');
...
if(document.getElementById("codigo").value==""){
	alert('Codigo del Producto No Existe');
		document.getElementById("descripcion").focus();
	return 0;
}
...
cantFilas = theTable.rows.length;
		...
		if(cantFilas==1){
		alert ('Falta Detalle de Orden de Compra');
		return 0;
				}
	
	
	if(document.getElementById("c_obaprb").value==""){
	jAlert('Ingrese un motivo de liberar la orden de Compra', 'Mensaje del Sistema');
		document.getElementById("c_obaprb").focus();
	return 0;
}
	
	 
jConfirm("¿Seguro de Liberar la Orden de Compra?", "Mensaje Confirmacion", function(r) {
			if(r) {
...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ComprasC.php?acc=liberaos&mod=<?php echo $_GET['mod'] ?>&udni=<?php echo $_GET['udni']; ?>">
<strong style="text-align:center">LIBERAR ORDEN DE COMPRA</strong>=&gt;<?php echo $_GET['udni'];  ?>

 <fieldset class="fieldset legend">
    <legend style="color:#00F"><strong>Encabezado Orden de Compra</strong></legend>
   
   <table width="990" height="89" border="0" cellpadding="0" cellspacing="0" >
 ...
 <td width="205">
  ...
  <table width="984" border="0" cellspacing="0" cellpadding="0" id="tablaDiagnostico">
    ...
    <tr>
      <td>
        <input name="<?php echo "codigo".$i; ?>" type="text" id="<?php echo "codigo".$i; ?>"  value="<?php echo $itemD["c_codprd"]; ?>" class="texto" size="13" /></td>
      <td>
        <input name="<?php echo "descripcion".$i; ?>" type="text" class="texto" id="<?php echo "descripcion".$i; ?>" value="<?php echo $itemD["c_desprd"]; ?>" size="27"  /></td>
        
        <td>
        <input name="<?php echo "medida".$i; ?>" type="text" class="texto" id="<?php echo "medida".$i; ?>"  value="<?php echo $itemD["c_codund"]; ?>" size="10" /></td>
  ...
  <table width="984" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td align="center"><strong style="color:#06C">Motivo de liberar la Orden de Compra:</strong></td>
  ...
  <p>
    <div class="buttons">
    <button type="button" class="positive" name="save" onclick="libera()">
