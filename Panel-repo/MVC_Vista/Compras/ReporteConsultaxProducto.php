...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ComprasC.php?acc=verreporte1&udni=<?php echo $_GET['udni']; ?>&mod=<?php echo $_GET['mod']; ?>">
    ...
    ?>
        <center>
          <div class="column_left" align="center">
            <div class="header"> <span>REPORTE DE COMPRAS POR PRODUCTOS </span><span><br class="clear"/>
              ...
              <table width="135%" border="1" align="center" cellpadding="0" cellspacing="0"  >
                ...
                <tr>
                  ...
                  <td height="24" ><input type="text" name="cod" id="cod" /></td>
                  <td height="24" >&nbsp;</td>
                </tr>
                <tr>
    ...
    <tr>
      <td height="113"><table width="200" border="1">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:12px" >
          <thead>
            <tr align="center">
              <td colspan="9">LISTADO DE COMPRAS POR PRODCUTO<br /> 
            ...
            <tr align="center">
              <td width="45" bgcolor="#CCCCCC">Item</td>
              <td width="166" bgcolor="#CCCCCC">N° O/C</td>
              <td width="166" bgcolor="#CCCCCC">Proveedor</td>
              <td width="166" bgcolor="#CCCCCC">Fecha O/C</td>
              <td width="208" bgcolor="#CCCCCC">Descripcion</td>
              <td width="186" bgcolor="#CCCCCC">Moneda</td>
              <td width="186" bgcolor="#CCCCCC">Precio Unitario</td>
          ...
          <tbody>
            ...
            <tr  <?php /*?>onMouseOver="this.style.backgroundColor='#99FFFF';" onMouseOut="this.style.backgroundColor='#ffffff';"<?php */?>>
              ...
              <td align="center" ><?php echo $item['c_numoc']; ?>&nbsp;</td>
              <td align="center" ><?php echo  $item['c_nomprv'];?>&nbsp;</td>
              <td align="center" ><?php echo vfecha(substr($item["d_fecoc"],0,10));?></td>
              <td align="center" ><?php echo $item["c_desprd"];?></td>
              <td align="center" bgcolor="#CCFFFF" ><?php if($item["c_codmon"]=='1'){echo 'Dolares';}else{ echo 'Soles';}; ?>&nbsp;</td>
              <td align="center" bgcolor="#FFFFCC" ><?php echo $item["n_preprd"];?></td>
              <td align="center">&nbsp;</td>
              <td align="center">&nbsp;</td>
