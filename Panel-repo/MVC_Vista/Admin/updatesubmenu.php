...
<body>
<form id="form1" name="form1" method="post" enctype="multipart/form-data" action="../MVC_Controlador/AdminC.php?acc=guardarupdatesubmenu&udni=<?php echo $val=$_GET['udni']; ?>&mod=<?php echo $_GET['mod'];?>&id=<?php echo $_GET['id'];?>&idmenu=<?php echo $_GET['idmenu'];?>" >
...
<table border="0" bgcolor="#D3F7FE" cellpadding="0" cellspacing="0" width="600">
  <tr>
    <td height="45" colspan="4" align="center"><strong>Actualizacion de Sub-menu</strong></td>
  </tr>
  <tr>
