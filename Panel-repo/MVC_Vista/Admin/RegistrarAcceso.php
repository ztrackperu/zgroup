...
function guardar(){	  
	  ...
	  jConfirm("¿Seguro de Grabar el Acceso?", "Mensaje Confirmacion", function(r) {
		if(r) {
...
<body>
<form id="form1" name="form1" method="post" action="../MVC_Controlador/AdminC.php?acc=guardaracceso&udni=<?php echo $val=$_GET['udni']; ?>&mod=<?php echo $_GET['mod'];?>" >
<table border="1" bgcolor="#D3F7FE" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="7" align="center"><strong>Registro de Accesos</strong></td>
  </tr>
  <tr>
    <td width="" height="40">Local</td>
    <td width=""> <input type="text" name="local" id="local" class="texto" value=""  required="required"/></td>
    <td width="">PC</td>
    <td width=""><input type="text" name="pc" id="pc" class="texto" value="" required="required" /></td>
    <td width="">Usuario</td>
    <td><input type="text" name="usuario" id="usuario" class="texto" value="" required="required"/></td>
    </tr>
  <tr>
    <td height="40">IP Publica</td>
    <td><input type="text" name="ippublica" id="ippublica" class="texto" value="" required="required"/></td>
    <td>IP Local</td>
    <td><input type="text" name="iplocal" id="iplocal" class="texto" value="" required="required"/></td>
    <td>MAC</td>
    <td><input type="text" name="mac" id="mac" class="texto" value="" required="required"/></td>
  </tr>
  <tr>
