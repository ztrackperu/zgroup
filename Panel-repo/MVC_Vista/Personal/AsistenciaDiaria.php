...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/PersonalC.php?acc=r1">
    ...
    <div class="column_left" align="center">
      <div class="header">ASISTENCIA DIARIA</div>
      <br class="clear"/>
					<div class="content">
					  <table width="85%" border="1" align="center" cellpadding="0" cellspacing="0"  >
					    <tr>
					      <td width="39%" height="39" align="right" >SELECCIONE FECHA</td>
					      <td width="36%" ><label for="textfield"></label>
				          <input name="textfield" type="text" id="textfield" size="12" value="<?php echo date('d/n/Y');?>" /><img src="../images/icon_calendar.png" alt="" name="lanzador" width="16" height="16" border="0" id="lanzador" title="Fecha de Emoci&oacute;n"  />
        <script type="text/javascript"> 
   Calendar.setup({ 
    inputField     :    "textfield",     // id del campo de texto 
  ...
  <tr>
    ...
    <td><?php $usuario;?></td>
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:14px">
                          <thead>
                              <tr align="center">
                                <td colspan="6">ASISTENCIA DEL DIA: <?php echo $_REQUEST['textfield']; ?></td>
                              </tr>
                              <tr align="center">
                                <td colspan="6"><a href="../MVC_Controlador/PersonalC.php?acc=v1">Retornar</a>&nbsp;<a href="#nogo" onclick="window.print();" class="nover"><em class="home nover"></em><b>Imprimir</b></a></td>
                              </tr>
                              <tr align="center">
                                <td width="51" bgcolor="#CCCCCC">Nro</td>
      <td width="248" bgcolor="#CCCCCC">Personal</td>
      <td width="116" bgcolor="#CCCCCC">Entrada</td>
      <td width="139" bgcolor="#CCCCCC">Inicio Refrigerio</td>
      <td width="151" bgcolor="#CCCCCC">Fin Refrigerio</td>
      <td width="137" bgcolor="#CCCCCC">Salida</td>
      </tr>
                          </thead>
                          <tbody>
                              <?php 
      ...
      <td align="center"><?php echo $item["personal"];?></td>
