...
var codigo=document.getElementById("cod_des").value;
	...
	var valor=obj
			//if (codigo=="") {
				//alert ("Debe Introducir el Codigo Equipo");
			//} else {
...
if(document.form1.c_refcot.value==""){
	...
	document.form1.c_refcot.focus();
	return 0;
	}
if(document.form1.c_numeroReporte .value==""){
	alert('ingrese numero de reporte');
	document.form1.c_numeroReporte.focus();
	return 0;
	}
if(document.form1.c_serieEquipo .value==""){
	alert('ingrese numero de serie equipo');
	document.form1.c_serieEquipo.focus();
	return 0;
	}	
	var theTable = document.getElementById('tablaDiagnostico');
	var cantFilas = theTable.rows.length;		
...
if(document.form1.c_tratopag .value==""){
	alert('ingrese numero de serie equipo');
	document.form1.c_tratopag.focus();
	return 0;
	}
if(document.form1.c_codpgf .value==""){
	alert('ingrese numero de serie equipo');
	document.form1.c_codpgf.focus();
	return 0;
	}	
      ...
      <div class="TabbedPanelsContent">
        <table width="890" border="0">
          <tr>
            ...
            <td width="10"></td>
            <td width="219">
			<input type="time" class="texto" name="h_inicio"  max="23:59:59" min="00:01:01" step="1">
			</td>
            <td width="18"></td>
          </tr>
		  <tr>
            ...
            <td width="325">
            <input name="c_numeroReporte" type="text"  class="texto" id="c_numeroReporte" required/>
            </td>
            <td width="145">Serie de Equipo</td>
            <td width="10"></td>
            <td width="219">
				<input name="c_serieEquipo" type="text"  class="texto" id="c_serieEquipo" required />
			</td>
            <td width="18">&nbsp;</td>
          </tr>
		  <tr>
            <td width="154">Nro de Guia / OC</td>
            <td width="325">
            <input name="nro_guia" type="text"  class="texto" id="nro_guia" />
            </td>
            <td width="145">Nro ticket</td>
            <td width="10"></td>
            <td width="219">
				<input name="nro_ticket" type="text"  class="texto" id="nro_ticket"  />
			</td>
            <td width="18">&nbsp;</td>
          </tr>
          <tr>
...
<img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
   ...
   <option value="<?php echo $item["descripcion"]?>"><?php echo utf8_decode($item["descripcion"])?></option>
            ...
            <td></td>
            <td><input name="c_refcot" type="text"  class="texto" id="c_refcot"  size="25" maxlength="11" onKeyPress="return isNumberKey(event);" required="required"/></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>Asunto </td>
            <td><label for="c_asunto"></label>
            <input name="c_asunto" type="text" id="c_asunto" size="52" class="texto"/></td>
...
<img src="../images/calendario.jpg" name="Image2" id="Image2" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
   ...
   <option value="<?php echo $item["codigo"]?>"><?php echo utf8_decode($item["descripcion"])?></option>
          ...
          <tr>
            ...
            <?php /*<input name="c_tecnico" type="text" id="c_tecnico" size="35" class="texto" required="required" />*/?>
