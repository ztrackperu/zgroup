...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=aprobacionosot&udni=<?php echo $_GET['udni']; ?>">
<strong style="text-align:center">APRUEBA ORDEN TRABAJO</strong>
