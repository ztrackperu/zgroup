...
cantFilas = theTable.rows.length;
	//	if(cantFilas==1){
//		
//		alert ('Falta Detalle de Orden Trabo');
...
<script type="text/javascript">
$().ready(function() {
	$("#c_sn").autocomplete("../MVC_Controlador/OrdenTrabajoC.php?acc=serieautonotsalida", {
		width: 300, 
		matchContains: true,
		selectFirst: false
	});	
	$("#c_sn").result(function(event, data, formatted) {
		$("#c_sn").val(data[0]);
		$("#c_sn").val(data[1]);
	});
});
...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=guardaotrabajo">
<strong style="text-align:center">REGISTRO DE ORDEN TRABAJO..</strong>
<fieldset class="fieldset legend">
    <legend style="color:#096"><strong>Encabezado Orden Trabajo</strong></legend>
  <table width="990" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="115">Nº Ord. Serv.</td>
      <td width="7">:</td>
      ...
      <td width="4">&nbsp;</td>
      <td width="111"><!--<select name="c_concepto" id="c_concepto"  class="Combos texto">
      </select>-->Ref. Cotizacion</td>
      <td width="3">:</td>
      <td width="144"><input name="c_refcoti" type="text" required placeholder="Nro Cotizacion"  class="texto" id="c_refcoti"  maxlength="11"/></td>
      <td width="99">Solicitado</td>
      <td width="3">:</td>
      <td width="144"><label for="c_solicita"></label>
        <input type="text" name="c_solicita" id="c_solicita" class="texto" placeholder="Ingrese Solicitante " required /></td>
   ...
   <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_desitm"]=='PRODUCCION'){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
            <?php }	?>
        </select></td>
      <td>&nbsp;</td>
      <td>Fecha Ord. Trab</td>
      <td>:</td>
      <td><input name="d_fecos" type="text"  class="texto" id="d_fecos" size="12"  value="<?php echo date('d/m/Y');?>" onkeyup = "this.value=formateafecha(this.value); "/><img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "d_fecos",
      ...
      <td>Ejecutado</td>
      <td>:</td>
      <td><label for="c_ejecuta"></label>
        <input type="text" name="c_ejecuta" id="c_ejecuta" class="texto" placeholder="Ingrese Ejecutor " required  /></td>
      <td><input name="c_opcrea" type="text" class="texto" id="c_opcrea" value="<?php echo $udni; ?>" size="20" readonly="readonly"/></td>
    </tr>
    <tr>
      <td>Moneda.</td>
      <td>:</td>
   ...
   <option value="<?php echo $item["c_numitm"]?>"><?php echo $item["c_desitm"]?></option>
      ...
      <input name="n_tcamb" type="text"  class="texto" id="n_tcamb" value="<?php echo $tipocambio; ?>" size="10"/></td>
      <td>Supervisado</td>
      <td>:</td>
      <td><label for="c_supervisa"></label>
        <input type="text" name="c_supervisa" id="c_supervisa" class="texto" placeholder="Ingrese Supervisor " required  /></td>
      <td align="center"><input type="button" value="Refrescar" onClick="location.reload();" style="width: 100px; height: 20px; background: #6699FF; color: #ffffff; cursor: pointer; border: 0px;"/></td>
    </tr>
    <tr>
      <td>Proveedor</td> 
      <td>:</td>
      <td>
      <input name="c_nomprov" type="text"  class="texto" id="c_nomprov" size="40"  placeholder="Digite para Busqueda Proveedor " required/>
     </td>
      <td>&nbsp;</td>
      <td>Ruc Proveedor</td>
      <td>:</td>
      <td><input type="text" name="c_codprov" id="c_codprov"  class="texto"/></td>
      <td>Lugar Trabajo</td>
      <td>:</td>
      <td><label for="c_lugar"></label>
        <input type="text" name="c_lugar" id="c_lugar" class="texto" placeholder="Ingrese Lugar Trabajo " required   /></td>
      <td bgcolor="#9999FF">Nota Salida Equipo</td>
    </tr>
    <tr>
      <td>Asunto</td>
      <td>:</td>
      ...
      <td>Contacto</td>
      <td>:</td>
      <td><input type="text" name="c_contacto" id="c_contacto" class="texto" /></td>
      <td>Fecha Entrega</td>
      <td>:</td>
      <td><label for="d_fecent"></label>
        <input type="text" name="d_fecent" id="d_fecent" class="texto"  placeholder="Ingrese Fecha Entrega" required /></td>
      <td bgcolor="#9999FF"><label for="textfield"></label>
        <input type="text" name="c_sn" id="c_sn" value="" class="texto" />        <label for="c_contacto"></label></td>
    </tr>
    <tr>
      <td colspan="11">
  </td>
...
<?php /*?> <a style='cursor: pointer;' onClick="muestra_oculta('contenido_a_mostrar')" title=""><strong style="color:#B72643">Datos Adicionales Para Glosa Servicio</strong> <img src="../images/Transfer Document.png" alt="" width="18" height="18" /></a>
        <div id="contenido_a_mostrar">
  <table width="984" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="75" bgcolor="#66CCCC">Origen</td>
      <td width="196" bgcolor="#66CCCC"><label for="origen"></label><?php $ven = ListalugarM();?>
   ...
   <option value="<?php echo utf8_encode($item["c_desitm"]);?>"><?php echo utf8_encode($item["c_desitm"]);?></option>
      ...
      <td width="177" bgcolor="#66CCCC"><label for="destino"></label><?php $ven = ListalugarM();?>
      ...
      <td width="215" bgcolor="#66CCCC"><label for="kg"></label>
  ...
  <fieldset class="fieldset legend">
    <legend style="color:#600"><strong>Asociar  Orden Servicio</strong></legend>
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
    <tr>
      <td><strong>Concepto</strong></td>
      <td>
        <input type="hidden" size="5" name="codigo" id="codigo" />
        <input name="descripcion" type="text"  class="texto" id="descripcion" size="30" readonly="readonly"/>
         <strong>Asociar Ord/Serv</strong>.<a href="#" onclick="abreVentana()"><img src="../images/icon_posts.png" alt="" width="20" height="20" title="Asociar a Orden Trabajo" /></a><strong>Ax</strong> <a href=""><img src="../images/download.png" alt="" width="24" height="24" title="Asociar Nota Salidad" /></a>
        
         <input name="glosa" type="text" class="texto" id="glosa" size="30" readonly="readonly" />
        <label for="precio"></label>
        <input name="precio" type="text"  class="texto" id="precio" value="0" size="5" readonly="readonly"/>
        <label for="cantidad"></label>
        <input name="cantidad" type="text"  class="texto" id="cantidad" value="0" size="5" readonly="readonly" />
        <strong>Cant. Fact</strong>.
<input name="imp" type="text" id="imp" value="1" size="5" class="texto"/> 
        <!--<a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" border="0" /></a>--><a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" /></a></td>
      </tr>
    </table>
  <table width="986" border="0" cellspacing="0" cellpadding="0" id="tablaDiagnostico">
    <tr>
      <td width="42" align="center" bgcolor="#CCCCCC"><strong>Item</strong></td>
      <td width="58" align="center" bgcolor="#CCCCCC"><strong>Nro </strong></td>
      <td width="177" align="center" bgcolor="#CCCCCC"><strong>Order Trabajo</strong></td>
      <td width="65" align="center" bgcolor="#CCCCCC"><strong>Asunto </strong></td>
      <td width="79" align="center" bgcolor="#CCCCCC"><strong>Monto sin (igv)</strong></td>
      <td width="93" align="center" bgcolor="#CCCCCC"><strong>Monto con (igv)</strong></td>
      <td width="103" align="center" bgcolor="#CCCCCC"><strong>Cant Fac.</strong></td>
      <td width="369" bgcolor="#CCCCCC"><strong>Eliminar</strong></td>
    </tr>
    </table>
  </fieldset>
  <fieldset class="fieldset legend">
    <legend style="color:#096"><strong>Adicionales Orden Trabajo</strong></legend>
  <table width="990" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="90">&nbsp;</td>
      <td width="7">&nbsp;</td>
      <td width="287">
        <?php /*?> <?php $ven = ListaFormaPagoM();?>
      ...
      <td width="339"><label for="st"></label>
        <input name="st" type="hidden" class="texto" id="st" value="0" size="10"/>
        <input name="igv" type="hidden" class="texto" id="igv" value="0" size="10"/>
        <input name="bi" type="hidden" class="texto" id="bi" value="0" size="10"/></td>
    </tr>
    <tr>
      <td><strong style="color:#33F">Observaciones</strong></td>
      <td>:</td>
