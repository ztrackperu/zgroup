  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td>
        ...
        <input type="hidden" name="imp" id="imp" size="5"/> <a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" border="0" /></a>&nbsp;<input name="c_rh" type="hidden" id="c_rh" value="1" onclick="rh()" />
        <label for="c_rh">R/H
