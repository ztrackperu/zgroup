...
<table width="745" border="0" align="left" cellpadding="0" cellspacing="0" style="font-family: 'Arial Narrow', Arial, sans-serif;font-size:12px">
  ...
  <tr>
    <td colspan="4" align="center"  class="t_titulo"><strong>GENERAR ORDENES DE SERVICIO ORDEN DE TRABAJO</strong></td>
    </tr>
  <tr>
    <td colspan="4"><hr /></td>
  </tr>
  ...
  <tr>
    <td colspan="4"><table width="813" border="1" cellpadding="0" cellspacing="0" style="font-size:10px">
      <tr>
        ...
        <td width="43" align="center" bgcolor="#CCCCCC"><strong>Total Dcto</strong></td>
        <td width="58" align="center" bgcolor="#CCCCCC"><strong>Monto Unit. Pactado</strong></td>
        <td width="87" align="center" bgcolor="#CCCCCC"><strong>Generar Ord Serv.</strong></td>
      </tr>
         <?php 
							if($reporteot != NULL)
							{		
      ...
      <tr>
        ...
        <td align="center"><a href="../MVC_Controlador/OrdenTrabajoC.php?acc=GenOS&amp;ot=<?php echo $item["c_numot"];?>&amp;udni=<?php echo $_GET['udni'];?>&ruc=<?php echo $item['c_rucprov'];?>&id=<?php echo $item['n_id'] ?>">Ver  Ord. Serv.</a></td>
      </tr>
      <?php }}?>
    </table></td>
    </tr>
  ...
  <tr>
    <td colspan="4"><table width="814" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
      <tr>
        <td><strong>Espacio Para ser Llenado por el supervisor:</strong></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        </tr>
  ...
  <tr>
    <td colspan="2" align="center"><strong>NOMBRE Y FIRMA DEL</strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" align="center"><strong> SUPERVISOR DEL TRABAJO</strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
