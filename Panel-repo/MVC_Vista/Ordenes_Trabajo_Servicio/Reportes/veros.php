...
$pdf->AddPage();
$cabecera="SELECT cabos.c_numos as os,pr_tele,pr_emai,pr_resp,cabos.*,detos.*, dt1.c_desitm as trato_pago, tp.tp_desc as factura_pago,tab_banc.tb_nomb,PR_CUENTA
from (((((cabos
...
inner join promae on promae.pr_nruc=cabos.c_codprov )
...
$pdf->Image('ENCABEZADO.png',10,10,100);
//$pdf->Image('zgroup.png',10,10,185);
$pdf->Ln(30);
//
