...
<body>
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=RegDuplicaOt&udni=<?php echo $_GET['udni'];?>">
      ...
      <div class="TabbedPanelsContent">
        <table width="890" border="0">
          <tr>
            ...
            <td width="325">
            <input name="c_numot" type="text"  class="texto" id="c_numot" value="AUTOGENERADO" size="25"/>
            </td>
            <td width="145">&nbsp;</td>
            <td width="10"></td>
            <td width="219">
