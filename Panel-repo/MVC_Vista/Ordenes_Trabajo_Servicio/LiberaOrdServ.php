...
function guarda(){
	...
	var motivo=document.getElementById('c_motivo').value;

if(motivo==''){
	alert('ingrese Motivo de Liberacion');
	document.form1.c_motivo.focus;
	return 0;
	}
...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=liberaos&udni=<?php echo $_GET['udni']; ?>">
<strong style="text-align:center">LIBERA ORDEN SERVICIO</strong>
<fieldset class="fieldset legend">
 ...
 <a style='cursor: pointer;' onClick="muestra_oculta('contenido_a_mostrar')" title=""><strong style="color:#60F">Datos Adicionales Para Glosa Servicio</strong> <img src="../images/Transfer Document.png" alt="" width="18" height="18" /></a>
  ...
  <table width="990" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td colspan="6" align="center" bgcolor="#CCCCFF"><strong>INGRESE MOTIVO</strong> 
        <input name="c_motivo" type="text" id="c_motivo" size="50"   class="texto"/></td>
    </tr>
    <tr>
      <td colspan="6" align="center" bgcolor="#CCCCFF">&nbsp;</td>
    </tr>
    </table>
  </fieldset>
  <p><div class="buttons">
