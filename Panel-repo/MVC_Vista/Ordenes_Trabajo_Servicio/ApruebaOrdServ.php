...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=aprobacionos&udni=<?php echo $_GET['udni']; ?>">
<strong style="text-align:center">APROBACION ORDEN SERVICIO</strong>(AQUI NO SE MODIFICA NADA)
<fieldset class="fieldset legend">
  ...
  <table width="987" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="10">:</td>
      <td width="241"><label for="c_numos"></label>
      ...
      <td width="549"><label for="c_refcoti"></label>
        <input name="c_refcoti" type="text"  class="texto" id="c_refcoti" value="<?php echo $c_refcoti ?>" maxlength="11" readonly="readonly" />
        Usuario:
   ...
   <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_numitm"]==$c_tipos){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
      ...
      <td>:</td>
      <td><label for="c_concepto"><input name="d_fecos" type="text"  class="texto" id="d_fecos" onkeyup = "this.value=formateafecha(this.value); "  value="<?php echo date('d/n/Y');?>" size="12" readonly="readonly"/><img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "d_fecos",
   ...
   <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_numitm"]==$c_codmod){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
      ...
      <input name="n_tcamb" type="text"  class="texto" id="n_tcamb" value="<?php echo $n_tcamb; ?>" readonly="readonly"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Refrescar" onClick="location.reload();" style="width: 100px; height: 20px; background: #6699FF; color: #ffffff; cursor: pointer; border: 0px;"/></td>
    </tr>
    <tr>
      <td>Proveedor</td>
      <td>:</td>
      ...
      <td>:</td>
      <td>
      <input name="c_codprov" type="text"  class="texto" id="c_codprov" value="<?php echo $c_codprov; ?>" readonly="readonly"/></td>
    </tr>
    <tr>
      <td>Asunto</td>
      <td>:</td>
      <td><input name="textfield" type="text"  class="texto" id="textfield" value="<?php echo $c_asunto; ?>" size="40" readonly="readonly"/></td>
      <td>&nbsp;</td>
      <td>Contacto</td>
      <td>:</td>
      <td><label for="c_contacto"></label>
        <input name="c_contacto" type="text" class="texto" id="c_contacto" value="<?php echo $c_contacto ?>" readonly="readonly" /></td>
    </tr>
    <tr>
      <td colspan="7">
  </td>
  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td><label for="descripcion"></label>
        <input name="descripcion" type="text"  class="texto" id="descripcion" size="40" readonly="readonly"/>
        Glosa
        <label for="glosa"></label>
        <input name="glosa" type="text" class="texto" id="glosa" size="40" readonly="readonly" />
        <input type="hidden" size="5" name="codigo" id="codigo" />        Precio Unitario
        <label for="precio"></label>
        <input name="precio" type="text"  class="texto" id="precio"  onkeyup="copia();" size="5" readonly="readonly"/>        Cantidad
        <label for="cantidad"></label>
        <input name="cantidad" type="text"  class="texto" id="cantidad" value="1" size="5" readonly="readonly" />
        <input type="hidden" name="imp" id="imp" size="5"/>        &nbsp;</td>
      </tr>
    </table>
  ...
  <table width="990" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><?php $ven = ListaPlazoM();?>
        ...
        <input type="text" name="xc_codpgf" id="xc_codpgf" /></td>
    ...
    <tr>
      ...
      <td>:</td>
      <td colspan="4"><textarea name="c_obs" id="c_obs" cols="60" rows="3" readonly="readonly"></textarea></td>
      </tr>
    <tr>
