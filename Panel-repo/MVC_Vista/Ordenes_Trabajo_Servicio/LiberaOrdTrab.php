...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/OrdenTrabajoC.php?acc=#&udni=<?php echo $_GET['udni']; ?>">
<strong style="text-align:center">LIBERA ORDEN TRABAJO</strong>
  ...
  <table width="984" border="0" cellspacing="0" cellpadding="0">
   ...
   <option value="<?php echo $item["c_numitm"]?>"<?php if($item["c_numitm"]==$c_codmod){?>selected<?php }?>><?php echo $item["c_desitm"]?></option>
    ...
    <tr>
      <td>Asunto</td>
      <td>:</td>
      <td><input name="textfield" type="text"  class="texto" id="textfield" size="40" value="<?php echo $c_asunto; ?>"/></td>
      <td>&nbsp;</td>
      <td>Contacto</td>
      <td>:</td>
      ...
      <td>Fecha Entrega</td>
      <td>:</td>
      <td><input type="text" name="d_fecent" id="d_fecent" class="texto"  placeholder="Ingrese Fecha Entrega" required="required" value="<?php echo $d_fecent ?>" /></td>
      <td><label for="c_contacto"></label></td>
    </tr>
    <tr>
      <td colspan="11">
  </td>
  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td><label for="descripcion"></label>
        ...
        <input type="hidden" name="imp" id="imp" size="5"/> <a href="#" onclick="accion()"> <img src="../images/agregar.png" width="22" height="22" border="0" /></a>&nbsp;</td>
      </tr>
    </table>
  ...
  <table width="990" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="339"><label for="st"></label>
        <input name="st" type="text" class="texto" id="st" value="<?php echo $st ?>" size="10"/></td>
    </tr>
    <tr>
      <td>Factura Pago</td>
      <td>&nbsp;</td>
      ...
      <td><label for="igv"></label>
        <input name="igv" type="text" class="texto" id="igv" value="<?php echo $igv ?>" size="10"/></td>
    </tr>
    <tr>
      ...
      <td><label for="bi"></label>
        <input name="bi" type="text" class="texto" id="bi" value="<?php echo $tp ?>" size="10"/></td><?php */?>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="6" align="center"><strong>INGRESE MOTIVO</strong>
<input name="c_motivo" type="text" id="c_motivo" size="40" class="texto" /></td>
    </tr>
  </table>
  </fieldset>
  <p>
