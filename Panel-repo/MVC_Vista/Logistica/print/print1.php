...
function Header()
{
	...
	$this->Cell(0,0,'Ingreso de paquete',0,1,'B');
	$this->Ln(1);
...
$strConsulta =  mysql_query("SELECT id_paquete, detalle_paquete, id_contenedor,fila_paquete,columna_paquete from mpaquete where id_usuario = '$idusuario' and id_empleado='$idempleado' and estado_impresion='0'");
...
$actualizar =  mysql_query("UPDATE mpaquete SET estado_impresion=1 where id_empleado = $idempleado and id_usuario = '$idusuario' AND estado_impresion=0");
// aqui actualizo el campo que ya ah sido impreso, coloca el valor 1
mysql_query($actualizar);

// Ahora imprimir el detalle de usuario
$strConsulta = "SELECT id_paquete, detalle_paquete, id_contenedor,fila_paquete,columna_paquete,

concat(nombres,' ',paterno) as nomuser,p.id_usuario,nombre_usuario,hora,fecha


from mpaquete as p,musuario as m,usuario as u where m.id_usuario=p.id_usuario
and id_empleado=udni and p.id_usuario = '$idusuario' and p.id_empleado='$idempleado'";
