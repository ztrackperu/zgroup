...
function Header()
{
	...
	$this->Cell(0,0,'Retiro de paquete',0,1,'B');
	$this->Ln(1);
...
$strConsulta =  mysql_query("SELECT id_paquete, detalle_paquete, id_contenedor,fila_paquete,columna_paquete from mpaquete where id_usuario = '$idusuario' and id_empleado='$idempleado' and estado_impresion_out='0'
and check_egreso='1'");
...
$actualizar =  mysql_query("UPDATE mpaquete SET estado_impresion_out=1 where id_empleado = $idempleado and id_usuario = '$idusuario' AND estado_impresion_out=0 and check_egreso='1'");
