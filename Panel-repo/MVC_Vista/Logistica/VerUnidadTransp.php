...
<div class="onecolumn">
                        ...
                        <table class="data" width="764" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                    ...
                                    <th width="35%" style="width:30%"><p>Unidad<BR>
                                    </p></th>
                                  <th width="13%" style="width:15%">Placa</th>
                                  <th width="8%" style="width:10%">Administrar</th>
                                      
                                </tr>
                            </thead>
                            <tbody>
                            <?php $verListaNosotros = ListaunidadtrasporteC();?>
                                <?php 
                    $i = 1;
            ...
            ?>
                                <tr>
                                    <td><?php echo $item["id_unitras"];?></td>
                                  <td bgcolor="#E5E5E5"> <B><?php echo $item["tipo"];?> </td>
                                    
                                  <td bgcolor="#FFFFCC"><?php echo $item["placa"]; ?></td>
                                    <td bgcolor="#FFFFFF"><a href="../MVC_Controlador/LogisticaC.php?acc=m12&amp;dato=<?php echo $item["id_unitras"];?>&amp;udni=<? echo $udni;?>"> <img src="../images/icon_edit.png" alt="editar" width="20" height="20" class="help" title="Editar" /></a>&nbsp;</td>
                                   <?php  if($tbu!="c1"){?> <?php }?>
                                </tr>
                                <?php
                        $i += 1;
            ...
            ?>
                        ...
                        Agregar <a href="../MVC_Controlador/LogisticaC.php?acc=m13&amp;udni=<? echo $_GET['udni'];?>"><img src="../images/nuevo.png" width="48" height="48" /></a>
