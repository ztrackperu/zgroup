...
<form name="form1" method="post" action="../MVC_Controlador/LogisticaC.php?acc=m10&udni=<?php echo $_GET['udni']; ?>">
  <table width="870" border="0">
    <tr>
      <td width="860">MODIFICAR CHOFERES</td>
    </tr>
  </table>
  ...
  <table width="630" border="0">
    <tr>
      ...
      <td width="456"><label for="textfield"></label>
        <input name="textfield" type="text" id="textfield" size="55" class="texto" value="<?php echo $itemP['nombre_chofer']?>">
        <input type="hidden" name="hiddenField" id="hiddenField" value="<?php echo $itemP['id_chofer'] ?>">
    ...
    <tr>
      <td>Dni</td>
      <td><input name="textfield2" type="text" id="textfield2" size="45" class="texto" value="<?php echo $itemP['dni_chofer']?>"></td>
    </tr>
    <tr>
      <td>Direccion</td>
      <td>
        <input type="text" name="textfield3" id="textfield3" class="texto" value="<?php echo $itemP['direccion']?>">
      </td>
    </tr>
    <tr>
      <td>Telefono</td>
      <td>
        <input type="text" name="textfield4" id="textfield4" class="texto"value="<?php echo $itemP['telefono']?>">
      </td>
    </tr>
    <tr>
      <td>Brevete</td>
      <td><label for="textfield5"></label>
        <input type="text" name="textfield5" id="textfield5" class="texto" value="<?php echo $itemP['brevete']?>"></td>
    </tr>
    <tr>
      <td>Estado</td>
