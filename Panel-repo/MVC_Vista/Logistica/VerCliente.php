...
<body>
<div class="onecolumn">
                    <div class="header"> CLIENTES<br class="clear"/>
                    </div>
                    <div class="content">
                        <table class="data" width="764" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                    ...
                                    <th width="35%" style="width:30%"><p>Razon Social<BR>
                                    </p></th>
                                  <th width="13%" style="width:15%">Ruc</th>
                                  <th width="8%" style="width:10%">Administrar</th>
                                      
                                </tr>
                            </thead>
                            <tbody>
                            <?php $verListaNosotros = ListaclienteC();
            ...
            ?>
                                <tr>
                                  ...
                                  <td bgcolor="#E5E5E5"> <B><?php echo $item["nom_cli"];?> </td>
                                    
                                  <td bgcolor="#FFFFCC"><?php echo $item["ruc_cli"];?></td>
                                    <td bgcolor="#FFFFFF"><a href="../MVC_Controlador/LogisticaC.php?acc=m2&amp;dato=<?php echo $item["id_cliente"];?>&amp;udni=<? echo $udni;?>"> <img src="../images/icon_edit.png" alt="editar" width="20" height="20" class="help" title="Editar" /></a>&nbsp;</td>
                                   <?php  if($tbu!="c1"){?> <?php }?>
                                </tr>
                                <?php
                        $i += 1;
            ...
            ?>
                        ...
                        Agregar <a href="../MVC_Controlador/LogisticaC.php?acc=m3&amp;udni=<? echo $_GET['udni'];?>"><img src="../images/nuevo.png" width="48" height="48" /></a>
