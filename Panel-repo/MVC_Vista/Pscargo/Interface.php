...
<fieldset class="fieldset legend" style="width:100%">
  <legend style="color:#03C"><strong>Actualizacion Comprobantes Para Forwarder</strong>
</legend>
  <div class="buttons">
  ...
  <tr>
    ...
    <td width="280" align="center" bgcolor="#CCCCCC"><strong>Comprobante</strong></td>
    <td width="205" align="center" bgcolor="#CCCCCC"><strong>Forwarder Nro</strong></td>
    <td width="406">Glosa </td>
    </tr>
   <?php 
							if($resultado != NULL)
							{		
  ...
  <tr>
    <td><?php echo $i;?>&nbsp;</td>
    <td><input type="text" id="<?php echo "c_numvou".$i; ?>"  name="<?php echo "c_numvou".$i; ?>" readonly  size="10" value="<?php echo $itemD["c_numvou"]; ?>" class='texto' />
    <input type="text" id="<?php echo "c_anovou".$i; ?>"  name="<?php echo "c_anovou".$i; ?>" readonly  size="2" value="<?php echo $itemD["c_anovou"]; ?>" class='texto' />
      <input type="text" id="<?php echo "c_mesvou".$i; ?>"  name="<?php echo "c_mesvou".$i; ?>" readonly  size="2" value="<?php echo $itemD["c_mesvou"]; ?>" class='texto' />
    
    </td>
    <td><input type="text" id="<?php echo "c_numeOP".$i; ?>"  name="<?php echo "c_numeOP".$i; ?>"  size="25" value="<?php echo $itemD["c_numeOP"]; ?>" class='texto' placeholder="Ingrese Forwarder "  /></td>
