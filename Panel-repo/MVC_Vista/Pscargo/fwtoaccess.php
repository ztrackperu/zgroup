...
action="../MVC_Controlador/PscargoC.php?acc=migracionfw">
  <div class="column_left">
    <div class="header"><strong>Proceso Migracion forwarder a contabilidad</strong></div>
  <table width="527" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="527" colspan="4" align="center" valign="middle"></td>
    </tr>
    <tr>
      <td colspan="4" align="right" valign="middle"></td>
    </tr>
    <tr>
      <td colspan="4" align="center" valign="middle"><input type="submit" name="button" id="button" value="Procesar Forwarders" /></td>
    </tr>
    <tr>
