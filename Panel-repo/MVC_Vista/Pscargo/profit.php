...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/PscargoC.php?acc=verfrmprofit">
  ...
  <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <div class="column_left" align="center">
      <div class="header"> PROFIT X FW</div>
      <br class="clear"/>
					<div class="content">
      ...
      <script type="text/javascript">
					...
					button     : "Image2"
					    ...
					    <tr>
					      <td align="center" >&nbsp;</td>
					      <td align="right" >Ingrese Nro Forwarder:</td>
					      <td align="left" ><label for="fw"></label>
				          <input type="text" name="fw" id="fw" /></td>
				        </tr>
					    <tr>
