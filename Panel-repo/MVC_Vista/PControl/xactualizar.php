 				 ...
 				 if (mysql_num_rows($resultado) != 0)
				 {
	      		$h_entrada= mysql_result($resultado,0,'h_entrada');
  					...
  					$h_in = substr($h_entrada,0,strpos($h_entrada,":"));
						...
						$m_in = substr($h_entrada,strpos($h_entrada,":")+1);
						$m_out = substr($hora,strpos($hora,":")+1);
...
$Nompaq=NombrePC();
    ...
    if (!($REMOTE_ADDR == "192.168.0.118" or $REMOTE_ADDR  == "127.0.0.1" or $REMOTE_ADDR  == "192.168.0.198" or $REMOTE_ADDR  == "192.168.80.25" or $REMOTE_ADDR  == "192.168.80.2" or $REMOTE_ADDR  == "192.168.0.140" or  $Nompaq  == "TI025" or  $Nompaq  == "ESTADISTICA009" or $Nompaq == "ESTADISTICA014" or $REMOTE_ADDR == "192.168.80.106"))
		{
