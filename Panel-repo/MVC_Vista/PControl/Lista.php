...
<div align="center"> <strong ><?PHP echo constant("ORGANIZACION");?> – REPORTE DE CONTROL DE PERSONAL </strong><p>
  <?php if ($radio=='Pxperi'){?>
...
//   $diaprogra = mysql_query("select dni,diapro,tipmov from horario where dni='43623262' and diapro between '2010-05-01' and '2010-05-31'order by diapro asc;");
   ...
   ?>
    ...
    <?       $tipmov; 
	     //echo"<br>"; 
	    echo TipoMovi($tipmov,$dni,$diapro); 
...
<table cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" width="334"><p align="left"><?PHP echo constant("ORGANIZACION");?>  <br />
    </p></td>
  </tr>
  <tr>
    <td align="left"><div align="left"><?PHP echo constant("TELEFONOS_ORGANIZACION");?>  </div></td>
  </tr>
</table>
