...
<center class="Estilo1">
  <strong>  <b><span class="Estilo1">CONTROL DE ASISTENCIA </span>  </strong>
</center>
...
<table width="150" border="0">
 <!-- <tr>
    ...
    <td width="130"><span class="Estilo1"><a href="asistencia.php<?php echo $param ?>" target="mainframe" class="Estilo1"> Consultar</a><br>
    </span></td>
  </tr-->>
 <!-- <tr>
