...
$(document).ready(function(){
	...
	myajax_Listar.loadCmbJson_L('../MVC_Modelo/cn/combo.php',{op:'showdepa'},'SER_CODIGO');
	$("#SER_CODIGO").change(function(){
		var dep=$("#SER_CODIGO").val();
		myajax_Listar.loadCmbJson_L('../MVC_Modelo/cn/combo.php',{op:'showprov',depa:dep},'SER_CODIGO2');	
	});	
	});
</script>
<script type="text/javascript">
...
<body>
<form action="../MVC_Controlador/WebC.php?acc=w9" method="post"  name="form1" enctype="multipart/form-data">
  <table width="870" border="0">
    <tr>
      <td width="860">REGISTRO DE DETALLE</td>
    </tr>
  </table>
  ...
  <table width="630" border="0">
    <tr>
      ...
      <td width="456"><label for="SER_CODIGO"></label>
    ...
    <tr>
      ...
      <td><label for="SER_CODIGO2"></label>
        <select name="SER_CODIGO2" id="SER_CODIGO2">
        </select>
    ...
    <tr>
      ...
      <td><label for="textfield"></label>
        <input name="textfield" type="text" id="textfield" size="60"></td>
    </tr>
    <tr>
      <td>Descripcion</td>
