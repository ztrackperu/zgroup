...
<body>
<div class="onecolumn">
                    <div class="header"> <span>Contenido Items de Producto y Servicios</span> (<a href="../MVC_Controlador/WebC.php?acc=w13">Agregar</a>)</div>
                    <br class="clear"/>
                    <div class="content">
                        <table class="data" width="764" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                    ...
                                    <th width="13%" style="width:15%">Descripcion</th>
                            ...
                            <tbody>
                            <?php $verListaNosotros = ListardataC();?>
                                <?php 
                    $i = 1;
            ...
            ?>
                                <tr>
                                  ...
                                  <td bgcolor="#E5E5E5"> <B><?php echo $item["empresa"];?> </td>
                                  <td><?php echo $item["direccion"].'-'.$item["telefono"];?></td>
                                    
                                  <td bgcolor="#FFFFCC"><?php if($item["estado"]==1){echo "Activo";}else{echo"No Activo";}?></td>
                                    <td bgcolor="#FFFFFF"><a href="../MVC_Controlador/WebC.php?acc=w5&amp;dato=<?php echo $item["id"];?>&amp;udni=<? echo $udni;?>"> <img src="../images/icon_edit.png" alt="editar" width="20" height="20" class="help" title="Editar" /></a>&nbsp;</td>
                                   <?php  if($tbu!="c1"){?> <?php }?>
                                </tr>
                                <?php
                        $i += 1;
