...
<div class="onecolumn">
                    <div class="header"><strong>GENERAR OPERACION DE TRANSPORTE</strong></div>
                    <strong style="color:#FFF"><?php echo $mod=$_GET['mod']; ?></strong>
<strong>Nueva Operacion</strong><a href="../MVC_Controlador/TransporteC.php?acc=regoper&udni=<?php echo $val;?>"><img src="../images/nuevo.png" width="48" height="48" /></a><br class="clear"/>
                    <div class="content">
                        <table class="data" width="894" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                  <th colspan="7" style="width:5%"><input type="radio" name="sw" id="sw" value="1" />
                                  ...
                                  NRO OPERACION (EJM=45)</th>
                                </tr>
                                <tr>
                                  <th colspan="7" style="width:5%"><input name="des" type="text" id="des" size="40" />
                                ...
                                <tr>
                                  <th width="2%"  >Item</th>
                                    <th width="9%" align="center"  >Nro Oper.</th>
                                    <th width="19%" align="center" >Cliente</th>
                                    <th width="5%" align="center" >Fecha Oper.</th>
                                  <th width="9%" align="center" >Estado</th>
                                  <th width="11%" align="center" >Aprueba<br />/Libera</th>
                                  <th width="19%" align="center" >Administrar</th>
										...
										if($listaos!=NULL)
{
            ...
            ?>
                                <tr>
                                  <td><?php echo $i; ?>&nbsp;</td>
                                    <td>OP<?php echo $item["c_numos"];?></td>
