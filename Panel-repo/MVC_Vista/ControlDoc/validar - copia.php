...
<body> 
 ...
 <form id="form1" name="form1" method="post" action="../MVC_Controlador/ControlDocC.php?acc=grabarValidacion&mod=<?php echo $_GET['mod'] ?>&udni=<?php echo $_GET['udni']; ?>&c_numcd=<?php echo $_GET['c_numcd']; ?>">
   ...
   <table width="988" height="54" border="0" cellpadding="0" cellspacing="0" >
		...
		<tr>
		  <td width="102" height="54">Nro Envio:</td>
		  <td width="178">			
			<input name="c_numpre"  type="text" class="texto" id="c_numpre" value="<?php echo $c_numcd; ?>" size="20" readonly="readonly"/>
            			
		  </td>
			
		  <td width="114">Fecha de Registro: </td>
		  <td width="170">
			
           <label for="fecha"></label>
			<input name="fecha"  type="text" class="texto"  id="fecha" size="12" maxlength="12" value="<?php echo  vfecha(substr($d_fecreg,0,10)); ?>" /> &nbsp;<img src="../images/calendario.jpg" name="Image1" id="Image1" width="16" height="16" border="0"   onMouseOver="this.style.cursor='pointer'">
			<script type="text/javascript">
						Calendar.setup(
						  {
						inputField : "fecha",
          ...
          <td width="99">Observacion:</td> 
          <td width="111"><textarea name="c_obsdoc" id="c_obsdoc" cols="15" rows="2"><?php echo $c_obsdoc; ?></textarea></td>  
		</tr>
   ...
   <tr>
         <td height="32">Tipo Doc.: </td>
		  ...
		  <td>          
           <?php $ven2 = docuC();  
			  ?>
		    <select name="docu" id="docu" class="Combos texto" onchange="cambiadocu()" style="width:150px"  >
		  ...
		  <td width="116"><b>Serie/Numero:</b></td>
	  
	   <td width="173"><input class="texto" type="text" size="5" name="seried" id="seried" onkeypress="return ValidaEntero(event)"  onchange="completar1()" maxlength="3" />
        ...
        <input class="texto" size="10" type="hidden" name="iddestinatario" id="iddestinatario"  readonly="readonly"  />
        <input class="texto" size="10" type="hidden" name="nombredestinatario" id="nombredestinatario"  readonly="readonly"  />
        </td>
       <td>Nº de copias
         <input class="texto" size="10" type="text" name="n_copias" id="n_copias" value="1" />
       </td> 
        
      </tr>
	 <tr>
	   <td width="101">Remitente: </td>
	   <td width="183" height="32">
           <select name="tiporemitente" id="tiporemitente" class="Combos texto" onchange="cambiaremitente()" style="width:150px"  >                                
	   ...
	   <td colspan="2"> 
         <input name="clie" type="text"  class="texto" id="clie" placeholder="Digite Cliente"  size="20" onclick="validarcombos();" onkeypress="validarcombos()" />    
         <div id="apDiv1"><input name="prov" type="text" class="texto" id="prov"  placeholder="Digite Proveedor" size="20" onclick="validarcombos();" onkeypress="validarcombos()" /></div>
          &nbsp;
        <input name="idremitente"  class="texto" type="text" id="idremitente" size="15" placeholder="Codigo Remitente" readonly="readonly" /> 
    ...
    <tr>
      ...
      <td>
        <input name="<?php echo "n_item".$i; ?>" type="text" id="<?php echo "n_item".$i; ?>"  value="<?php echo $itemD["n_item"]; ?>" size="10" readonly="readonly" /></td>
      <td>
      ...
      <td align="center">
       <?php if($itemD["c_estado"]!=0){ ?>
        ...
        <input name="<?php echo "sel".$i ?>" type="checkbox" id="<?php echo "sel".$i; ?>"  value="<?php echo $itemD["n_item"]; ?>" size="10" />
