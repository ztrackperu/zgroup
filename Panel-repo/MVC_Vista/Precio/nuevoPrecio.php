...
if($resultado!=NULL)
{
                ...
                $c_oper=$udni;
                echo $marca=$item['c_mcamaq'];
                echo $modelo=$item['c_cmodel'];
                }
}
  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
      ...
      <td align="center" >Marca:<br />
        <select name="c_mcamaq" id="c_mcamaq" class="texto">
            <option value="SELECCIONE">SELECCIONE</option>
                <?php 
                 $marcam = ListaMarcaMaqM();
       foreach($marcam as $mmaq){              
               ?>                                   
       <option value="<?php echo $mmaq['C_NUMITM']; ?>" <?php if($mmaq['C_NUMITM']==$marca){?>selected<?php }?>  > <?php echo $mmaq['C_DESITM']; ?> 
       </option>
          <?php } ?>
      ...
      <td align="center" >Modelo:<br />
        <select name="c_cmodel" id="c_cmodel" class="texto" >
                          <option value="SELECCIONE">SELECCIONE</option>  
                <?php $ListaModelo = ListarModeloPorMarca($marca);
              foreach($ListaModelo as $model){  ?>                                               
                <option value="<?php echo $model['C_NUMITM']; ?>" <?php if($model['C_NUMITM']==$modelo){?>selected<?php }?>    > <?php echo $model['C_DESITM']; ?> </option>
                <?php } ?>            
