...
<!-------------------------------------------------------------------------------------------------------------- -->
  ...
  <table width="985"  border="0" cellpadding="1" cellspacing="1">
      ...
      <td width="137" height="52">Descripcion: </td>
        ...
        <input type="button" value="Refrescar" onclick="location.reload();" style="width: 90px; height: 25px; background: #6699FF; color: #ffffff; cursor: pointer; border: 0px;"/></td>
                  
                               <td width="102" align="center">Precio:<br />
...
<?php /*?>   <a href="" class="regular"><!-- class="regular"-->
    ...
    <button type="reset" class="negative" name="cancel" onClick="cancelar();">
