...
<a href="../MVC_Controlador/PrecioC.php?acc=regPrecio&udni=<?php echo $val;?>&mod=<?php echo $mod=$_GET['mod']; ?>"><img src="../images/nuevo.png" width="48" height="48" /></a>
&nbsp;<strong>Reporte General</strong>&nbsp;&nbsp;<a href="../MVC_Controlador/PrecioC.php?acc=ReporteGeneral&mod=<?php echo $_GET['mod'] ?>&amp;udni=<?php echo $val;?>"><img src='../images/search.png' name='avatar' title="Ver Precios Actuales" width="28" height="20"></a>&nbsp;
<br class="clear"/>
                    <div class="content">
                        <table class="data" width="701" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                  <th colspan="16" style="width:5%"><input type="radio" name="sw" id="sw" value="1" checked="checked" /> NOMBRE DEL PRODUCTO /                                                          
                                  <input name="sw" type="radio" id="sw" value="2"  /> CODIGO DEL PRODUCTO</th>
       
                                </tr>
                                <tr>
                                  <th colspan="16" style="width:5%"><input name="des" type="text" id="des" size="40" />
                                ...
                                <tr>
                                  ...
                                  <th colspan="7" align="center">Datos del Producto</th>
				...
				<!--<a href="../MVC_Controlador/PrecioC.php?acc=reporte&mod=<?php  //echo $_GET['mod'] ?>&amp;c_codprd=<?php //echo $item["c_codprd"]; ?>&amp;c_catprd=<?php //echo $item["c_catprd"]; ?>&amp;c_conprd=<?php //echo $item["c_conprd"]; ?>&amp;udni=<?php // $val;?>"><img src='../images/detallecerrado.png' name='avatar' title="Ver historial de precios por categoria y condicion" width="18" height="20"></a>-->
