  ...
  <table width="102%" border="1" align="center" cellpadding="0" cellspacing="0" >
    ...
    <tr>
      ...
      <style type="text/css" media="print">
        ...
        <table width="89%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:10px">
          <thead>
            <tr align="center">
              <td colspan="12">LISTADO DEL HISTORIAL DE PRECIOS<BR />
          ...
          <tbody>
            ...
            <tr >
              <td><?php echo $i; ?>&nbsp;</td>
                      ...
                      <td bgcolor="#FFFFCC"><?php echo utf8_encode($desmarca);?></td>
                      <td bgcolor="#FFFFCC"><?php echo utf8_encode($desmodelo);?></td>
                      ...
                      <td bgcolor="#FFFFCC"><?php if($item["c_activo"]=='2') echo "ULTIMO"; ?></td>
            </tr>
            <?php $i += 1;}?>   
