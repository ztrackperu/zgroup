...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/PrecioC.php?acc=listahistorial&udni=<?php echo $_POST['usuario1']; ?>&mod=<?php echo $_GET['mod']; ?>&c_codprd=<?php echo $_GET['c_codprd']; ?>&c_catprd=<?php echo $_GET['c_catprd']; ?>&c_conprd=<?php echo $_GET['c_conprd']; ?>">
