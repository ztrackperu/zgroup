...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ComprasC.php?acc=verreporte2&udni=<?php echo $_GET['udni']; ?>&mod=<?php echo $_GET['mod']; ?>">
    ...
    ?>
        <center>
          <div class="column_left" align="center">
            <div class="header"> <span>REPORTE DE ORDEN DE COMPRA SIN NOTA DE INGRESO</span><span><br class="clear"/>
    ...
    <tr>
      <td height="113"><table width="200" border="1">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="data" style="font-family:Arial, Helvetica, sans-serif; font-size:12px" >
          <thead>
            <tr align="center">
              <td colspan="5">LISTADO DE COMPRAS POR PRODCUTO<br /> 
            ...
            <tr align="center">
              <td width="47" bgcolor="#CCCCCC">Item</td>
              <td width="94" bgcolor="#CCCCCC">N° O/C</td>
              <td width="375" bgcolor="#CCCCCC">Proveedor</td>
              <td width="144" bgcolor="#CCCCCC">Fecha O/C</td>
              <td width="273" bgcolor="#CCCCCC">&nbsp;</td>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr  <?php /*?>onMouseOver="this.style.backgroundColor='#99FFFF';" onMouseOut="this.style.backgroundColor='#ffffff';"<?php */?>>
              ...
              <td align="center" ><?php echo $item['C_NUMEOC']; ?>&nbsp;</td>
              <td align="left" ><?php echo  $item['C_NOMPRV'];?>&nbsp;</td>
