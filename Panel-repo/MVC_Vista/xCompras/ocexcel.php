...
<form id="form1" name="form1" method="post" action="../MVC_Controlador/ComprasC.php?acc=exportaoc">
  ...
  <table width="619" border="1" cellpadding="0" cellspacing="0" class="data" id="Exportar_a_Excel">
    <tr>
      <td colspan="8">Fecha Emision :<?php echo vfecha(substr($d_fecoc,0,10));?></td>
    </tr>
    <tr>
      <td colspan="8">Nro Orden&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<?php echo $c_numeoc?>  <input type="hidden" name="hiddenField" id="hiddenField" value="<?php echo $c_numeoc?>" /></td>
    </tr>
    <tr>
      <td colspan="8">Razon Social&nbsp;&nbsp;:<?php echo $c_nomprov?></td>
    </tr>
    <tr>
