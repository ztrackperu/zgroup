...
<a href="../MVC_Controlador/ComprasC.php?acc=formos&udni=<?php echo $val;?>"><img src="../images/nuevo.png" width="48" height="48" /></a>
...
<br class="clear"/>
                    <div class="content">
                        <table class="data" width="894" cellpadding="0" cellspacing="0" bordercolor="#000000">
                            <thead>
                                <tr>
                                  <th colspan="9" style="width:5%"><input type="radio" name="sw" id="sw" value="1" checked="checked" /> PROVEEDOR / 
                                  
                                 
                                  
                                  <input name="sw" type="radio" id="sw" value="2"  />  NRO ORDERN COMPRA (EJM=45)</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <th width="4%"  >&nbsp;</th>
                                    <th width="12%"  >Nro Orden</th>
                                    <th width="19%" >Proveedor</th>
                                    <th width="7%" >Fecha</th>                                 
                                  <th width="11%" >Estado</th>
                                  <th width="13%" >&nbsp;</th>
                                  <th width="13%" >Aprueba<br />/Libera</th>
                                  <th width="21%" >Administrar</th>
										...
										if($listaos!=NULL)
{
            ...
            ?>
			  ...
			  }elseif($item['n_swaprb']==2   && $item['c_estado']==0){ echo '<strong style="color:#060">Aprobado</strong>';}
			  
			  if($item['n_swaprb']==2  && $item['c_estado']==2 &&  $item['b_swtfac']=='1'){ echo '<strong style="color:#FF0000">Cerrado</strong>';} ?>&nbsp;</td>
                                  <td align="center" bgcolor="#FFFFFF"><a href="../MVC_Controlador/ComprasC.php?acc=duplicaoc&amp;os=<?php echo $item["c_numeoc"];?>&amp;udni=<?php echo $_GET['udni'];?>&tipo=<?php echo $item['CC_TCLI']; ?>&doc=<?php echo $item['CC_TDOC'];  ?>"><!--<img src="../images/icono-descargas.jpg" alt="" width="23" height="22" title="Duplicar Orden Servicio" />--></a></td>
                                  <td bgcolor="#FFFFFF">
                  <?php if($item['n_swaprb']=='0'  && $mod=='1'){ ?>
                       <?php 			  
				  }?>
               <?php if($item['n_swaprb']=='0' && $item['b_swtfac']=='0'  && $mod=='1'){ ?>
                                 <a href="../MVC_Controlador/ComprasC.php?acc=veraprobacion&mod=<?php echo $_GET['mod'] ?>&amp;os=<?php echo $item["c_numeoc"];?>&amp;udni=<?php echo $val;?>"><img src="../images/Coherence.png" width="32" height="32" title="Aprobar Orden Compra" /></a></td>
                                  <?php }?>
                       <?php if($item['n_swaprb']=='2' && $item['b_swtfac']=='0' && $mod=='1'){ ?>             
