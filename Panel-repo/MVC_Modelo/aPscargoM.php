...
include('cn/sqlconexps.php');
$sql="select Cxc_Kdoc,Cxc_Ndoc,convert(varchar(10),Cxc_Femi,103)as Cxc_Femi,Cxc_Mone, Cxc_Adqu,Ent_Rsoc,Cxc_Tota,Cxc_Igv,Cxc_Tnet,Cxc_Glos,Cxc_Obse from CXCDocumentos as c ,Entidades as e
...
include('cn/sqlconexps.php');
$sql="select Ccd_Desc,Ccd_Cant,Ccd_Mone,Ccd_Vuni,Ccd_Tota from CXCDocumentosDetalle 
where Ccd_Kdoc='$nro'";
$result = mssql_query($sql,$link ); 
	while ($fila=mssql_fetch_array($result)){$ven[] = $fila;}	return $ven; }
?>