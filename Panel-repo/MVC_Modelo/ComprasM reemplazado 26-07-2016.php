...
$resultado = odbc_exec($cid,$sql)or die("Error: ".odbc_error($cid));
	...
	function BusquedaOSM($descripcion,$sw){
		...
		if($sw=='1'){
			...
			$sql="select top 100 c_numeoc,c_nomprv,d_fecoc,c_estado,n_swaprb,b_swtfac from
...
$d_fecreg,$c_oper,$d_date,$c_tipooc,$c_claoc,$c_codcia,$c_codtda,$b_importac,$b_cierreOP,$c_refcoti,$c_pais,$c_icote,$c_puerto,$c_depo){
	include('cn/dbconex.php');
...
c_codcc,c_codlug,c_deslug,c_estado,c_obsoc,d_fecent,c_lugent,b_swtenv,c_codtran,c_nomtran,n_swtofi,
d_fecreg,c_oper,d_date,c_tipooc,c_claoc,c_codcia,c_codtda,b_importac,c_refcoti,c_pais,c_icote,c_puerto,c_depo) values('$c_numeoc','$c_seroc','$c_numoc','$c_ocmain','$c_codcon','$c_codprv','$c_nomprv','$d_fecoc',$n_bruafe,$n_desafe,$n_netafe,$n_facisc,$n_totisc,$n_porigv,$n_igvafe,$n_totoc,$n_tcoc,'$c_codmon','$c_codpag',
'$c_codcc','$c_codlug','$c_deslug','$c_estado','$c_obsoc','$d_fecent','$c_lugent','$b_swtenv','$c_codtran','$c_nomtran',$n_swtofi,'$d_fecreg','$c_oper','$d_date','$c_tipooc','$c_claoc','$c_codcia','$c_codtda',$b_importac, '$c_refcoti','$c_pais','$c_icote','$c_puerto','$c_depo')";
...
$n_totimp,'$c_codafe','$c_obsdoc','$d_fecreg','$c_oper',
'$c_codcia','$c_codtda','$c_nroserie')";		
$resultado = odbc_exec($cid, $sqlComprascabM)or die(exit("Error en odbc_exec()<br>$sqlComprascabM"));
	return $resultado;
	}

	
function UpdateCabComprasM($c_numeoc,$d_fecmod,$c_opermd,$n_tcoc,$c_codmon,$c_codpag,$c_codlug,$c_deslug,$c_estado,$c_obsoc,$d_fecent,$c_lugent,$c_codtran,$c_nomtran,$c_tipooc,$c_refcoti,$c_pais,$c_icote,$c_puerto,$c_depo){
	include('cn/dbconex.php');
	...
	c_pais='$c_pais',c_icote='$c_icote',c_puerto='$c_puerto',c_depo='$c_depo'
