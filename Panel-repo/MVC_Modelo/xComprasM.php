...
c_codcc,c_codlug,c_deslug,c_estado,c_obsoc,d_fecent,c_lugent,b_swtenv,c_codtran,c_nomtran,n_swtofi,
d_fecreg,c_oper,d_date,c_tipooc,c_claoc,c_codcia,c_codtda,b_importac,c_refcoti) values('$c_numeoc','$c_seroc','$c_numoc','$c_ocmain','$c_codcon','$c_codprv','$c_nomprv','$d_fecoc',$n_bruafe,$n_desafe,$n_netafe,$n_facisc,$n_totisc,$n_porigv,$n_igvafe,$n_totoc,$n_tcoc,'$c_codmon','$c_codpag',
'$c_codcc','$c_codlug','$c_deslug','$c_estado','$c_obsoc','$d_fecent','$c_lugent','$b_swtenv','$c_codtran','$c_nomtran',$n_swtofi,'$d_fecreg','$c_oper','$d_date','$c_tipooc','$c_claoc','$c_codcia','$c_codtda',$b_importac, '$c_refcoti')";
...
function UpdateCabComprasM($c_numeoc,$d_fecmod,$c_opermd,$n_tcoc,$c_codmon,$c_codpag,$c_codlug,$c_deslug,$c_estado,$c_obsoc,$d_fecent,$c_lugent,$c_codtran,$c_nomtran,$c_tipooc,$c_refcoti){
	include('cn/dbconex.php');
	
	$sql="update cabeoc set d_fecmod='$d_fecmod',c_opermd='$c_opermd',n_tcoc=$n_tcoc,c_codmon='$c_codmon',c_codpag='$c_codpag',c_codlug='$c_codlug',c_deslug='$c_deslug',c_estado='$c_estado',c_obsoc='$c_obsoc',d_fecent='$d_fecent',c_lugent='$c_lugent',c_codtran='$c_codtran',c_nomtran='$c_nomtran',c_tipooc='$c_tipooc',c_refcoti='$c_refcoti' where c_numeoc='$c_numeoc'";
